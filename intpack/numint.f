...
c zradpt    : The array of radial points
      ...
      zvalint=setptr(1,1, naonao*dimauxbs)

      pordr  =setptr(1,0, naobasfn)
      zscrord=setptr(1,0, naobasfn)

      zscr   =setptr(1,1, naonao*dimauxbs)
      zscr2=setptr(1,1,naobasfn*naobasfn)
      zeigval=setptr(1, 1,dimauxbs)
      ztran=setptr(1,1,dimauxbs*dimauxbs)
