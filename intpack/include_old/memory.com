...
c This include file should NEVER be used in any standard routine.  It is
c strictly for crapsi, crapso, and a few memory routines.
c
...
c maxmem   : Maximum memory to allocate (set in ZMAT file)
      ...
      common /memory/ i0,iptr,ineeded,i1,d0,dptr,dneeded,d1,maxmem
      save /memory/
