...
c             first ones have real values.  The remaining ones are 0.
      ...
      integer patomchrg,pfullclss,pcompclss,pfullpopv,pcomppopv,
     &    pfullmemb,pcompmemb,pnprimatom,pnshellatom,pnaoatom,
     &    pnshellprim,pnshellao,pprimoff,paooff,pnangatom
      integer zatommass,zcoord,zalpha,zprimcoef

      common /mol/  orientmt,nucrep,
     ...
     &    zprimcoef,pprimoff,paooff,pnangatom
      ...
      common /molc/ compptgp,fullptgp,spinc
      save /mol/
      save /molc/
