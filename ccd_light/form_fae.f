      ...
      Subroutine Form_fae(T2aa,T2bb,T2ab,Fae_a,Fae_b,W_aa,W_bb, 
...
C Fae_aa(A,E)= -1/2 T2(AF,MN)*W(MN,EF) - T2(Af,Mn)*W(Mn,Ef)
      ...
      Do n = 1, Nocc_a
      Do f = 1, Nvrt_a
         C = (1.0D0-Ocn_va(F))*Ocn_oa(N)*Ocn_oa(M)
      ...
      Do n = 1, Nocc_a
      Do f = 1, Nvrt_b
         C = (1.0D0-Ocn_vb(f))*Ocn_oa(N)*Ocn_ob(m)
...
C Fae_bb(a,e)= -1/2 T2(af,mn)*W2(mn,ef) - T2(mN,aF)*W2(mN,eF)
      ...
      Do n = 1, Nocc_b
      Do f = 1, Nvrt_b
         C = (1.0D0-Ocn_vb(f))*Ocn_ob(n)*Ocn_ob(m)
      ...
      Do n = 1, Nocc_b
      Do f = 1, Nvrt_a
         C = (1.0D0-Ocn_va(F))*Ocn_ob(n)*Ocn_oa(M)
