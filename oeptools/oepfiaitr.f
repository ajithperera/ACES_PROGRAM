...
c MEs are equal to those of non-local exchange potential.
c
...
c therein.
c
c Igor Schweigert, Aug-Sep 2003 $Id: oepfiaitr.FPP,v 1.1.1.1 2008/05/29 19:35:39 taube Exp $
c
      implicit none
c
c     Common blocks
...
c     
 1005 format (
     $     t3,'@OEPFIAITR-F: DGESVD failed to converge')
 1010 format (
     $     t3,'@OEPFIAITR-F: Illegal argument to DGESVD, argument #',
     $     i2)
 1020 format (
     $     t3,'@OEPFIAITR-F: ',i2,' singularities of the auxiliary',/,
