...
c
      zvalao    = setptr(1,1, nbastot)
      zvalprim  = setptr(1,1, totprim)
      znucatt   = setptr(1,1, totprim*totprim)
c
...
c     .. scratch arrays ..
c
      zscraxp   = setptr(1,1, nbastot*totprim)
      zscraxa   = setptr(1,1, nbastot*nbastot)
      zscr1xa   = setptr(1,1, nbastot)
c
