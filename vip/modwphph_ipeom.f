      ...
      SUBROUTINE MODWPHPH_IPEOM(ICORE,MAXCOR,IUHF, FACTOR, LISTFIJ,
     &                          LISTFAB)
C
...
C
      ...
      CALL SSCAL(NFMI(1), -FACTOR, ICORE(I000),1)
      CALL GETLST(ICORE(I020),1,1,1,1,LISTFAB)
      CALL SSCAL(NFEA(1), -HALF*FACTOR, ICORE(I020), 1)
C
...
C
     ...
     $   ICORE(I040),ICORE(I050),ICORE(I060))
      IF (IUHF.NE.0) THEN
         ...
         CALL SSCAL(NFMI(2), -FACTOR, ICORE(I010),1)         
         CALL GETLST(ICORE(I030),1,1,1,2,LISTFAB)
         CALL SSCAL(NFEA(2), -HALF*FACTOR, ICORE(I030), 1)         
C
C TRANSPOSE F(A,C) -> F(C,A)
C
