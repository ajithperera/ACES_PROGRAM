...
C
      SUBROUTINE FormG_leom(ICORE,MAXCOR,IUHF,LISTG,GAE_SCALE,GMI_SCALE)
C
...
CEND
      ...
      DOUBLE PRECISION ONE,ONEM,FACT,GAE_SCALE,GMI_SCALE
...
105     CONTINUE
        CALL SSCAL (LENGIJ,GMI_SCALE,ICORE(I0GIJ),1)
        CALL SSCAL (LENGAB,GAE_SCALE,ICORE(I0GAB),1)
        Call checksum("GAB      :",ICORE(I0GAB),LENGAB)
        Call checksum("GMI      :",ICORE(I0GIJ),LENGIJ)
