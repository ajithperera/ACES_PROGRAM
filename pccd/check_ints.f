      ...
      Integer AAAA_LENGTH_ABCD,BBBB_LENGTH_ABCD,ABAB_LENGTH_ABCD

      Dimension Work(Length)

      Logical null,uhf,Ao_lad 
...
C ABIJ
      ...
      Else
C      Length_14=IDSYMSZ(IRREPX,ISYTYP(1,14),ISYTYP(2,14))
      Length_16=IDSYMSZ(IRREPX,ISYTYP(1,16),ISYTYP(2,16))
C      Call Getall(Work, Length_14, Irrepx, 14)
C      Call checksum("ABIJ-AAAA",Work,Length_14)
      Call Getall(Work, Length_16, Irrepx, 16)
      Call checksum("ABIJ-ABAB",Work,Length_16)
      Endif 
CMBEJ
...
CSSS      Write(6,"(6(1x,F15.10))") (Work(i),i=1,Length_23)
      ...
      Call checksum("MBEJ-ABAB",Work,Length_17)
      Call Getall(Work, Length_18, Irrepx, 18)
      Call checksum("MBEJ-BABA",Work,Length_18)
...
CSSS      Write(6,"(6(1x,F15.10))") (Work(i),i=1,LABAB_LENGTH_ABCD)
      Call Checksum("ABAB_ABCD", Work, LABAB_LENGTH_ABCD)
      Else
      Length_23=IDSYMSZ(IRREPX,ISYTYP(1,23),ISYTYP(2,23))
      Length_25=IDSYMSZ(IRREPX,ISYTYP(1,25),ISYTYP(2,25))
CSSS      Length_26=IDSYMSZ(IRREPX,ISYTYP(1,26),ISYTYP(2,26))
   
      Call Getall(Work, Length_23, Irrepx, 23)
      Call checksum("MBEJ-AAAA",Work,Length_23)
      Call Getall(Work, Length_25, Irrepx, 25)
      Call checksum("MBEJ-ABBA",Work,Length_25)
CSSS      Call Getall(Work, Length_26, Irrepx, 26)
CSSS      Call checksum("MBEJ-BAAB",Work,Length_26)
      Length_18=IDSYMSZ(IRREPX,ISYTYP(1,18),ISYTYP(2,18))
      Call Getall(Work, Length_18, Irrepx, 18)
      Call checksum("MBEJ-BABA",Work,Length_18) 
      Endif 
...
CSS      Write(6,"(6(1x,F15.10))") (Work(i),i=1,Length_27)
