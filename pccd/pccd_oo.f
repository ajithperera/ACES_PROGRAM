      ...
      SUBROUTINE PCCD_OO(DOO,DVV,DVO,IOO,ICORE,MAXCOR,IUHF,
     &                   NONHF_TERMS_EXIST)
C
C DRIVER FOR THE FOLLOWING CONTRIBUTION TO THE Htau_oo:
C
...
C
      ...
      CALL DZERO(IOO,NFMI(1)+IUHF*NFMI(2))
      CALL PCCD_OOINOO(IOO,DOO,ICORE,MAXCOR,IUHF)
      CALL PCCD_VVINOO(IOO,DVV,ICORE,MAXCOR,IUHF)
      IF(NONHF_TERMS_EXIST)THEN
       ...
       ENDIF
       MXCOR=MAXCOR-IBOT+1
       CALL PCCD_VOINOO(IOO,ICORE,ICORE(IBOT),MXCOR,IUHF)
      ENDIF
      RETURN
      END
