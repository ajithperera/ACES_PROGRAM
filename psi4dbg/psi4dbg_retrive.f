      ...
      Subroutine Psi4dbg_retrive(Work,Length,Iuhf)
...
C T2-ABIJ
     ...
     +                                   ISYTYP(2,45))
      ...
      Write(6,*) 
      Call Getall(Work, Length_44, Irrepx, 61)
      Call Putall(Work, Length_44, Irrepx, 44)
      Call checksum("T2-AAAA:",Work,Length_44)

      If (Iuhf .ne. 0) Then
      Call Getall(Work, Length_45, Irrepx, 62)
      Call Putall(Work, Length_45, Irrepx, 45)
      Call checksum("T2-BBBB:",Work,Length_45)
      Endif 
      Call Getall(Work, Length_46, Irrepx, 63)
      Call Putall(Work, Length_46, Irrepx, 46)
