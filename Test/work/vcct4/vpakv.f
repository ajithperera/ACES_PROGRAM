...
c            write(6,*)'nlist,irrep,nsydsz:',nlist,irrep,nsydsz
c            call flush(6)
            call rdlistnew(nlist,irrep,inum,1,t2s,nsydsz)
c            write(6,*)'rdlistnew done'
c            call flush(6)
            do 8 is=1,nsydsz
               kkk=kkk+1
c               write(6,*)'is,kkk,t2s',is,kkk,t2s(is)
c            call flush(6)
