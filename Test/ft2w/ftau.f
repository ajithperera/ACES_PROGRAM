...
C
     ...
     &                    +FACT*T1A(INDAI)*T1A(INDBJ)
     &                    -FACT*T1A(INDAJ)*T1A(INDBI)
20        CONTINUE
10       CONTINUE
C
...
C
          DO 50 IB=1,NUMB
           ...
           DO 60 IA=1,NUMA
            INDAI=INDI+IA
            INDAB=INDAB+1
            T2(INDAB,INDIJ)=T2(INDAB,INDIJ)+FACT*T1A(INDAI)*T1A(INDBJ)
60         CONTINUE
50        CONTINUE
30       CONTINUE
        ENDIF
...
C
        ...
        DO 210 I=1,NUMI
         ...
         DO 220 IA=1,NUMA
          INDAB=INDAB+1
          INDAI=INDI+IA
          T2(INDAB,INDIJ)=T2(INDAB,INDIJ)+FACT*T1A(INDAI)*T1B(INDBJ)
220      CONTINUE
210     CONTINUE
200    CONTINUE
      ENDIF
