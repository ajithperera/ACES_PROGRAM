...
C
      ...
      CALL GETREC(20,'JOBARC','SCFEVCA0',NBAS2*IINTFP,ICORE(I000))
CSSS      call output(icore(i000),1,ncomp,1,ncomp,ncomp,ncomp,1)
C
...
C
      IF(IUHF.NE.0)THEN
       IOFF0=IOFF0+TOTLENA
       CALL GETREC(20,'JOBARC','SCFEVCB0',NBAS2*IINTFP,ICORE(I010))
