      ...
      SUBROUTINE RCC_TRP_CNTRCT(Q,W,T,
...
C SPIN ADAPTED CODE
C
       CALL GETLST(W,1,NUMSYW,2,IRREP,LISTW0)
       CALL SSCAL(NUMSYW*NUMSYW,ONEM,W,1)
CSSS
