      ...
      SUBROUTINE RCC_RNABIJ(ICORE,MAXCOR,IUHF,TYPE)
C
...
CEND
     ...
     &            CC2,RCCD,DRCCD
      ...
      I030=I020+NSCRSZ
      IF(I030.GT.MAXCOR)CALL INSMEM('RCC_RNABIJ',I030,MAXCOR)
C
...
C
      ...
      DO 30 ISPIN=1,1+IUHF
       ...
       NSCRSZ=NNP1O2(NVRTO(ISPIN))+NNP1O2(NOCCO(ISPIN))+
     &        NVRTO(ISPIN)*NOCCO(ISPIN)
       ...
       CALL RCC_SST003(ICORE(I000),ICORE(I010),ICORE(I030),
     &                 MEMLEFT,ISZTOT,ISZTAR,ICORE(I020),
     &                 SPCAS2,RERDTP)
