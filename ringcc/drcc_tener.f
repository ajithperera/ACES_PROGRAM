      ...
      SUBROUTINE DRCC_TENER(NLIST,ET2,EAA,NUMSYT,DISSYT,T2,W,T1A,
...
CEND
      ...
      LOGICAL TAU
      INTEGER DISSYT,POP1,POP2,VRT1,VRT2,DIRPRD
...
C Notice that the TAU is set to false in the calling routine for 
C all ring  CC methods.

      IF (ISPIN .LT. 3) THEN
         CALL GETLST(W, 1,NUMSYT,2,IRREP,ISPIN)
      ELSE
