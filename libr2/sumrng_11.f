      ...
      SUBROUTINE SUMRNG_11(T2AIBJ,T2AJBI,ISCR,NSZ1,NSZ2,ISCRSZ)
C
...
CEND
     ...
     &                DIRPRD(8,8)
      ...
      DATA ONE /1.0/
C      CALL GETALL(T2AJBI,NSZ2,1,43)
C      CALL SSTRNG(T2AJBI,T2AIBJ,NSZ2,NSZ1,ISCR,'ABBA')
      CALL GETALL(T2AIBJ,NSZ1,1,42)
C      CALL SAXPY(NSZ1,ONE,T2AJBI,1,T2AIBJ,1)
