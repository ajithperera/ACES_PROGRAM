      ...
      SUBROUTINE PDCC_G2X2AA(T2,Z2,T1A,TAU,ISPIN,FMI,POP,VRT,NOCCSQ,
     &                  DISSYT,DISSYZ,NUMSYT,NUMSYZ,NFSIZ,
     &                  LISTT,LISTZ,IRREP,TMP,FACT)
...
C
      ...
      CALL DSCAL(NUMSYZ*DISSYZ,FACT,T2,1)
        Write(6,*)
        write(6,"(a,F5.2)") "Gmi*tau-AA scaling factor :", Fact
