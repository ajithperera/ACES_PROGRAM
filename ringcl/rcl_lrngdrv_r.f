      ...
      SUBROUTINE RCL_LRNGDRV_R(ICORE,MAXCOR,LISTW,LISTT,CALMOD,MAXSIZ,
     &                         INCREM,LSTSCR)
...
C
         ...
         CALL RCL_LRNGPRD(ICORE(I020),ICORE(I010),ICORE(I000),
     &                    ICORE(I030),
     &                    DISSYW,NUMSYW,DISSYT,NUMSYT,DISSYQ,NUMSYQ,
     &                    LISTW,LISTT,IRREP,SPINAD,MAXCOR-I030)
        ELSE
...
C This symmetrization take care of the permutation P(ab)P(ij) for RHF
