...
C     versions). lcct is not linked against vcc5t in the shared
...
C     interface mismatch (ltrps.f only ever passes 3 actual arguments)
C     that reads garbage into EXTRNL_CCSD and crashes deep inside
C     GETLST/PUTLST. See ACES II test suite cases_pending/014b.apt.
