      SUBROUTINE TPDIJAB2(ICORE,MAXCOR,IUHF,LISTL1,LISTL1OFF,LISTL2,
     &   LISTR1,LISTR1OFF)
...
C
        ENDIF
        call checksum('tpdijab2',icore(i0z(ispin)),DISSYT2)
C
...
C
     ...
     &             IRREP,IRREPX,ISPIN)
         ENDIF
C
         call checksum('tpdijab2',icore(i000),numsyg*dissyg)
C
