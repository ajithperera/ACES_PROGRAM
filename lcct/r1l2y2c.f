      SUBROUTINE R1L2Y2C(R1,ICORE,MAXCOR,IUHF,LISTL2)
C
...
c        call checksum('r1l2y2c r',icore(i000),numdsz*dissyz)
...
C
          CALL GETLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
          CALL SAXPY (NUMDSZ*DISSYZ,ONE,ICORE(I010),1,ICORE(I000),1)
c        call checksum('2c 1',icore(i000),numdsz*dissyz)
          CALL PUTLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
C
1010     CONTINUE
C
...
C
         CALL GETLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
c        call checksum('2c 2',icore(i000),numdsz*dissyz)
         CALL SAXPY (NUMDSZ*DISSYZ,ONE,ICORE(I010),1,ICORE(I000),1)
c        call checksum('2c 2add',icore(i000),numdsz*dissyz)
         CALL PUTLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
C
         I000=1
...
C
         CALL GETLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
c        call checksum('2c 3',icore(i000),numdsz*dissyz)
         CALL SAXPY (NUMDSZ*DISSYZ,ONE,ICORE(I010),1,ICORE(I000),1)
c        call checksum('2c 3add',icore(i000),numdsz*dissyz)
         CALL PUTLST(ICORE(I000),1,NUMDSZ,1,IRREPR,LISTZ)
C
2010    CONTINUE
C
