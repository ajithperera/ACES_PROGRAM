      SUBROUTINE TPDABCI2(ICORE,MAXCOR,IUHF,LISTL2,LISTR1,LISTR1OFF,
     &   LISTR2)
C
...
c       LISTL=443+MIN(ISPIN,3)
       LISTL=LISTL2-1+MIN(ISPIN,3)  
c       LISTR=460+MIN(ISPIN,3)
       LISTR=LISTR2-1+MIN(ISPIN,3)
       LISTG=126+ISPIN
