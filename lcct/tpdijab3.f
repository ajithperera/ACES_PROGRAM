      SUBROUTINE TPDIJAB3(ICORE,MAXCOR,IUHF,LISTL1,LISTL1OFF,LISTL2NRS,
     &   LISTL2RS,LISTR1,LISTR1OFF,LISTR2NRS)
...
c       CALL GETLST(ICORE(I0L(2)),1,1,1,2,490)
       CALL GETLST(ICORE(I0R(2)),1,1,1,LISTR1OFF+1,LISTR1)
...
C
        IF (MBPT2 .AND. .NOT.DD) GOTO 10000
C
...
C
      IF (CC .OR. DD)
     &   CALL Y2XR2(ICORE,I0Y1,I0Y2,ISTART,MAXCOR,IUHF,LISTR2NRS,114)
C
C ALL DONE, RETURN
C
      TWO=0.D0
