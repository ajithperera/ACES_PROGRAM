     ...
     &                   IOFFT1,IOFFR1,ISPIN,IUHF,LISTR2RS)
C
...
c       LISTW=413+ISPIN
     ...
     &               VRT(1,ISPIN),TWO,SPCASE,IUHF,LISTR2RS)
C
C               AB         Ae
