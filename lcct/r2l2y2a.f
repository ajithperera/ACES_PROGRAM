      SUBROUTINE R2L2Y2A(ICORE,MAXCOR,IUHF,LISTLRS,LISTRRS)
C
...
C
         IRREPL=DIRPRD(IRREPR,IRREPX)
C
         LISTR1=LISTRRS-1+ISPIN
         LISTL1=LISTLRS-1+ISPIN
         LISTR2=LISTRRS+1+ISPIN
         LISTL2=LISTLRS+4-ISPIN
C   
...
C 
         IRREPL=DIRPRD(IRREPR,IRREPX)
         LISTL1=LISTLRS-1+ISPIN
         LISTR1=LISTRRS+4-ISPIN
         LISTL2=LISTLRS+4-ISPIN
         LISTR2=LISTRRS+2-ISPIN
C  
...
C
         IRREPL=DIRPRD(IRREPR,IRREPX)
C
         LISTR=LISTRRS+3+ISPIN
         LISTL=LISTLRS+6-ISPIN
C 
