      ...
      SUBROUTINE T1RING_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,
     &           LISTTOFF)
C
...
C
      ...
      IF (AOBASIS) THEN
       ...
       DO 1111 ISPIN=1,1+IUHF
        CALL UPDMOI(1,NFMI(ISPIN),6+ISPIN,92+IOFFLIST,0,0)
        CALL GETLST(ICORE(I000),1,1,1,ISPIN,92+IOFFLIST)
        CALL PUTLST(ICORE(I000),1,1,1,6+ISPIN,92+IOFFLIST)
1111   CONTINUE
      ENDIF
C
...
10    CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL T1RA01_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ELSE
       CALL T1RA02_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ENDIF
C
...
110   CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL T1RB01_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ELSE
       CALL T1RB02_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ENDIF
C
...
C
      IF (AOBASIS) THEN
       ...
       DO 2222 ISPIN=1,1+IUHF
        ...
        CALL GETLST(ICORE(I000),1,1,1,ISPIN,92+IOFFLIST)
        CALL GETLST(ICORE(I010),1,1,1,6+ISPIN,92+IOFFLIST)
...
210   CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL T1RC01_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ELSE
       CALL T1RC02_R(ICORE,MAXCOR,IUHF,LAMBDA,IOFFLIST,LISTT,LISTTOFF)
      ENDIF
      RETURN
      END
