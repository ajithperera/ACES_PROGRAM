      SUBROUTINE T1W2AA_R(W,Z,T,F,POP,VRT,DISSYZ,DISSYW,NUMSYZ,
...
c      CALL ASSYM(IRREP,POP,DISSYZ,DISSYZ,W,Z)
c      CALL GETLST(Z,1,NUMSYZ,1,IRREP,LISTZ)
c      CALL VADD(Z,Z,W,NUMSYZ*DISSYZ,ONE)
c      CALL PUTLST(Z,1,NUMSYZ,1,IRREP,LISTZ)
      ENDIF
      RETURN
      END
