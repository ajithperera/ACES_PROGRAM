      SUBROUTINE TPDIJKA5(ICORE,MAXCOR,IUHF,LISTL2,LISTR1,LISTR1OFF)
...
1100    CONTINUE
C
       call checksum('tpdijka5',icore(i000),irpdpd(irrepx,20+ispin))
1000   CONTINUE
C
C FORM G*T TERMS
C
...
C
          call checksum('tpdijka5',icore(i010),numsyg*dissyg) 
