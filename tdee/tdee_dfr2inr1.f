      ...
      SUBROUTINE TDEE_DFR2INR1(ICORE,MAXCOR,IUHF,ISPIN,IRREPX)
C
...
C
      ...
      CALL GETLST(ICORE(I000),1,1,1,1,390)
C
      CALL TDEE_GT2XF(ICORE(I0TA),IRREPX,1,304,93,0,ICORE(I000),
     &                MXCOR,IUHF,0)
C
      CALL GETLST(ICORE(I000),1,1,1,1,394)
      CALL SAXPY (LENA,ONE,ICORE(I000),1,ICORE(I0TA),1)
      CALL PUTLST(ICORE(I0TA) ,1,1,1,1,394)

      IF(IUHF.NE.0)THEN
       CALL GETLST(ICORE(I000),1,1,1,2,394)
       CALL SAXPY (LENB,ONE,ICORE(I000),1,ICORE(I0TB),1)
       CALL PUTLST(ICORE(I0TB) ,1,1,1,2,394)
      ENDIF
C
      RETURN
      END
