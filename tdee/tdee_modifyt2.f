      ...
      SUBROUTINE TDEE_MODIFYT2(ICORE,MAXCOR,IUHF,IRREPX,FACT)
C
...
C
      ...
      CALL GETLST(ICORE(I0C(1)),1,1,1,1,390)
      IF(IUHF.NE.0)THEN
       I0C(2)=I0C(1)+IINTFP*IRPDPD(IRREPX,9)
       CALL GETLST(ICORE(I0C(2)),1,1,1,2,390)
      ELSE
       I0C(2)=I0C(1)
      ENDIF
...
C
      DO 10 IRREPIJ=1,NIRREP
       ...
       CALL GETLST(ICORE(I000),1,NUMDST,1,IRREPIJ,316)
...
c     &           NUMDST,POP(1,1),POP(1,2),VRT(1,1),VRT(1,2),IRREP,
c     &           3,FACT)
       CALL PUTLST(ICORE(I000),1,NUMDST,1,IRREPIJ,316)
10    CONTINUE
C
      IF(IUHF.NE.0)THEN
       DO 20 ISPIN=1,2
        DO 21 IRREPIJ=1,NIRREP
         ...
         CALL GETLST(ICORE(I000),1,NUMDST,1,IRREPIJ,313+ISPIN)
         CALL DTAU(IRREPAB,IRREPIJ,1,IRREPX,ICORE(I000),
     &             ICORE(I0T(ISPIN)),ICORE(I0T(ISPIN)),
     &             ICORE(I0C(ISPIN)),ICORE(I0C(ISPIN)),ISPIN,FACT)
         CALL PUTLST(ICORE(I000),1,NUMDST,1,IRREPIJ,313+ISPIN)
21      CONTINUE
20     CONTINUE
      ENDIF
C
