      ...
      SUBROUTINE TDEE_GT2XF(Z,IRREPA,IRREPB,LISTA0,LISTB,IOF0,
...
CEND
      ...
      INTEGER DIRPRD,POP,VRT,DISSIZ,DISSYA
      DIMENSION SCR(MAXCOR),Z(*)
      DIMENSION ITPOS(8,3),ISPOS(8,3)
...
C
      ...
      DO 10 ISPIN=IBOT,ITOP
       IOFF=1+(ISPIN-1)*IRPDPD(IRREPZ,9)
       IRREPAR=IRREPB
       IRREPAL=IRREPZ
