      ...
      SUBROUTINE TDEE_GFORMG2(IRREPC,IRREPT,LISTC0,LISTT0,LISTG,ICORE,
...
C ARE WRITTEN TO LISTS LISTG+81 AND LISTG+82.
C
C
CEND
...
C
       ...
       CALL GETLST(ICORE(I000),1,1,1,1+IOF0,LISTG+81)
       CALL SAXPY (LENGIJ,ONE,ICORE(I000),1,ICORE(I0GIJ),1)
       CALL PUTLST(ICORE(I0GIJ),1,1,1,1+IOF0,LISTG+81)
       CALL GETLST(ICORE(I000),1,1,1,1+IOF0,LISTG+82)
       CALL SAXPY (LENGAB,ONE,ICORE(I000),1,ICORE(I0GAB),1)
       CALL PUTLST(ICORE(I0GAB),1,1,1,1+IOF0,LISTG+82)
C
      ELSE
C
       DO 100 ISPIN=1,2
...
105     CONTINUE
        CALL SSCAL (LENGIJ,Gmi_scale,ICORE(I0GIJ),1)
        CALL SSCAL (LENGAB,Gae_scale,ICORE(I0GAB),1)
        CALL GETLST(ICORE(I000),1,1,1,ISPIN+IOF0,LISTG+81)
        CALL SAXPY (LENGIJ,ONE,ICORE(I000),1,ICORE(I0GIJ),1)
        CALL PUTLST(ICORE(I0GIJ),1,1,1,ISPIN+IOF0,LISTG+81)
        CALL GETLST(ICORE(I000),1,1,1,ISPIN+IOF0,LISTG+82)
        CALL SAXPY (LENGAB,ONE,ICORE(I000),1,ICORE(I0GAB),1)
        CALL PUTLST(ICORE(I0GAB),1,1,1,ISPIN+IOF0,LISTG+82)
C
100    CONTINUE
C 
      ENDIF
