      ...
      Subroutine Tdee_screen_eigs_strict(Eig_vals,Leig_vecs,
...
c to save time, but easier to extend. 
      ...
      Do N = 1, Ncol
        ...
        Ioffsp = 0
         ...
         Call Tdee_normaliz_init_vec(Reig_Vecs(1,N),Nrow)
     ...
     +               Reig_vecs(1,N),Nrow,Null,Scr(I020),Nsize)
      ...
      call checksum("Q*R_n        :",Scr(I020),Nsize,s)
         Call Tdee_dump_vec(Irrepx,Scr(I020),Nsize,
     +                      Mubar_s_pq_t0,Ioffr1,Ioffsp,
     +                      Mubar_d_pq_t0,Ioffr2,Iuhf,.False.)

         Call Tdee_hbar_mult(Scr(Iend),Memleft,Iuhf,Irrepx,1)

         Call Tdee_Load_vec(Irrepx,Scr(I030),Nsize,
     +                      Mubar_s_pq_tn,Ioffr1,Mubar_d_pq_tn,
     +                      Ioffr2,Iuhf,.False.)
         Call Tdee_normaliz_init_vec(Scr(I030),Nsize)
