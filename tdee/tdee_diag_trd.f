      ...
      Subroutine Tdee_diag_trd(Work,Memleft,Nrow,Nsize,Iuhf,Irrepx)
...
C Save the righr eigenvectors to I050 before residual is built
         ...
         Call Tdee_screen_eigs_strict(Work(I000),Work(I020),
     +                                Work(I030),Work(I040),
     +                                Work(Iend),Nrow,Ncol,
...
C that we always do a one more iteration than the requested.
     ...
     +                                        Memleft)
         Memleft = Memleft - Iend
         Call Tdee_screen_eigs_light(Work(I000),Work(I020),
     +                               Work(I030),Work(I040),
     +                               Work(I050),
...
C functions.
      ...
      Call tdee_built_dp_respns(Work(I000),Work(I020),Work(I030),
