      SUBROUTINE PDCC_DRLAD(ICORE,MAXCOR,IUHF,ITYPE)
C
...
C
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW) THEN
          CALL PDCC_LADAA1(ICORE(I020),ICORE(I000),ICORE(I010),MAXSIZE,
...
C
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW) THEN
          CALL PDCC_LADAB1(ICORE(I020),ICORE(I000),ICORE(I010),MAXSIZE,
     &                DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,LISTT,ITYPE,
     &                IRREP,ICORE(I0TA),ICORE(I0TB),TAU,POP(1,1),
     &                POP(1,2),VRT(1,1),VRT(1,2),ELADAB,MODIF,IUHF)
C
