      SUBROUTINE T1INW2(ICORE,MAXCOR,IUHF)
C
...
C   IN CORE VERSION
C
          CALL T1W2AA(ICORE(I001),ICORE(I002),ICORE(IT),ICORE(IFMI),
...
C
     ...
     &                      DISSYWB)
       IF(I004.LT.MXCOR) THEN
C
        CALL T1W2AB(ICORE(I001),ICORE(I002),ICORE(I0TA),ICORE(I0TB),
...
C
      ...
      IF(IUHF.EQ.1) CALL PUTLST(ICORE(I0BB),1,1,1,2,91)
      RETURN
      END
