      SUBROUTINE T2ITER2(ICORE,MAXCOR,IUHF,ET2)
C
...
1000   FORMAT(T3,'@T2ITER2-I, Beginning iterative solution for ',A2,
     &           ' amplitudes.')
       Z=0.0
...
C
CJDW 3/18/98. Try to let RHF calculations run correctly.
C
        IF(IUHF.EQ.0)THEN
