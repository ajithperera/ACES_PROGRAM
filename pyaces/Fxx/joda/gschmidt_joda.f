      SUBROUTINE GSCHMIDT_JODA(VORTH,NSIZE,NDIM,TMP,RESID)
C
...
C
      Write(6,*) 
      write(6,"(a)") 'Non-orthogonal vectors in gschmidt_joda'
      call output(vorth,1,nsize,1,ndim,nsize,ndim,1)
      do i = 1, ndim
         TMP(i)=SDOT(NSIZE,VORTH(1,I),1,VORTH(1,I),1)
      enddo  
      Write(6,*)
      write(6,"(a)") 'Old overlap in gschmidt_joda'
...
C
      ...
      write(6,*)
      write(6,"(a)") 'Orthogonal vectors in gschmidt_joda'
      call output(vorth,1,nsize,1,ndim,nsize,ndim,1)
      do i = 1, ndim
         TMP(i)=SDOT(NSIZE,VORTH(1,I),1,VORTH(1,I),1)
      enddo
      Write(6,*)
      write(6,"(a)") 'Current overlap in gschmidt_joda'
      Write(6, "(6(1x,F12.6))") (Tmp(i), i=1, NSIZE)
C
      RETURN
      END
