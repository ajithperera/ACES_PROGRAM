...
c      call scopy(numsyg*dissyg,icore(i010),1,icore(i000),1)
      call checksum('y2xr2 1 ',icore(I000),numsyg*dissyg)
      IF(IUHF.EQ.0) THEN
C
...
C
       ENDIF
      call checksum('y2xr2 2 ',icore(I000),numsyg*dissyg)
C
C UPDATE G(IJ,AB) ON DISK
C
       CALL GETLST(ICORE(I010),1,NUMSYG,1,IRREPR,LISTG)
      call checksum('y2xr2 3 ',icore(I010),numsyg*dissyg)
       CALL SAXPY(NUMSYG*DISSYG,ONE,ICORE(I010),1,ICORE(I000),1)
      call checksum('y2xr2 4 ',icore(I000),numsyg*dissyg)
       CALL PUTLST(ICORE(I000),1,NUMSYG,1,IRREPR,LISTG)
C
200   CONTINUE
C
