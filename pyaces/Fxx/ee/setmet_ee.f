      ...
      SUBROUTINE SETMET_EE(ICORE,MAXCOR,IUHF)
     ...
     &                 ITRANSY,ITRANSZ,NUCIND
      ...
      COMMON /PROJECT_/ IPROJECT, IPATTERN_, NCALC, ICALC, IWINDOW(8)
...
C
C   LOGIC TO DETERMINE COMMON BLOCK /PROJECT_/
C
...
C algorithm 
      ...
      IF (IFLAGS2(177) .EQ. 1) THEN
         DAVID       = .FALSE.
         BLOCK_DAVID = .TRUE.
      ELSEIF  (IFLAGS2(177) .EQ. 2) THEN
         DAVID       = .FALSE.
         LANCZOS     = .TRUE.
      ENDIF 
C
