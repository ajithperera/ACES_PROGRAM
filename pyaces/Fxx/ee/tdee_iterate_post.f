...
C Source and target singels
      ...
      If (Iside .EQ.1) Then
         ...
         Call checksum("list-394-AA      :",Work,Pha_length)
         Call Putlst(Work,1,1,1,3,490)
         If (Iuhf .EQ. 1) Then
            Call Getlst(Work,1,1,1,2,394)
            Call checksum("list-394-BB      :",Work,Phb_length)
            Call Putlst(Work,1,1,1,4,490)
         Endif 
      Else if (Iside .EQ. 2) Then
         Call Getlst(Work,1,1,1,1,396)
         Call checksum("list-396-AA      :",Work,Pha_length)
         Call Putlst(Work,1,1,1,3,490)
         If (Iuhf .EQ. 1) Then
            Call Getlst(Work,1,1,1,2,396)
            Call checksum("list-396-BB      :",Work,Phb_length)
            Call Putlst(Work,1,1,1,4,490)
         Endif
      Endif 
