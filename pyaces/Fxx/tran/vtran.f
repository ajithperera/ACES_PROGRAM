      ...
      SUBROUTINE VTRAN(ICORE,MAXCOR,IUHF)
C
...
C                               THEN ALL VIRTUALS
C
      CALL GTNRB2(ICORE,MAXCOR,IUHF,NBASIS,NBASIS,1)
C 
...
C
      CALL SYMDRV_TRAN(ICORE,MAXCOR,NCOMP,IUHF)
CSSS      CALL SYMDRV_TRAN(NCOMP,IUHF)
c-----------------------------------------------------------------------
...
c-----------------------------------------------------------------------
     ...
     &            ICORE(I060))
       NCOMP=NBASIS-NDROP
       CALL SYMDRV_TRAN(ICORE(I0),MAXCOR,NCOMP,IUHF)
      endif 
c-----------------------------------------------------------------------
      RETURN
      END
