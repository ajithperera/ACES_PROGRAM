      SUBROUTINE PDCC_T1RB02(ICORE,MAXCOR,IUHF,LAMBDA)
C
...
C
CSSS        IF(.NOT.LAMBDA) THEN
CSSS        IF(ISPIN.EQ.1)THEN
CSSS         CALL TRACEOO('OVVO',IRREPDO,POP(1,2),VRT(1,1),DISTAR,
CSSS     &                SIZEVV(1),ICORE(I000),ICORE(I010))
CSSS         CALL SUMSYM3(ICORE(I010),ICORE(I020),SIZEVV(1),
CSSS     &                1,1,LSTFEA)
CSSS        ELSE
CSSS         CALL TRACEOO('OVOV',IRREPDO,POP(1,1),VRT(1,2),DISTAR,
CSSS     &                SIZEVV(2),ICORE(I000),ICORE(I010))
CSSS         CALL SUMSYM3(ICORE(I010),ICORE(I020),SIZEVV(2),
CSSS     &                1,2,LSTFEA)
CSSS        ENDIF
CSSS        ENDIF
C
