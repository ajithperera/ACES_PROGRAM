      ...
      SUBROUTINE PDCC_T1RING(ICORE,MAXCOR,IUHF,LAMBDA)
C
...
10    CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL PDCC_T1RA01(ICORE,MAXCOR,IUHF,LAMBDA)
      ELSE
       CALL PDCC_T1RA02(ICORE,MAXCOR,IUHF,LAMBDA)
      ENDIF
C
...
110   CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL PDCC_T1RB01(ICORE,MAXCOR,IUHF,LAMBDA)
      ELSE
       CALL PDCC_T1RB02(ICORE,MAXCOR,IUHF,LAMBDA)
      ENDIF
C
...
210   CONTINUE
      IF(INEED.LT.MAXCOR/IINTFP)THEN
       CALL PDCC_T1RC01(ICORE,MAXCOR,IUHF,LAMBDA)
      ELSE
       CALL PDCc_T1RC02(ICORE,MAXCOR,IUHF,LAMBDA)
      ENDIF
      RETURN
      END
