      ...
      SUBROUTINE T2FT3_HT3C3(T3,W,CORE,IADT3,IADW,IRPI,IRPJ,IRPK,
     &                       IRPIJ,IRPIK,IRPJK,IRPIJK,I,J,K,SCR1,
     &                       SCR2,SCR3,ICLLVL,IMODE,LAMBDA)

      IMPLICIT INTEGER (A-Z)
      LOGICAL LAMBDA
      DOUBLE PRECISION T3(1),W(1),CORE(1),SCR1(1),SCR2(1),SCR3(1)
...
C     List offset
      ...
      ENDIF
C
C     ROUTINE TO COMPUTE INCLUSION OF F*T3 BBA IN T2 BB OR T2 AB.
C
C
      ISPIN1 = 2
      ISPIN2 = 1
C
C     --- BB D2T2 INCREMENTS ---
C
C      AB  AB                      ABC
...
C
C     --- TRANSPOSE CURRENT PIECE OF INCREMENT IN PLACE. ---
C
CJ      CALL SYMTR3(IRPIK,VRT(1,2),VRT(1,1),LENT2,1,CORE(IADT2),
CJ     1            SCR1,SCR2,SCR3)
C
C     --- READ T2 INCREMENT, ADD CURRENT PIECE, AND WRITE SUM BACK ---
C     ---                      TO DISK.                            ---
...
C     --- TRANSPOSE CURRENT PIECE OF INCREMENT IN PLACE. ---
C
CJ      CALL SYMTR3(IRPJK,VRT(1,2),VRT(1,1),LENT2,1,CORE(IADT2),
CJ     1            SCR1,SCR2,SCR3)
C
C
C     --- READ T2 INCREMENT, ADD CURRENT PIECE, AND WRITE SUM BACK ---
