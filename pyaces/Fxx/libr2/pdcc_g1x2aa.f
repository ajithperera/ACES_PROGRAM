      SUBROUTINE PDCC_G1X2AA(T2,Z2,T,Z,T1A,TAU,ISPIN,FEA,POP,VRT,
     &                       NVRTSQ,DISSYT,DISSYZ,NUMSYT,NUMSYZ,
     &                       NFSIZ,LISTT,LISTZ,IRREP,TMP,FACT)
...
C
        ...
        Write(6,*) 
        write(6,"(a,F5.2)") "Gae*tau-AA scaling factor :", Fact
