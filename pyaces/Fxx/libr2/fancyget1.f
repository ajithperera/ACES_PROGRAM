      ...
      SUBROUTINE FANCYGET1(Z,BUF,GETTYP,PERM,NUMP,NUMQ,NUMR,NUMS,
     &                     IFIRST,NUMREC,ICACHE,IRREPGET,LIST,SPINAD,
     &                     TMP,ITMP)
C
...
C
C  THIS ROUTINE READS ``SPIN-ADAPTED'' LISTS, NOTE THAT THE
C  SPIN-ADAPTION IS DONE ON THE FLY !
C
CEND
      IMPLICIT INTEGER (A-Z)
      LOGICAL SPINAD
      DOUBLE PRECISION Z(1),BUF(1),TMP(1)
      CHARACTER*2 GETTYP
      CHARACTER*4 PERM
...
C
        DO 130 ICOUNT4=1,NUMS(IRREPS)
         DO 140 ICOUNT3=1,NUMR(IRREPR)
          ...
          IF(SPINAD) THEN
           CALL SPINAD3(IRREPON,NUMP,DSZPCK(IRREPON),1,BUF,TMP,ITMP)
          ENDIF 
