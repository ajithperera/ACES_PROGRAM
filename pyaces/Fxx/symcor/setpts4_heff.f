...
c     
     ...
     $              points(ioffp), 1)
      ...
      write(6,*) ' npoint after -q displacements ', npoint
c     
      if (iflags2(157) .eq. 8 .or. 
     $     iflags2(157) .eq. 9) then
c     
...
c     
      if (iflags2(157) .eq. 3 .or. 
     $     iflags2(157) .eq. 4 .or.
     $     iflags2(157) .eq. 6 .or. 
     &     iflags2(157) .eq. 7 .or.
     $     iflags2(157) .eq. 10 .or. 
     &     iflags2(157) .eq. 11) then
c     
