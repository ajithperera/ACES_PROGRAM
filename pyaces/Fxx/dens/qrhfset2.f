...
C
      ...
      if (nmod.gt.255) then
         print *, '@QRHFSET2: Assertion failed.'
...
C      
c---------------
      write (6,2012) (poprhf(i),i=1,8),(vrtrhf(i),i=1,8)  
 2012 format (4x,' poprhf in qrhfset2 =',8i4, 
     &       /4x,' vrtrhf in qrhfset2 =',8i4) 
      write (6,2013) (nosh1(i),i=1,8),(nosh2(i),i=1,8)  
 2013 format (4x,' nosh1  in qrhfset2 =',8i4, 
     &       /4x,' nosh2  in qrhfset2 =',8i4) 
      write (6,2014) (popdoc(i),i=1,8),(vrtdoc(i),i=1,8)  
 2014 format (4x,' popdoc in qrhfset2 =',8i4, 
     &       /4x,' vrtdoc in qrhfset2 =',8i4) 
      write (6,2015) nai,n1i,n2a,numiscf,numascf 
 2015 format (4x,' in qrhfset2  nai n1i n2a numiscf numascf =',5i4) 
c---------------
      RETURN
      END
