      ...
      SUBROUTINE GAMDRV(ICORE,MAXCOR,IUHF)
C
...
C
      IF (.NOT. LTRP) CALL INIGAM_DENS(ICORE, MAXCOR,IUHF)
      IF(CIS)THEN
...
C
      ...
      write(6,"(a)") "Checksums of G(ab,ci)"
       CALL GAMMA5_DENS(ICORE,MAXCOR,IUHF)
      write(6,*)
      write(6,"(a)") "Checksums of G(ij,ka)"
       CALL GAMMA6_DENS(ICORE,MAXCOR,IUHF)
