      ...
      SUBROUTINE CONSTRUCT_T1T1T2L2(ICORE,MAXCOR,IUHF)
C
       ...
       DO 100 IRREP=1,NIRREP
        ...
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(I030.LT.MXCOR)THEN
          CALL PDCC_V1X2AA(ICORE(I000),ICORE(I010),ICORE(I020),DISSYW,
     &                NUMSYW,DISSYT,NUMSYT,LISTW,LISTT,ITYPE,IRREP,
     &                ICORE(I0T),TAU,POP(1,ISPIN),VRT(1,ISPIN),
     &                LISTZ,ISPIN)
         ELSE
          CALL INSMEM('PDCC_V1X2AA',I030,MXCOR)
         ENDIF
        ENDIF
100    CONTINUE
      ELSE
...
C
        ...
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(I030.LT.MXCOR)THEN
          CALL PDCC_V1X2AB(ICORE(I000),ICORE(I010),ICORE(I020),DISSYW,
     &                NUMSYW,DISSYT,NUMSYT,LISTW,LISTT,ITYPE,IRREP,
     &                ICORE(I0TA),ICORE(I0TB),TAU,POP(1,1),POP(1,2),
     &                VRT(1,1),VRT(1,2),IUHF)
C
         ELSE
          CALL INSMEM('PDCC_V1X2AB',I030,MXCOR)
         ENDIF
        ENDIF
110    CONTINUE
      ENDIF
