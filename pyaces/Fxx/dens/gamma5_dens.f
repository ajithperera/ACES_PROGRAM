      ...
      SUBROUTINE GAMMA5_DENS(ICORE,MAXCOR,IUHF)
C
C
...
C
      ...
      if(iuhf.eq.0) then
       call checkgam1_der(icore,30,130,two,iuhf,2,vrt)
      endif
      IF(IUHF.EQ.1) THEN
       CALL CHECKGAM_der(ICORE,30,130,TWO)
       CALL CHECKGAM_der(ICORE,27,127,TWO)
       CALL CHECKGAM_der(ICORE,28,128,TWO)
       CALL CHECKGAM_der(ICORE,29,129,TWO)
      ENDIF
C
      RETURN
      END
