      SUBROUTINE GETGX7T (G,TMP,LBL0,NBL0,I2,IRREP,LISTG,ISPIN) 
...
C
     ...
     x    nab.ne.lbl0)  THEN
      write(6,111) listg
 111  format (3x,'start of getgx7t with listg=',i5) 
...
C-----------------------
 ...
 950   format (4x,'Some error (getgx7t) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
