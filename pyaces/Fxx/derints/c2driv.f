      ...
      SUBROUTINE C2DRIV(NHKT3,NHKT4,KHKT3,KHKT4,KHKT12,KHKT34,KH1234,
...
C
      ...
      IF (IPRINT .GE. 10 .AND. Ienter .EQ.2) THEN
         ...
         WRITE (LUPRI, 1020) KHKT3, KHKT4
         WRITE (LUPRI, 1030) KHKT34
         WRITE (LUPRI, 1040) DIAG34
         WRITE (LUPRI, 1050) NORB34
         WRITE (LUPRI, 1060) NUC34
         WRITE (LUPRI, 1070) ID340X, ID340Y, ID340Z
         WRITE (LUPRI, 1080) ISTEP3, ISTEP4
         WRITE (LUPRI, 1100) NCCPP
         WRITE (LUPRI, 1110) NORB12*NORB34
         WRITE (LUPRI, 1005) DC2H
         WRITE (LUPRI, 1006) DC2E
         WRITE (LUPRI, 1220) (LVALU3(I), I = 1, KHKT3)
         WRITE (LUPRI, 1230) (MVALU3(I), I = 1, KHKT3)
         WRITE (LUPRI, 1240) (NVALU3(I), I = 1, KHKT3)
         WRITE (LUPRI, 1250) (LVALU4(I), I = 1, KHKT4)
         WRITE (LUPRI, 1260) (MVALU4(I), I = 1, KHKT4)
         WRITE (LUPRI, 1270) (NVALU4(I), I = 1, KHKT4)
      END IF
C
C     ***** CALL INITIALIZATION ROUTINES *****
C
      IF (DC2H) CALL C2HINI(WORK1,LWORK1)
      IF (DC2E) CALL C2EINI(WORk1,LWORK1,Ienter)
      IF (IPRINT .GE. 10) WRITE (LUPRI, 1120) IWKLST
C
C     *********************************************
...
C
            IF (DC2H) CALL C2HCAL(WORK1,LWORK1)
C
C           DERATIVES ON EACH SEPARATE NUCLEUS
C
CSSS            If (ienter .eq. 2) Write(6,*) "Entering C2ECAL",PATH1
            IF (DC2E) CALL C2ECAL(WORK1,LWORK1,Ienter)
C
  300    CONTINUE
  200 CONTINUE
      RETURN
 1000 FORMAT (//,1X,'<<<<<<<<<< SUBROUTINE C2DRIV >>>>>>>>>>',/)
