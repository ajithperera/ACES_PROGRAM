       ...
       SUBROUTINE RXPINT(NHKTA,NHKTB,KHKTA,KHKTB,LDIAG,ISTEPA,ISTEPB,
     *                  ONECEN,CORPX,CORPY,CORPZ,EXPPI,DIFDIP,WORK1)
C
C  CALCULATES INTEGRALS OVER THE ANGULAR MOMENTUM OPERATOR
C
CEND
C
C JG 4/91
...
CSSS                  RLMCOF(LWKRLM),WK3HGH
     ...
     *                IA0Y0Z, IA0Z0X, IA0Z0Y, IA0Z0Z
      COMMON/POINT3/IL000X,IL000Y,IL000Z
