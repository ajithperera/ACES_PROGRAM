...
C WARNING WARNING WARNING WARNING WARNING WARNING WARNING
      SUBROUTINE V2JA(ICORE,ICRSIZ,IUHF)
C:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
C
C ROUTINES REQUIRED
      External ErrEx, AOSize, CrapsI, PutRec, GetRec, IZero, aces_fin,
...
C   AO2SOINV         : the inverse transformation of AO2SO
...
C
C     Include 'memman.inc'
C $Id: v2ja.F,v 1.6 2008/11/19 15:48:33 perera Exp $
      integer icrsiz
      integer icore(icrsiz)
      integer iuhf
      integer i0
C     Include 'memini.inc'
C $Id: v2ja.F,v 1.6 2008/11/19 15:48:33 perera Exp $
C     Include 'mach.inc'
C $Id: v2ja.F,v 1.6 2008/11/19 15:48:33 perera Exp $
...
C
      I0 = 1
      Call CrapsI (ICore(1), LJunk, 0)
C
      SEWARD = IFLAGS(56).EQ.4
      IACESIII = 0
      CALL GETREC(-1, "JOBARC", "AIIIJARC", 1, IACESIII)
      IF (IACESIII .GT. 0) ACESIII = .TRUE.
      WRITE(6,*) '@V2JA-DEBUG: IFLAGS(56)=', IFLAGS(56),
     &           ' SEWARD=', SEWARD, ' IACESIII=', IACESIII
C
C     *************************
...
C     
      ...
      If (SEWARD) Then
         Call GenTranMat(Icore(I0), Icrsiz)
      endif
C
...
CSSS      write(6,*) '  @V2JA-I, NAOBF and NBF is ',NAOBF, NBF
...
C
      MemPtr(1) = MemPtr(1) + Mod( MemPtr(1), 2)
      MemPtr(1) = MemPtr(1) + I0
      Do 250 I = 2, MxMPtr
C
...
c NEW
     ...
     &                ICore(MemPtr(1)+NAOBF+iPad),NAOBF*NAOBF,iErr)
      Else
          Call DGETRI(NAOBF,ICore(MemPtr(2)),NAOBF,ICore(MemPtr(1)),
     &                ICore(MemPtr(1)+NAOBF+iPad),NAOBF*(NAOBF-1),iErr)
      Endif
