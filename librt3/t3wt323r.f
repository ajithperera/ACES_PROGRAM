...
C
      ...
      DO IRPBC = 1,NIRREP
         IRPA  = DIRPRD(IRPBC,IRPIJK)
         NROW  = VRT(IRPA,ISPIN1)
         NCOL  = IRPDPD(IRPBC,13)
         I020  = I010 + NROW
         I030  = I020 + NROW
         CALL SYMTR1(IRPBC,VRT(1,ISPIN2),VRT(1,ISPIN1),NROW,
     &               CORE(INDX),CORE(I010),CORE(I020),CORE(I030))
         ITMP = NROW*NCOL
         CALL VADD(D3T3EXP(INDX),D3T3EXP(INDX),CORE(INDX),ITMP,1.D0)
         INDX = INDX + ITMP
      END DO
C
