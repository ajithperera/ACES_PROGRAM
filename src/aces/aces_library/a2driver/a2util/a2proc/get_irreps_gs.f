...
C 
      SUBROUTINE GET_IRREPS_GS(SCFVEC,SCFEVAL,ICORE,MAXCOR,NBAS,NBASX,
     &                         ISPIN, NOCC, IUHF, IFLAG, STATE)
C
...
C
      ...
      CALL EVLOUT_GS(SCFEVAL, ICORE(I020), ICORE(I030), IREPS, NBAS,
     &               NIRREP, NOCC, ISPIN, IFLAG, STATE)
