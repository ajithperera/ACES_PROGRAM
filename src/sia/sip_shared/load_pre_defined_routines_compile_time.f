...
c-------------------------------------------------------------------- 
      dummy = load_user_sub('sip_test'//char(0), 0)
...
c----------------EOM/STEOM------------------------------------------------
      dummy = load_user_sub('eomeaf12info'//char(0),0)
      dummy = load_user_sub('f12_c_ijab_coef'//char(0),0)
      dummy = load_user_sub('eomiproots'//char(0),0)
      dummy = load_user_sub('eomearoots'//char(0),0)
      dummy = load_user_sub('eomchunk'//char(0),0)
      dummy = load_user_sub('steom_u_inv'//char(0), 0)
      dummy = load_user_sub('steom_gbar'//char(0), 0)
      dummy = load_user_sub('steomroots'//char(0), 0)
      dummy = load_user_sub('steom_cis_matrix'//char(0), 0)
      dummy = load_user_sub('steom_diag'//char(0), 0)
      dummy = load_user_sub('steom_f12_vact'//char(0), 0)
      dummy = load_user_sub('steom_f12_vact_select'//char(0), 0)
      dummy = load_user_sub('mksqcvec'//char(0), 0)
      dummy = load_user_sub('mksomfex'//char(0), 0)
      dummy = load_user_sub('steom_so_diag'//char(0), 0)
      dummy = load_user_sub('steom_matr_nr'//char(0), 0)
      dummy = load_user_sub('steom_matr_so'//char(0), 0)
      dummy = load_user_sub('prsolrover'//char(0), 0)
      dummy = load_user_sub('lrootcorr'//char(0), 0)
      dummy = load_user_sub('eom_so_diag_ip'//char(0), 0)
      dummy = load_user_sub('print_eomso_roots'//char(0), 0)
      dummy = load_user_sub('eom_so_diag'//char(0), 0)
      dummy = load_user_sub('set_tr_sin'//char(0), 0)
c---------------Angular momentum integrals----------------------------
      dummy = load_user_sub('so_info'//char(0),0)
