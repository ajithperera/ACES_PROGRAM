...
C
      ...
      CALL SYMCONTW_VCC5T(ICORE(I080),ICORE(I070),EVAL,IADT3,1,NOCA,NVRTA,
     1              IRPIJK)
      CALL     ZERO(ICORE(I090),DISTSZ(IRPIJK,1))
      CALL SYMCONTW_VCC5T(ICORE(I090),ICORE(I000),EVAL,IADT3,1,NOCA,NVRTA,
     1              IRPIJK)
