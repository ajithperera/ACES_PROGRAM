      ...
      Subroutine project_FC(Coords,AtmMass,Hess_project,Nreals,
     &                      Threshold,Move_2CMass,Proj_trans,
     &                      Proj_rotas)
...
C
      ...
      Double Precision Hess_project(3*Nreals,3*Nreals)
      Double Precision Asym_ten(3,3,3)
      Double Precision Cm(3)
      Double Precision Center_mass(3)
      Double Precision Cut8
      Double Precision Threshold 
      Double Precision Totmass 
      Double Precision Check_3d
      Double Precision MO_inertia(3,3) 
      Double Precision Det 
      Double Precision Tmp
      Double Precision Grad_sqr
      Double Precision Dabs,Ddot 
...
C
      ...
      Write(6, "(3(1x,F17.13))") (Coords(i),i=1,3*Nreals)
C
...
C
      ...
      Else 
          Call Dgetrf(3,3,Mo_inertia,3,Iscratch,Info)
          If (Info .Gt. 0) Then
             Write(6,"(2a)") "@-project_fc,Failed to invert:",
     &                       " Inertia matrix is singular"
             Call Errex
          Endif 
          Call Dgetri(3,Mo_inertia,3,Iscratch,Jscratch,3,Info)
      Endif
C
