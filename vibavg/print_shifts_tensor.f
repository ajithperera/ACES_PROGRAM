      ...
      Subroutine Print_shifts_tensor(Tensor,Iatmchrg,Isotopes,Atmlabel,
     +                               Nreals,Natoms) 
     ...
     +             '[77]Br', '[81]Br', '[82]Br', '[79]Kr', '[81]Kr'/
      ...
      Call Header('The NMR shielding tensor (in ppm)',-1,6) 
      Do I = 1, Nreals
         Write(6,"(15x,a6,5x,F15.8)") Atmlabel(I),Tensor(I)
      Enddo 
      Return 
      End 
