      SUBROUTINE GETGV2U(G,GTMP,I1,NBL0,I2,IRREP,LISTG,ISPIN,listw,Leng)
...
C
     ...
     x    nab.ne.leng)  THEN
      write(6,111) listg
 111  format (3x,'start of getgv2u with listg=',i5) 
...
C-----------------------
 ...
 950   format (4x,'Some error (getgv2u) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
