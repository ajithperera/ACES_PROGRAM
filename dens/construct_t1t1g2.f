      ...
      SUBROUTINE CONSTRUCT_T1T1G2(ICORE,MAXCOR,IUHF,IOFF,FACT)
C
...
C
       ...
       IF(MIN(NUMSYT,NUMSYZ,DISSYT,DISSYZ).NE.0) THEN
        ...
        IF(I004.LT.MXCOR) THEN
         ...
         CALL PDCC_G2X2AB(ICORE(I001),ICORE(I002),ICORE(I0TA),
     &               ICORE(I0TB),
     &               TAU,ICORE(I0AA),ICORE(I0BB),POP(1,1),POP(1,2),
     &               VRT(1,1),VRT(1,2),DISSYT,DISSYZ,NUMSYT,NUMSYZ,
     &               NFAA,NFBB,LISTT,LISTZ,IRREP,IUHF,ICORE(I003),FACT)
        ELSE
          CALL INSMEM("PDCC_G2X2AA",I004,MAXCOR)
        ENDIF
       ENDIF
