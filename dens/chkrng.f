...
C
        ISIZE=ISYMSZ(ISYTYP(1,125),ISYTYP(2,125))
        I000=1
        I010=I000+IINTFP*ISIZE
        I020=I010+IINTFP*ISIZE
        I030=I020+IINTFP*ISIZE
        CALL GETALL(ICORE(I000),ISIZE,1,125)
        CALL SSTGEN(ICORE(I000),ICORE(I010),ISIZE,VRT(1,1),POP(1,2),
     &              VRT(1,1),POP(1,2),ICORE(I020),1,'1432')
        CALL PUTALL(ICORE(I000),1,1,125)
        ISIZE=ISYMSZ(ISYTYP(1,126),ISYTYP(2,126))
        I000=1
        I010=I000+IINTFP*ISIZE
        I020=I010+IINTFP*ISIZE
        I030=I020+IINTFP*ISIZE
        CALL GETALL(ICORE(I000),ISIZE,1,126)
        CALL SSTGEN(ICORE(I000),ICORE(I010),ISIZE,VRT(1,2),POP(1,1),
     &              VRT(1,2),POP(1,1),ICORE(I020),1,'1432')
        CALL PUTALL(ICORE(I000),1,1,126)
       ENDIF
...
C
        ...
        CALL SSTGEN(ICORE(I000),ICORE(I010),ISIZE,VRT(1,1),POP(1,2),
     &              VRT(1,1),POP(1,2),ICORE(I020),1,'1432')
        CALL PUTALL(ICORE(I010),1,1,125)
        ISIZE=ISYMSZ(ISYTYP(1,126),ISYTYP(2,126))
        I000=1
        I010=I000+IINTFP*ISIZE
        I020=I010+IINTFP*ISIZE
        ...
        CALL SSTGEN(ICORE(I000),ICORE(I010),ISIZE,VRT(1,2),POP(1,1),
     &              VRT(1,2),POP(1,1),ICORE(I020),1,'1432')
        CALL PUTALL(ICORE(I010),1,1,126)
       ENDIF
      ENDIF
C
      RETURN
