      SUBROUTINE GETGV2O(G,GTMP,I1,NRDIS,I2,IRREP,LISTG,ISPIN,LISTW,NAB,
     X                    INDXG,NIKI)
...
C------------------------
 ...
 100  CONTINUE 
      CALL GETLST(G,I1,NIJDR,I2,IRREP,LISTG)
C------------------------
C---- EXPAND IJ BLOCK
C------------------------
      ININEW = NRDIS * NAB + 1
...
C-----------------------
 ...
 950   format (4x,'Some error (getgv2o) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
