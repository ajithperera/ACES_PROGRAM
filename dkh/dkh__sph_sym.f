      ...
      Subroutine Dkh__sph_sym(Work,Mxdcor,Iuhf,Symmetry,Contract)
...
C
     ...
     &               ncfps(ishell) 
      ...
      Write(6,*)
      Write(6,"(a,1x,i10,1x,i10)") "Iend and Mxdcor  :", Iend, Mxdcor
      Write(6,"(a,1x,i10,1x,i10)") "Intmax and Mxicor:", Intmax,Mxicor
...
C number of primitives.
     ...
     &                        Jstrt, Jrs, Atmnam, Charge)
      ...
      Call output(Work(Ioed_pvp), 1, Naobfns, 1, Naobfns, Naobfns,
     &            Naobfns, 1)
       Call rescale_2ints_op2(Work(Ioed_pvp),Work(Ioed_kin),
     +                        Naobfns,Erd_index,Erd_scale,Symmetry)

      Write(6,"(a)") "Scaled/reordered contracted DKH integrals"
      Call output(Work(Ioed_kin), 1, Naobfns, 1, Naobfns, Naobfns,
     &            Naobfns, 1)
C
...
C is used to store the sym. transformation matrix and scratch arrays.
       ...
       Call Do_symadapt_sph_op1(N_Cart_fns,Nbfns,Work(Ioed_kin),
