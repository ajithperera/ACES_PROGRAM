      ...
      Subroutine Do_symadapt_sph_op2(Naobfns, Nbfns, Ovlp, Ao2so,
...
c machsp.com : end
      ...
      Double Precision Ovlp(Nbfns,Nbfns), Tmp1(Naobfns,Naobfns),
     &                 Tmp2(Naobfns*Naobfns), Ao2So(Naobfns*Naobfns)

      Call Getrec (20, "JOBARC", "AO2SOINV", Naobfns*Nbfns*Iintfp,
     &             Ao2So)

      Call Xgemm("N", "N", Naobfns, Nbfns, Nbfns, 1.0D0, Ao2so,
     &            Naobfns, Ovlp, Nbfns, 0.0D0, Tmp2, Naobfns)
      Call Getrec (20, "JOBARC", "AO2SO   ", Naobfns*Nbfns*Iintfp,
     &             Ao2So)
      Call Xgemm("N", "N", Naobfns, Naobfns, Nbfns, 1.0D0, Ao2so,
