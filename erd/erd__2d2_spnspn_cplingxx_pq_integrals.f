...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D2_SPNSPN_CPLINGXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_SPNSPN_CPLINGXX_PQ_INTEGRALS
...
C
         ...
         DOUBLE PRECISION  ONE,HALF,TWO,QUART
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
                  ...
                  INT2DX2 (N,0,0) = (PQX * INT2DX1 (N,0,0) +
     +                                     INT2DX  (N,0,0) * RHOINV)
     +                                                     * QROOT 
                  ...
                  DO K = 1, SHELLQ
                     ...
                     INT2DX2 (N,0,K) = (PQX  * INT2DX1 (N,0,K)  -
     +                                  QKL  * INT2DX1 (N,0,K1) * K 
     +                                       + INT2DX  (N,0,K)  
     +                                       * RHOINV) * QROOT 
                  ...
                  DO I = 1, SHELLP
                     ...
                     INT2DX2 (N,I,0) = (PQX  * INT2DX1 (N,I,0)  +
     +                                  PIJ  * INT2DX1 (N,I1,0) * I
     +                                       + INT2DX  (N,I,0)
     +                                       * RHOINV) * QROOT
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        ...
                        INT2DX2 (N,I,K) = (PQX  * INT2DX1 (N,I,K)  +
     +                                     PIJ  * INT2DX1 (N,I1,K) * I -
     +                                     QKL  * INT2DX1 (N,I,K1) * K
     +                                          + INT2DX  (N,I,K)
     +                                          * RHOINV) * QROOT
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
     ...
     +                                     * QROOT
                  ...
                  INT2DX2 (N,0,1) = (PQX   * INT2DX1 (N,0,1) -
     +                               QKL   * INT2DX1 (N,0,0) 
     +                                     + INT2DX  (N,0,1) * RHOINV)
     +                                     * QROOT 
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
     ...
     +                                     * QROOT 
                  ...
                  INT2DX2 (N,1,0) = (PQX   * INT2DX1 (N,1,0) +
     +                               PIJ   * INT2DX1 (N,0,0)
     +                                     + INT2DX  (N,1,0) * RHOINV)
     +                                     * QROOT 
