...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D1_SPNSPN_CPLINGXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +                               INT2DX1)
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D1_SPNSPN_CPLINGXX_PQ_INTEGRALS
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DX1 (N,0,0) = PQX  * INT2DX (N,0,0) * QROOT 

                  DO K = 1, SHELLQ
                     K1 = K - 1
                     INT2DX1 (N,0,K) = (PQX  * INT2DX (N,0,K)  -
     +                                  QKL  * INT2DX (N,0,K1) * K) *
     +                                  QROOT 
                  ENDDO                           
                  ...
                  DO I = 1, SHELLP
                     I1 = I - 1
                     INT2DX1 (N,I,0) = (PQX  * INT2DX (N,I,0)  +
     +                                  PIJ  * INT2DX (N,I1,0) * I) *
     +                                  QROOT 
                  ENDDO
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        K1 = K - 1
                        I1 = I - 1
                        INT2DX1 (N,I,K) = (PQX  * INT2DX (N,I,K)  +
     +                                     PIJ  * INT2DX (N,I1,K) * I -
     +                                     QKL  * INT2DX (N,I,K1) * K) *
     +                                     QROOT 
                     ENDDO
    ...
    2    DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DX1 (N,0,0) = PQX   * INT2DX (N,0,0) * QROOT
                  INT2DX1 (N,0,1) = (PQX  * INT2DX (N,0,1) -
     +                               QKL  * INT2DX (N,0,0)) * QROOT
                  DO K = 2, SHELLQ
                     K1 = K - 1
    ...
    3     DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DX1 (N,0,0) =  PQX   * INT2DX (N,0,0) * QROOT 
                  INT2DX1 (N,1,0) = (PQX   * INT2DX (N,1,0) +
     +                               PIJ   * INT2DX (N,0,0)) 
     +                                     * QROOT 
                  DO I = 2, SHELLP
                     I1 = I - 1
