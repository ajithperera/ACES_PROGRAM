...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_ATOM_SPNSPN_CPLING_PQ_INTEGRALS
     +
     ...
     +                               INT2DZ2 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_SPNSPN_CPLING_PQ_INTEGRALS
...
CSSS         Write(*,*) "printing zeroth order 2Ds"
CSSS         do n=1, NGQEXQ
CSSS         do i=0,shellp
CSSS         do k=0,shellq
CSSS              write(*,"(3(1x,I3),F15.10)") n,i,k, INT2DX(n,i,k)
CSSS              write(*,"(3(1x,I3),F15.10)") n,i,k, INT2DY(n,i,k)
CSSS              write(*,"(3(1x,I3),F15.10)") n,i,k, INT2DZ(n,i,k)
CSSS         enddo
CSSS         enddo
CSSS         enddo
    ...
    1     CALL    ERD__2D1_ATOM_SPNSPN_CPLINGXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
CSSS         Write(*,*) "printing xx-1"
CSSS         do n=1, NGQEXQ
CSSS         do i=0,shellp
CSSS         do k=0,shellq
CSSS              write(*,"(3(1x,I3),F15.10)") n,i,k, INT2DX1(n,i,k)
CSSS         enddo
CSSS         enddo
CSSS         enddo

          CALL    ERD__2D2_ATOM_SPNSPN_CPLINGXX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
    ...
    2     CALL    ERD__2D_ATOM_SPNSPN_CPLINGXY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C         Write(*,*) "printing xy-1 atom block"
C         do n=1, NGQEXQ
C         do i=0,shellp
C         do k=0,shellq
...
C         enddo
    ...
    3     CALL    ERD__2D_ATOM_SPNSPN_CPLINGXZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C         enddo
   ...
   4      CALL    ERD__2D_ATOM_SPNSPN_CPLINGYX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C
    ...
    5     CALL    ERD__2D1_ATOM_SPNSPN_CPLINGYY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C         enddo
          ...
          CALL    ERD__2D2_ATOM_SPNSPN_CPLINGYY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C     
    ...
    6     CALL    ERD__2D_ATOM_SPNSPN_CPLINGYZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C         enddo
    ...
    7    CALL    ERD__2D_ATOM_SPNSPN_CPLINGZX_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C         enddo
    ...
    8     CALL    ERD__2D_ATOM_SPNSPN_CPLINGZY_PQ_INTEGRALS
     + 
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C
    ...
    9     CALL    ERD__2D1_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
C        enddo
          ...
          CALL    ERD__2D2_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
