...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__SPNSPN_CPLING_CSGTO
     +
     +                    ( IMAX,ZMAX,
     +                      NALPHA,NCOEFF,NCSUM,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__SPNSPN_CPLING_CSGTO
C  MODULE      : ELECTRON REPULSION INTEGRALS DIRECT
C  MODULE-ID   : ERD
C  SUBROUTINES : ERD__SET_SPNSPN_CPLING_ABCD
C                ERD__SET_IJ_KL_PAIRS
C                ERD__E0F0_DEF_SPNSPN_CPLING_BLOCKS
C                ERD__PREPARE_CTR
C                ERD__E0F0_PCGTO_SPNSPN_CPLING_BLOCK
...
C
         ...
         CALL  ERD__SET_SPNSPN_CPLING_ABCD
     +
     +              ( NCGTO1,NCGTO2,NCGTO3,NCGTO4,
     +                NPGTO1,NPGTO2,NPGTO3,NPGTO4,
     +                SHELL1,SHELL2,SHELL3,SHELL4,
...
C         Write(*,*) "ENTER ERD__E0F0_DEF_DSHIELD_BLOCKS"
         CALL  ERD__E0F0_DEF_SPNSPN_CPLING_BLOCKS
     +
     +              ( ZMAX,
     +                NPGTOA,NPGTOB,NPGTOC,NPGTOD,
     +                SHELLP,SHELLQ,
...
C         Write(*,*) "END ERD__E0F0_DEF_SPNSPN_CPLING_BLOCKS"
...
CSSS               Write(*,*) "ENTER ERD__E0F0_PCGTO_SPNSPN_BLOCKS",
CSSS     +                      MGQIJKL, MIJ, MKL, NGQP
CSSS               Write(*,*) "NIJBEG,NKLBEG", NIJBEG,NKLBEG
               CALL  ERD__E0F0_PCGTO_SPNSPN_CPLING_BLOCK
     +
     +                    ( NPSIZE,NINT2D,
     +                      ATOMIC,ATOMAB,ATOMCD,
     +                      MIJ,MKL,MIJKL,
