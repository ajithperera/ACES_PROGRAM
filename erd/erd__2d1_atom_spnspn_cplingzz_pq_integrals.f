...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D1_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                 ...
                 DO K = 1, SHELLQ
                    ...
                    K1 = K - 1
                    INT2DZ1 (N,0,K) = - QKL * INT2DZ (N,0,K1) * K *
     +                                  QROOT 
                 ...
                 DO I = 1, SHELLP
                    ...
                    I1 = I - 1 
                    INT2DZ1 (N,I,0) = PIJ * INT2DZ (N,I1,0) * I * 
     +                                QROOT 
