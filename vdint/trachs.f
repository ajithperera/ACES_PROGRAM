      ...
      SUBROUTINE TRACHS(SCHS,CCHS,NCOOR)
...
c     MXCONT - ???
      ...
      PARAMETER (D1 = 1.0D0)
      DIMENSION SCHS(3,MXCOOR), CCHS(3,MXCOOR),
     *          MATRIX(3,MXCOOR), PERDIP(3,3)
...
C
      CALL ZERO(PERDIP,9)
      DO 100 ICOOR = 1, 3
         PERDIP(ICOOR,IPTAX(ICOOR)) = D1
  100 CONTINUE
      CALL XGEMM('N','N',3,NCOOR,3,ONE,PERDIP,3,
     *           SCHS,3,AZERO,MATRIX,3)
      CALL XGEMM('N','T',3,NCOOR,NCOOR,ONE,MATRIX,3,
     *           TRSTOC,MXCOOR,AZERO,CCHS,3)
      RETURN
      END
