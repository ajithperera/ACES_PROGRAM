      ...
      SUBROUTINE EFINT(NHKTA,NHKTB,KHKTA,KHKTB,ICENTA,LDIAG,
     &                 ISTEPA,ISTEPB,ISTEPU,ISTEPV,NAHGTF,
     &                 NATOMC,CHARGE,WORK1)
C
C   THIS ROUTINE CALCULATES ELECTRICAL FIELD INTEGRALS 
C
CEND
C
C   JG 4/93
