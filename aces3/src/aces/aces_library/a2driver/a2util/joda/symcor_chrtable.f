cmn
c This subroutine is a dubplicate of symcor/chrtable.f
c
...
c put TYPE//'NIRX'
      ...
      SUBROUTINE SYMCOR_CHRTABLE(IORDER,SYOPS,REGREP,DIST,CHAR,
     $     ISCR,IPTR,
     &                    IDEGEN,IRRNM,SCR,TYPE,ptgrp,DSCR)
...
cmn      CALL GETCREC(20,'JOBARC',TYPE//'PTGP',4,PTGRP)
       write(6,*) ' @symcor_chrtable, pointgroup ', ptgrp
c
      do i = 1, iorder
         irrnm(i) = '        '
      enddo
