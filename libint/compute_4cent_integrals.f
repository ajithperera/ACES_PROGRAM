      ...
      Subroutine Compute_4cent_integrals(a1,a2,b1,b2,c1,c2,d1,d2,
...
CSSS      Write(6,*) 
      do c = c1,c2
      do d = d1,d2
      Write(6, "(5(1x,F15.10))") (Repulsion(a,d,c,b), a=1, nbasis)
          eri_s = eri_s + Repulsion(a,b,c,d) * Repulsion(a,b,c,d)
          eri_l = eri_l + Repulsion(a,b,c,d) + Repulsion(a,b,c,d)
      enddo
      enddo
      enddo
CSSS      enddo
      Write(*,*)
      Write(6,"(a,a,F20.10,1x,F20.10)")"Check sum of the repulsion",
     &                      " integrals = " ,eri_s,eri_l
