...
c-----------------------------------------------------------------------
      if (ndrgeo.ne.0) then 
        ...
        if (ndrop0.ne.0) then
         izero=0
         CALL PUTREC(20,'JOBARC','NUMDROPA',1,izero)   
         if (iuhf.ne.0) CALL PUTREC(20,'JOBARC','NUMDROPB',1,izero)   
        endif 
      endif 
c-----------------------------------------------------------------------
      CALL DROPVC(NBASIS,NDROP,IUHF,ICORE(I000),ICORE(I010),
