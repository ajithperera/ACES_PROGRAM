...
C
       ...
       CALL PUTBLK_DENS(DFULL,DOO(IOFFO),'OO',ISCR(I000),ISCR(I010),
     &                  NBAS,IRPDPD(1,20+ISPIN),LENOO,ISPIN)
       I000=1
       I010=I000+LENVV*IINTFP
       I020=I010+LENVV
       IF(I020.GT.MAXCOR)CALL INSMEM('FILFUL',I020,MAXCOR)
       CALL PUTBLK_DENS(DFULL,DVV(IOFFV),'VV',ISCR(I000),ISCR(I010),
     &                  NBAS,IRPDPD(1,18+ISPIN),LENVV,ISPIN)
       I000=1
       I010=I000+LENVO*IINTFP
       I020=I010+LENVO
       IF(I020.GT.MAXCOR)CALL INSMEM('FILFUL',I020,MAXCOR)
       CALL PUTBLK_DENS(DFULL,DVO(IOFFOV),'VO',ISCR(I000),ISCR(I010),
