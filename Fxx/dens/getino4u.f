      SUBROUTINE GETINO4U (INDXG,NTDIS,NRNUM,LISTG,IRREP,ISPIN) 
...
C
     ...
     x    nab.ne.nrnum)  THEN
       write(6,14) listg
  14   format (3x,'start of getino4u with listg=',i5)
...
C
 ...
 700  CONTINUE 
      IF (NIJIN.EQ.0) RETURN 
       write (6,710) nijin   
 710   format (4x,'some error (getino4u) = nijin=',i6,4x,'must be 0') 
       CALL ERREX 
      END
