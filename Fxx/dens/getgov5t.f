      SUBROUTINE GETGOV5T(G,TMP,LBL0,NBL0,I2,IRREP,LISTG,ISPIN)
...
C
     ...
     x    nab.ne.lbl0)  THEN
      write(6,111) listg
 111  format (3x,'start of getgov5t with listg=',i5,5x) 
...
C-----------------------
 ...
 950   format (4x,'Some error (getgov5t) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
