       SUBROUTINE INTV6(AIVV,ICORE,MAXCOR,IUHF)     
C
C
C THIS ROUTINE CALCULATES THE SIXTH TERM OF THE VIRTUAL VIRTUAL BLOCK
C OF THE INTERMEDIATE I
C
C THE GENERAL FORMULA IS
C
C 1. TERM :  - 1/2 SUM M,N,O <MN//OA> G(MN,OB)
C
...
C         IN CORE VERSION
C
          CALL IV6AB(ICORE(I001),ICORE(I002),AIVV(IOFF),
