      SUBROUTINE XIA1AB(W,DOO,XIA,ISPIN,POP1,VRT1,POP2,VRT2,
     &                  DISSYW,NUMSYW,LISTW,IRREP,IUHF,TMP)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER DISSYW,DIRPRD,POP1,VRT1,POP2,VRT2
      DIMENSION W(DISSYW,1),DOO(*),XIA(*),POP1(8),VRT1(8),
     &          POP2(8),VRT2(8),IPD(8),TMP(*)
...
C
C SPIN ADAPT INTEGRALS FOR RHF
C
      IF(IUHF.EQ.0) THEN
       CALL SPINAD3(IRREP,POP1,DISSYW,NUMSYW,W,TMP,
     &              TMP(1+NUMSYW))
      ENDIF
C
