      SUBROUTINE Z2VAA(G,W,T,AIVV,FACT,ISPIN,POP,VRT,DISSYT,NUMSYT,
     &                 LISTG,LISTW,IRREP)
...
C
C PICK UP THE intermediate I(mn,ga) AND L(ij,gb) amplitudes REQUIRED
C
      if (ndrgeo.eq.0) CALL GETLST(T,1,NUMSYT,1,IRREP,LISTG)
      if (ndrgeo.eq.1) 
     &     CALL GETGO1U(T,G,1,NUMSYT,1,IRREP,LISTG,ispin,listw,dissyt)
C
