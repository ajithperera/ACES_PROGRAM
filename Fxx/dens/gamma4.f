...
C
      ...
      CALL CHECKGAM_DER(ICORE,23,123,TWO)
      CALL CHECKGAM_DER(ICORE,25,125,TWO)
      CALL CHECKGAM_DER(ICORE,18,118,TWO)
      IF(IUHF.NE.0) THEN
       CALL CHECKGAM_DER(ICORE,24,124,TWO)
       CALL CHECKGAM_DER(ICORE,26,126,TWO)
       CALL CHECKGAM_DER(ICORE,17,117,TWO)
      ENDIF
C
      RETURN
      END
