      SUBROUTINE GETGO3R(G,GTMP,I1,NBL0,I2,IRREP,LISTG,ISPIN,listw,
     &                                                     Leng,iin)
...
C
 ...
 111  format (3x,'start of getgo3r with listg=',i5,5x,'listw=',i5)
...
C-----------------------
 ...
 950   format (4x,'Some error (getgo3r) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
