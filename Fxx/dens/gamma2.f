...
C
      TWO=1.D0
      IF(IUHF.EQ.0)
     &   CALL CHECKGAM1_DER(ICORE,133,233,TWO,IUHF,2,VRT)
      IF(IUHF.EQ.1) THEN
       CALL CHECKGAM_DER(ICORE,133,233,TWO)
       CALL CHECKGAM_DER(ICORE,131,231,TWO)
       CALL CHECKGAM_DER(ICORE,132,232,TWO)
      ENDIF
C
      RETURN
      END
