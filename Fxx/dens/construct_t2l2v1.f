       ...
       SUBROUTINE CONSTRUCT_T2L2V1(ICORE,MAXCOR,IUHF)
C
...
C The TAU is not formed in this case.
...
C         IN CORE VERSION
C
          CALL PDCC_T2L2V1ALL(ICORE(I001),ICORE(I002),ICORE(I003),
     &                    ICORE(I0T),ICORE(I0T),ISPIN,TAU,ISAME,
     &                    DISSYL,DISSYT,NUMSYL,
     &                    NUMSYT,LISTL,LISTT,IRREP,ICORE(I004))
         ELSE
C
C         OUT OF CORE VERSION
C
          CALL INSMEM('PDCC_T2L2V1ALL ',I005,MXCOR)
         ENDIF
C
        ELSE
        ENDIF
...
C
          CALL PDCC_T2L2V1ALL(ICORE(I001),ICORE(I002),ICORE(I003),
     &                    ICORE(I0TA),ICORE(I0TB),3,TAU,ISAME,
     &                    DISSYL,DISSYT,NUMSYL,
