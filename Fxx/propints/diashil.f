...
C     
      SUBROUTINE DiaShil(VLIST,NOC,CENTR1,EXPS,CONT,LABEL,NPRIM,NCONTR,
...
C
     ...
     &          ITRN(256,1),CTRN(256,1),NCONTR(1),NPRIM(1),INDX(1)
      ...
      DIMENSION VAL(3,3),VAL1(3,3),VAL2(3,3),VAL3(3,3),
     &          TITLE(10,25),TEMP1(3)
     ...
     &          V(10), DISTQA(3), G(3), DISTQG(3)
C     
      DATA LFLAG / 1, 0, 0/
      DATA MFLAG / 0, 1, 0/
      DATA NFLAG / 0, 0, 1/
C
      DATA (LABELJA(I, 20), I = 1, 10) /'  DSXX  ', '  DSYX  ',
     &      '  DSYY  ','  DSZX  ', '  DSZY  ', '  DSZZ  ',
     &     4*'        '/
C     
      DATA (  TITLE(I, 20), I = 1, 10) /'  DSXX  ', '  DSYX  ',
     &      '  DSYY  ','  DSZX  ', '  DSZY  ', '  DSZZ  ',
     &     4*'        '/
C     DATA (TITLE(I, 20), I = 1, 10)/6H  DSXX, 6H  DSYX, 6H  DSYY,
...
C
C                  Write(6,*) "IJ", I, J 
C                  Write(6,"(3(F15.8))") (A(L), L=1,3)
C                  Write(6,"(3(F15.8))") (B(L), L=1,3)
C                  Write(6,*) 
C                  Write(6,"(3(F10.8))") (TEMP1(L), L=1,3)

                  DO 52 K = 1, 3
                     DO 53 L = 1, 3
                        VAL1(K, L) = DISTQA(K)*TEMP1(L) 
CSSSS                        VAL2(K, L) = DISTQG(K)*TEMP1(L) 

 53                  CONTINUE
 52               CONTINUE

CSSSS                  call output(val2, 1, 3, 1, 3, 3, 3, 1)
C
