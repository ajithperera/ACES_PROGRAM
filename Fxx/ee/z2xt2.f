...
C
      call checksum('z2xt2 1',icore(I000),numsyg*dissyg)
      IF(IUHF.EQ.0) THEN
C
...
C
       ENDIF
      call checksum('z2xt2 2',icore(I000),numsyg*dissyg)
C
C UPDATE G(IJ,AB) ON DISK
C
       CALL GETLST(ICORE(I010),1,NUMSYG,1,IRREP,LISTG)
      call checksum('z2xt2 3',icore(I010),numsyg*dissyg)
       CALL SAXPY(NUMSYG*DISSYG,ONE,ICORE(I010),1,ICORE(I000),1)
      call checksum('z2xt2 4',icore(I000),numsyg*dissyg)
       CALL PUTLST(ICORE(I000),1,NUMSYG,1,IRREP,LISTG)
C
200   CONTINUE
C
