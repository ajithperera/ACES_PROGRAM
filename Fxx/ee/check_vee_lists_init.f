...
c sympop.com : end
      ...
      call checksum("List-448;Z(AB,IJ):",Work(1),length)
      Length=idsymsz(Irrepx,isytyp(1,449),isytyp(2,449))
      call getall(Work(1),length,irrepx,449)
      call checksum("List-449;Z(ab,ij):",Work(1),length)
      Length=idsymsz(Irrepx,isytyp(1,450),isytyp(2,450))
      call getall(Work(1),length,irrepx,450)
      call checksum("List-450;Z(ab,ij):",Work(1),length)
      Else 
      Length=idsymsz(Irrepx,isytyp(1,450),isytyp(2,450))
      call getall(Work(1),length,irrepx,450)
      call checksum("List-450;Z(Ai,Bj):",Work(1),length)
      Endif
      Else
