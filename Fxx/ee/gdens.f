...
C
     ...
     &             LSTR2RS,LSTL2RS)
      ...
      call checksum("doo",DOO,LENOO(1)+IUHF*LENOO(2))
      call checksum("dvv",DVV,LENvv(1)+IUHF*LENvv(2))
      call checksum("dvo",DVO,LENvO(1)+IUHF*LENvO(2))
      call checksum("dvo",DOV,LENvO(1)+IUHF*LENvO(2))
C
      RETURN
      END
