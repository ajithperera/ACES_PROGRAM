...
CSSS      call check_ints(Work,Length,Iuhf)
      write(6,*)
      ...
      write(6,*)
      call checksum("Rcc_R(P,Q)",Rcc_vecr(joff,Iroot),Lengtha)
      call checksum("Rcc_L(P,Q)",Rcc_vecl(joff,Iroot),Lengtha)
     ...
     +                  Rcc_vecl(joff,Iroot),1)
      call checksum("Rcc_R(P,Q)",Rcc_vecr(joff,Iroot),Lengthb)
      call checksum("Rcc_L(P,Q)",Rcc_vecl(joff,Iroot),Lengthb)
      endif 
