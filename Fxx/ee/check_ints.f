...
CSS         call output(Work(I010),1,nrow,1,ncol,nrow,ncol,1)
      ...
      Call checksum("List-7 ",Work,Length_7)
      Call Getall(Work, Length_8, Irrepx, 8)
      Call checksum("List-8 ",Work,Length_8)
      Call Getall(Work, Length_9, Irrepx, 9)
      Call checksum("List-9 ",Work,Length_9)
      Call Getall(Work, Length_10, Irrepx, 10)
      Call checksum("List-10",Work,Length_10)
...
C         call checksum("list-10",work,nrow*ncol)
C      enddo
C      write(6,*)
      ...
      Call checksum("List-27",Work,Length_27)
      Call Getall(Work, Length_28, Irrepx, 28)
      Call checksum("List-28",Work,Length_28)
      Call Getall(Work, Length_29, Irrepx, 29)
      Call checksum("List-29",Work,Length_29)
      Call Getall(Work, Length_30, Irrepx, 30)
      Call checksum("List-30",Work,Length_30)
