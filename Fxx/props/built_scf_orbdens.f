...
c flags.com : end
      ...
      If (Symmetry) Then
         Write(6,"(a)") " This demonstrative code is unable to handle",
     &                  " symmetry=on cases"
         Return
      Endif 
     ...
     &                                       Iend,Maxcor)
      Else
         Write(6,"(a,a)") " The spin-densities are zero for closed",
     &                    " shell molecules" 
         Call Errex
      Endif 
...
C check with the density matrix from JOBARC 
      ...
      Write(6,"(a)") " The SCFDENSA from JOBARC"
