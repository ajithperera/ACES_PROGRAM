      SUBROUTINE CMP_PROPS(ICORE,MAXCOR,IUHF)
...
C
C      IF(IFLAGS(1).GT.0)THEN
C       write(6,*) ' data ' , ncomp,norbs,noca,nvrta
C       write(6,*) ' popful ',popful
C       write(6,*) ' vrtful ',vrtful
C       write(6,*) ' nocco, nvrto ', nocco,nvrto
C       write(6,*) ' ndrpop, ndrvrt', ndrpop,ndrvrt
C       write(6,*) ' nbfirr ',nbfirr
C      ENDIF
C
C-----------------------------------------------------------------------
C
