      ...
      SUBROUTINE T2T3_HT3C2_1(T3,W,ICORE,IADT3,IADW,IRPI,IRPJ,
     &                        IRPK,IRPIJ,IRPIK,IRPJK,IRPIJK,
     &                        I,J,K,IUHF,SCR1,SCR2,SCR3,LAMBDA)
...
C
     ...
     1            1,1,IRPIJ,LIST2I1+LISTOFF)
      CALL   VADD(ICORE(IADT2I),ICORE(IADT2I),ICORE(IADT2),
     1            IRPDPD(IRPIJ,1), 1.0D+00)
...
C
      ...
      IOFFV  = IADT2I         + IRPDPD(IRPIK,13)
C
C     FORM T2 MATRICES. (A,B)
C
      CALL ZERO(ICORE(IADT2E(1)),IRPDPD(IRPIK,13))
...
C
     ...
     1            1,1,IRPIK,LIST2I3+LISTOFF)
C
      CALL SYMTR3(IRPIK,VRT(1,1),VRT(1,2),IRPDPD(IRPIK,13),1,
...
C
      IADT2I = IADT2E(NIRREP) + LENT2E(NIRREP)
      IOFFV  = IADT2I         + IRPDPD(IRPJK,13)
C
C     FORM T2 MATRICES. (A,B)
C
      CALL ZERO(ICORE(IADT2E(1)),IRPDPD(IRPJK,13))
...
C
     ...
     1            1,1,IRPJK,LIST2I3+LISTOFF)
C
      CALL SYMTR3(IRPJK,VRT(1,1),VRT(1,2),IRPDPD(IRPJK,13),1,
     1            ICORE(IADT2E(1)),SCR1,SCR2,SCR3)
C
      KJ = (J-1)*POP(IRPK,2) + K
