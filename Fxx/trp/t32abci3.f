      ...
      SUBROUTINE T32ABCI3(T3,W,ICORE,
     1                    IADT3,IADW,
...
C
     ...
     1            AI,VRT(IRPA,ISPIN1),2,IRPAI,128)
...
C
      ...
      CALL GETLST(ICORE(IADG(IRPA)),
     1            AJ,VRT(IRPA,ISPIN1),2,IRPAJ,128)
      CALL XGEMM('N','T',IRPDPD(IRPBC,ISPIN1),VRT(IRPA,ISPIN1),
     1           VRT(IRPD,ISPIN2), 1.0D+00,
     1           T3(IADT3(IRPD)),IRPDPD(IRPBC,ISPIN1),
...
C
      ...
      CALL GETLST(ICORE(IADG(IRPA)),
     1            AI,VRT(IRPA,ISPIN2),2,IRPAI,130)
...
C
  ...
  320 CONTINUE
C
C     CONTRACT TO GET CONTRIBUTION TO W(AB,CI)
C
      ...
      CALL GETLST(ICORE(IADG(IRPA)),
     1            AJ,VRT(IRPA,ISPIN2),2,IRPAJ,130)
      CALL XGEMM('N','N',IRPDPD(IRPBC,13),VRT(IRPA,ISPIN2),
     1             VRT(IRPD,ISPIN1), 1.0D+00,
     1            W(IADW(IRPD)),IRPDPD(IRPBC,13),
...
C            GAMMA EQUATIONS.
C
C     SET ADDRESSES FOR EXPANDED W2(D,A).
C
...
C
      ...
      CALL GETLST(ICORE(IADG(IRPA)),
     1            AK,VRT(IRPA,ISPIN1),2,IRPAK,129)
