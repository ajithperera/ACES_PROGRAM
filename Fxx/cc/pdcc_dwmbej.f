      SUBROUTINE PDCC_DWMBEJ(ICORE,MAXCOR,SPCASE,IUHF,C1,C2,C3,C4,
     &                      LISTIN_1,LISTIN_2,ISPAR,COULOMB,
     &                      WMBEJ_SCALE)
C
...
C
     ...
     &         IFLAGS2(117) .EQ. 10)
      ...
      Write(6,*)
      Write(6,"(a)") " The DCC parameters passed in as argument"
      Write(6,"(a,4a)") " The spin-case :", SPCASE
      Write(*,"(a,2L4)") " The ISPAR and COULOMB", ISPAR, COULOMB
      Write(*,"(a,F5.3)") " The parbeta : ", parbeta
      Write(*,"(a,F5.3)") " The paralpha: " , paralpha
