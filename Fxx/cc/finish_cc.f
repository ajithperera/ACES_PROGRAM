...
cAP - 500 is the maximum number of CC iterations (not basis functions)
      COMMON /ENERGY_CC/ ECORR(500,2),IXTRLE(500)
...
C Entries at 51 and 52 correspond to external CC runs (the first runs 
...
cmn again for vibronic purposes:
     ...
     &           IFLAGS(2) .EQ. 49)
      ...
      IF (HBAR_OK) CALL PUTREC(1,'JOBARC','CC_DONE ',IONE,IONE)
c
