...
CSSS      DIMENSION ENERGY(500,2),IXTRLE(500)
...
cAP - 500 is the maximum number of CC iterations (not basis functions)
      COMMON /ENERGY_CC/ ENERGY(500,2),IXTRLE(500)
...
C
      ...
      IF (IFLAGS(21).EQ.1) THEN
         CALL DIISLST_CC(1,IUHF,METHOD.GE.6.AND.METHOD.NE.8)
      END IF
      CALL INCOR_CC(I0,ICRSIZ,IUHF)
      MAXCOR = ICRSIZ
...
C
      IF (IFLAGS(21).EQ.1) THEN
         CALL DODIIS0_CC(ICORE(I0),MAXCOR/IINTFP,IUHF,1,ICYCLE,
