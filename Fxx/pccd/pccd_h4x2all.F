      SUBROUTINE PCCD_H4X2ALL(ICORE,MAXCOR,ISPIN,IUHF,TAU)
C
...
C***********************************************************************
       LISTT=33+ISPIN
       LISTW=153+ISPIN
       CALL HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,
...
C***********************************************************************
        LISTT=34
C Note that LISTT=34 is ignored (it is constructed on the fly). 
        LISTW=156
        CALL PCCD_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,
...
C
       LISTW=154+IUHF
       LISTT=37
       CALL HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,1,42,
...
C
       LISTT=36
       LISTW=154
       CALL HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,42,
...
C***********************************************************************
       LISTW=158+IUHF
       LISTT=39
       CALL HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,43,
...
C
       LISTT=38
       LISTW=158
       CALL HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,43,
