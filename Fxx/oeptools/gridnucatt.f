      ...
      subroutine gridnucatt (
     &     natm, nprm, maxshl, 
     &     nshlatm, nprmshl, angfct, crdatm, alpha, 
     &     crdnuc, attint)
c
...
c $Id: gridnucatt.FPP,v 1.1.1.1 2008/05/29 19:35:40 taube Exp $
c 
      implicit none
c
c     .. input parameters ..
...
c                  
     ...
     &                 angfct(1,ishl), angfct(2,ishl), angfct(3,ishl),
     &                 angfct(1,jshl), angfct(2,jshl), angfct(3,jshl),  
