      ...
      SUBROUTINE G2INL2_LEOM(ICORE,MAXCOR,IUHF)
C
...
C
      ...
      ENDIF 
C These terms get included in Hbar(ai,bc) and Hbar(ijka)
C
C AUGMENT G IF THIS IS CCSD OR QCISD
C
CSSS      IF(CCSD.OR.QCISD)THEN
CSSS       CALL GADD(ICORE,MXCOR,IUHF,ICORE(I0AA),1,'MI')
CSsS      ENDIF
      IF(IUHF.EQ.0) THEN
       I0BB=I0AA
      ELSE
...
C
CSSS       IF(CCSD.OR.QCISD)THEN
CSSS        CALL GADD(ICORE,MXCOR,IUHF,ICORE(I0BB),2,'MI')
CSSS       ENDIF
      ENDIF
C
