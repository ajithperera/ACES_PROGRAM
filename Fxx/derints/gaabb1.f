      SUBROUTINE GAABB1(NIRREP,NTYPE,TYPE,NBAS,IOFFL,
     &           MULT,NRCSH,KHKTSH,INDGEN,ISTBSH,
     &           ISHLD,NNIJ,IJADD,
     &           NSTSH,NENDSH,
     &           BUF,BUF1,SORT)
C
C  GAABB1 PERFORMS THE SORT OF THE GAMMA ELEMENTS OF SYMMETRY TYPE
C  AABB. THIS IS THE INCORE VERSION
C 
CEND
C
C  CODED DEC/90/JG
...
C
           CALL EXPND_DERINTS(BUF,BUF1,NBAS2)
C
