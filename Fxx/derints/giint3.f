      ...
      SUBROUTINE GIINT3(NHKTA,NHKTB,KHKTA,KHKTB,ICENTA,LDIAG,
...
C PROPERTIES. THIS ROUTINE DEALS WITH THE ONE-CENTER
C CASES.
C
CEND
C
C  UNIVERSITY KARLSRUHE,    AUGUST/91  JG
C
...
C
C SECOND DERIVATIVE WITH RESPECT TO B
C
       WORK1(ISCR4+I)=SX0*QY0*SZ0+SX0*SY0*QZ0
       WORK1(ISCR5+I)=-DX0*DY0*SZ0
       WORK1(ISCR6+I)=-DX0*SY0*DZ0
       WORK1(ISCR7+I)=QX0*SY0*SZ0+SX0*SY0*QZ0
       WORK1(ISCR8+I)=-SX0*DY0*DZ0
       WORK1(ISCR9+I)=QX0*SY0*SZ0+SX0*QY0*SZ0
C
10    CONTINUE
C 
