      ...
      SUBROUTINE GIINT1(NHKTA,NHKTB,KHKTA,KHKTB,ICENTA,LDIAG,
     &                  ISTEPA,ISTEPB,ISTEPU,ISTEPV,NAHGTF,
     &                  NATOMC,CORPX,CORPY,CORPZ,TWOG,
     &                  CHARGE,WORK1)
C
...
C
       ...
       DX0=SHGTF*ODC00X(ISTRET+1)
       DY0=SHGTF*ODC00Y(ISTREU+1)
       DZ0=SHGTF*ODC00Z(ISTREV+1)
      ...
      DO 15 IRCA=1,NRCA
       ...
       DO 15 IRCB=1,MAXB
        ...
        IF(ABS(CONT).GT.THRSH) THEN
         CALL SAXPY(KHKTA*KHKTB*3,CONT,WORK1(ISCR1+1),1,
