...
c pmap        Array for mapping C1 to symmetry
      ...
      zcoef  =setptr(1,1,    nbastot*nbastot)
      zdens  =setptr(1,1,    nbastot*nbastot*2)
      zbuf   =setptr(1,1,    ilnbuf)
      zdens1 =setptr(1,1,    nbastot*(nbastot+1)/2*(iuhf+1))
      zcdens =setptr(1,1,    nbastot*nbastot*(iuhf+1))
      zocc   =setptr(1,1,    nbastot)

      pbuf   =setptr(1,0, ilnbuf)
      pmap   =setptr(1,0, nbastot)
