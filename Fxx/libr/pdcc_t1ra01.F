      SUBROUTINE PDCC_T1RA01(ICORE,MAXCOR,IUHF,LAMBDA)
C
...
CSSS        CALL TRACEOO('VOVO',IRREPDO,POP(1,ISPIN),VRT(1,ISPIN),
CSSS     &               DISTAR,ABFULL(1),ICORE(I000),
CSSS     &               ICORE(I020))
CSSS        CALL SYMTRA(1,VRT(1,ISPIN),VRT(1,ISPIN),1,
CSSS     &              ICORE(I020),ICORE(I010))
CSSS        CALL SUMSYM3(ICORE(I010),ICORE(I020),ABFULL(1),1,ISPIN,LSTFEA)
CSSS        ENDIF
C
