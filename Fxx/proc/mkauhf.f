      ...
      SUBROUTINE MKAUHF(AMAT,SCRATCH,IRREP)
C
...
1001   CONTINUE
       IOFF=IOFFBBBB
       call getall(scratch,NUMSYW*DISSYW,1,LISTW)
       call checksum("@-MKUHF:ABIJ", scratch, NUMSYW*DISSYW)
       NUMSYW=IRPDPD(IRREP,ISYTYP(2,LISTW2))
       DISSYW=IRPDPD(IRREP,ISYTYP(1,LISTW2))
       call getall(scratch,NUMSYW*DISSYW,1,LISTW2)
       call checksum("@-MKUHF:AIBJ", scratch, NUMSYW*DISSYW)
C
1000  CONTINUE
C
...
C
      ...
      DISSYW=IRPDPD(IRREP,ISYTYP(1,LISTW))
       call getall(scratch,NUMSYW*DISSYW,1,LISTW)
       call checksum("@-MKUHF:ABIJ:AiBj", scratch, NUMSYW*DISSYW)
      IOFF2=IOFFAABB
      IOFF=IOFFBBAA
