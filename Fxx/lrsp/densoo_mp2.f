       ...
       SUBROUTINE DENSOO_MP2(DOO,T2AMPS,ICORE,MAXCOR,T2LN,T2LN_AA,
...
C
     ...
     &                   *POP(DIRPRD(IRREPJ,IRREP),ISPIN)
               ...
               DISSYT=IRPDPD(IRREP,ISPIN)
               NUMSYT=IRPDPD(IRREP,2+ISPIN)  
               T2LEN = DISSYT*NUMSYT
     ...
     &                          DISSYT,NUMSYT,NOCC2SQ,T2LEN,IRREP,
     &                          IUHF)
               ENDIF 
