      SUBROUTINE SYMRHF3(IRREPL,IRREPR,NUML,NUMR,DISSIZE,A,
     &                  SCR,ISCRL,ISCRR)
C
...
C
C  INPUT :  IRREPR ...   IRREP OF   G(K)*G(L)
C           IRREPL ...   IRREP OF   G(I)*G(J)
...
C
      ...
      DO 10 IRREPJ=1,NIRREP-1
       ...
       IRREPK=DIRPRD(IRREPR,IRREPJ)
       IPR(IRREPJ+1)=IPR(IRREPJ)+NUMR(IRREPK)*NUMR(IRREPJ)
