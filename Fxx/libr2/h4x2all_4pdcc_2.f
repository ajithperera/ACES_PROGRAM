      ...
      SUBROUTINE H4X2ALL_4PDCC_2(ICORE,MAXCOR,ISPIN,IUHF,TAU,
     &                           T3L)
C
...
C***********************************************************************
       LISTT=33+ISPIN
       LISTW=53+ISPIN
       CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,
...
C***********************************************************************
        LISTT=34
        LISTW=56
        CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,42,
...
C
       LISTW=54+IUHF
       LISTT=37
       CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,1,42,
...
C
       LISTT=36
       LISTW=54
       CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,42,
...
C***********************************************************************
       LISTW=58+IUHF
       LISTT=39
       CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,43,
...
C
       LISTT=38
       LISTW=58
       CALL HRNGDRV_2(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,43,
