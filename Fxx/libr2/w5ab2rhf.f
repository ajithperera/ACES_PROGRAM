      SUBROUTINE W5AB2RHF(ICORE,MAXCOR,IUHF,TERM1,TERM2,TERM3,TAU,
     &                    IOFFLIST,HBAR_4LCCSD,NONHF)
C
...
C
       IF (HBAR_4LCCSD) THEN
          IF (NONHF) THEN
             CALL GETLST(ICORE(I020),1,1,1,3,93)
          ELSE
             CALL ZERO(ICORE(I020),NT(1)*IINTFP)
          ENDIF 
       ELSE
