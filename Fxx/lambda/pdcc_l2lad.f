      SUBROUTINE PDCC_L2LAD(ICORE,MAXCOR,IUHF,ITYPE,LISTIN)
C
...
C
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW)THEN
          CALL PDcC_LLADAA1(ICORE(I020),ICORE(I000),ICORE(I010),
     &                 MAXSIZE,DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,
     &                 LISTT,
        ...
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW)THEN
          IF(IUHF.NE.0.OR.ITYPE.EQ.1)THEN
           CALL PDCC_LLADAB1(ICORE(I020),ICORE(I000),ICORE(I010),
     &                  MAXSIZE,DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,
     &                  LISTT,ITYPE,
     &                  IRREP,CC,CCSD)
          ELSE
           CALL PDCC_LLADAB2(ICORE(I020),ICORE(I000),ICORE(I010),
     &                  MAXSIZE,DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,
     &                  LISTT,ITYPE,
     &                  IRREP,CC,CCSD)
          ENDIF
