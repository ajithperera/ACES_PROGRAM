      SUBROUTINE F1T1INL2(T2,T1A,T1B,F1A,F1B,DISSYT,
     &                    NUMSYT,POP1,POP2,VRT1,VRT2,
     &                    IRREP,ISPIN)
C
C THIS SUBROUTINE CALCULATES THE T1*F1 CONTRIBUTION TO L2[2]
C IN CASE OF ROHF-MBPT[3]:
C
C  L2(AB,IJ) <= + T1(A,I)*F1(B,J)+F1(A,I)*T1(B,J)
C               - T1(A,J)*F1(B,I)-F1(A,J)*T1(B,I)
C
...
C
      ...
      DIMENSION T2(DISSYT,NUMSYT),T1A(1),T1B(1),F1A(1),F1B(1)
