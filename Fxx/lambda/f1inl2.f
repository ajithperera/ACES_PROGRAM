      SUBROUTINE F1INL2(ICORE,MAXCOR,IUHF)
C
...
C
       IF(.NOT.QCISD) THEN
C
C  ALLOCATE MEMORY FOR F(EA) AND T1
C
        I01=I0ZB-IINTFP*MAX(NTAA,NTBB)
        I02=I01-IINTFP*MAX(NTAA,NTBB)
C
C  DO NOT UPDATE MAXCOR
C
C  GET F(EM) AND T1 AMPLITUDES
C
...
C     IN CORE VERSION
C
         CALL F1L2AA(ICORE(I001),ICORE(I002),ICORE(I002),
