      SUBROUTINE OSL1II2(ICORE,MAXCOR,IUHF,W)
C
...
C
C  WHERE TARGET INDECES ARE INACTIVE
C
C  WITH
C
...
C
         ...
         NUMSYL=FSDPDII(1,ISYTYP(2,LISTL))
         ...
         IF(NSIZTAR.NE.NUMSYL.OR.DISSYL.NE.NUMSYT) THEN
            WRITE(6,*)'@OSL21II2-E FATAL ERROR: NSIZTAR.NE.NUMSYL',
...
C
         ...
         IF(I030.GT.MAXCOR) CALL INSMEM('OSL1II2',I030,MAXCOR)
C
         CALL FSGET(ICORE(I020),1,NUMSYT,1,IRREP,LISTT,STRING)
         CALL FSGET(ICORE(I010),1,NUMSYL,1,1,LISTL,'AIII')
C
...
C
         CALL FSGET(ICORE(I020),1,NUMSYT,1,IRREP,LISTT,STRING)
         CALL FSGET(ICORE(I010),1,NUMSYL,1,1,LISTL,'IAII')
C
...
C
         I020=I010+IINTFP*NUMSYL*DISSYL
C
         CALL FSGET(ICORE(I010),1,NUMSYL,1,1,LISTL,'IIII')
C
         CALL XGEMM('N','N',1,NUMSYL,DISSYL,ONEM,ICORE(I0(3-ISPIN)),1,
     $        ICORE(I010),DISSYL,ONE,ICORE(I000),1)
C
C     AB SPINCASE
C
...
C
         CALL FSGET(ICORE(I010),1,NUMSYL,1,1,LISTL,'IIII')
C
         CALL XGEMM('N','N',1,NUMSYL,DISSYL,ONE,ICORE(I0(ISPIN)),1,
     $        ICORE(I010),DISSYL,ONE,ICORE(I000),1)
C
C     SCALE BY W
C
...
C
         CALL FSGETT1(ICORE(I010),5-ISPIN,90,'II',11-ISPIN)
         CALL SAXPY(NSIZTAR,W,ICORE(I000),1,ICORE(I010),1)
         CALL FSPUTT1(ICORE(I010),5-ISPIN,90,'II',11-ISPIN)
C
 1000 CONTINUE
      RETURN
      END
