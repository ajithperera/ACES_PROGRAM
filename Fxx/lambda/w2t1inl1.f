...
C
      DATA ONE,ONEM,ZILCH /1.0D0,-1.D0,0.D0/ 
C
C       L1(E;M) =  t(F;N) <MN||EF> + t(f,n) <Mn|Ef> 
C
C       L1(e;m) =  t(f;n) <mn||ef> + t(F;N) <mN|eF>
C
      LISTT1=90
...
C
      ...
      IF(I040.GT.MAXCOR)CALL INSMEM('W2T1INL1',I040,MAXCOR)
      IF(BREDUNDANT) THEN
     ...
     &                  LISTW1,1)
      ENDIF
c      call chksums("w2t1inl1 listw1 1: ",icore(i030),nwdis1*nwdsz1)
      CALL XGEMM('N','N',1,NTOTTAR,NSIZT1,ONE,ICORE(I010),
     &           1,ICORE(I030),NWDSZ1,ONE,L1,1)
     ...
     &                  LISTW2,1)
      ENDIF
c      call chksums("w2t1inl1 listw2 1: ",icore(i030),nwdis2*nwdsz2)
      CALL XGEMM('N','N',1,NTOTTAR,NSIZT2,ONE,ICORE(I020),
     &           1,ICORE(I030),NWDSZ2,ONE,L1,1)
      RETURN
      END
