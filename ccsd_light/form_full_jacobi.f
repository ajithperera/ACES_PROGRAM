      ...
      Subroutine Form_full_jacobi(Hbar_mia,Hbar_mib,Hbar_aea,Hbar_aeb,
     ...
     +                                   Maxcor)
      ...
      Do I = 1, Ileng_cc_jacobi
         ...
         Elseif (I .Gt. Len1 .And. I .Le. Len2) Then
             ...
             Call Fill_vec(Work(Ivec2_in_aa),Nocc_a,Nvrt_a,I,Len1)
         Elseif (I .Gt. Len2 .And. I .Le. Len3) THen
             Ioff = I-Len2-1
             Work(Ivec2_in_bb+Ioff) = Done
             Call Fill_vec(Work(Ivec2_in_bb),Nocc_b,Nvrt_b,I,Len2)
