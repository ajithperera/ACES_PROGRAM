...
C  SAVE G ON DISK
C
CSSS          call checksum('tpdijka6',icore(i010),numsyg*dissyg,s)
...
C
1101    CONTINUE
CSSS        call checksum('tp6 in g',icore(i000),numsyg*dissyg,s)
CSSS        call checksum('tp6 inh1',icore(i010),numsyh1*dissyh1,s)
C
...
1200    CONTINUE
CSSS        call checksum('tp6 in g',icore(i000),numsyg*dissyg,s)
CSSS        call checksum('tp6 inh2',icore(i010),numsyh2*dissyh2,s)
C
