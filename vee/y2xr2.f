...
CSSS      call checksum('y2xr2 1 ',icore(I000),numsyg*dissyg,s)
      IF(IUHF.EQ.0) THEN
C
...
C
       ENDIF
CSSS      call checksum('y2xr2 2 ',icore(I000),numsyg*dissyg,s)
C
C UPDATE G(IJ,AB) ON DISK
C
       CALL GETLST(ICORE(I010),1,NUMSYG,1,IRREPR,LISTG)
CSSS      call checksum('y2xr2 3 ',icore(I010),numsyg*dissyg,s)
       CALL SAXPY(NUMSYG*DISSYG,ONE,ICORE(I010),1,ICORE(I000),1)
CSSS      call checksum('y2xr2 4 ',icore(I000),numsyg*dissyg,s)
       CALL PUTLST(ICORE(I000),1,NUMSYG,1,IRREPR,LISTG)
C
200   CONTINUE
C
