...
105     CONTINUE
        ...
        If (ispin .eq. 1) then
        call checksum("QIJ2AA :",ICORE(I0GIJ),LENGIJ,S)
        call checksum("QAB2AA :",ICORE(I0GAB),LENGAB,S)
        else
        call checksum("QIJ2BB :",ICORE(I0GIJ),LENGIJ,S)
        call checksum("QAB2BB :",ICORE(I0GAB),LENGAB,S)
        endif
