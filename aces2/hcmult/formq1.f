...
C
      ...
      Call checksum("QABAA  :",ICORE(I0QABA),LENQABA,S)

C      call output(ICORE(I0QABA),1,vrt(1,1),1,vrt(1,1),vrt(1,1),
C     &                   vrt(1,1),1)
C
C      call output(ICORE(I0QIJA),1,pop(1,1),1,pop(1,1),pop(1,1),
C     &                   pop(1,1),1)

CSSS      call dzero(ICORE(I0QIJA),LENQIJA)

      CALL PUTLST(ICORE(I0QIJA),1,1,1,1,491)
      Call checksum("QIJAA  :",ICORE(I0QIJA),LENQIJA,S)
      IF(IUHF.NE.0)THEN
       I0QABB=I0QABA+IINTFP*LENQABA
       I0QIJB=I0QIJA+IINTFP*LENQIJA

       Call checksum("QABAA  :",ICORE(I0QABB),LENQABA,S)
CSSS       call dzero(ICORE(I0QIJB),LENQIJB)
       Call checksum("QIJAA  :",ICORE(I0QIJB),LENQIJA,S)
