...
C
        ...
        call checksum("W(abci):",ICORE(I010),NUMDSW* DISSYW,S)
C         call output(Icore(I010),1,DISSYW,1,NUMDSW,DISSYW,
C     &               NUMDSW,1)
...
120     CONTINUE
         call checksum("Z(abij):",ICORE(I000),NUMDSZ*DISSYZ,S)
C         call output(Icore(I000),1,DISSYZ,1,NUMDSZ,DISSYZ,
C     &               NUMDSZ,1)
C
