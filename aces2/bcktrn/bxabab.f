      SUBROUTINE BXABAB(EVEC,BUF1,BUF2,BUF3,BUFTMP,LEN1,LEN2,LEN3,
     &                  LENTMP,IUHF)
C
...
C
         ...
         IOFFEVB=INDVRT(IRREPI,ISL)
         IOFFEOA=INDOCC(IRREPXI,ISL)
         IOFFEOB=INDOCC(IRREPI,ISL)
         IOFFG1A=IOFF2A
...
C
         DO 130 INDEXJ=1,NJI
          DO 140 INDEXB=1,NBXI
           CALL SYTRAB(BUF2(IOFFG1A),BUF2(IOFFG2A),EVEC(IOFFEVA),
     &                 EVEC(IOFFEVB),EVEC(IOFFEOA),EVEC(IOFFEOB),
     &                 NAOXI,NAOI,NAXI,NAI,NIXI,NII,BUFTMP,
     &                 BUF1(IOFF1),0)
...
C
         ...
         DO 150 INDEXJ=1,NJXI
          DO 160 INDEXB=1,NBI
           CALL SYTRAB(BUF2(IOFFG2B),BUF2(IOFFG1B),EVEC(IOFFEVA),
     &                 EVEC(IOFFEVB),EVEC(IOFFEOA),EVEC(IOFFEOB),
     &                 NAOXI,NAOI,NAXI,NAI,NIXI,NII,BUFTMP,
     &                 BUF1(IOFF1),0)
...
C
          DO 230 INDEXJ=1,NJI
           DO 240 INDEXB=1,NBXI
            CALL SYTRAB(BUF3(IOFFG1A),BUF3(IOFFG2A),EVEC(IOFFEVA),
     &                  EVEC(IOFFEVB),EVEC(IOFFEOA),EVEC(IOFFEOB),
     &                  NAOXI,NAOI,NAXI,NAI,NIXI,NII,BUFTMP,
     &                  BUF1(IOFF1),1)
            IOFFG1A=IOFFG1A+IBLKSIZ
...
C
          ...
          DO 250 INDEXJ=1,NJXI
           DO 260 INDEXB=1,NBI
            CALL SYTRAB(BUF3(IOFFG2B),BUF3(IOFFG1B),EVEC(IOFFEVA),
     &                  EVEC(IOFFEVB),EVEC(IOFFEOA),EVEC(IOFFEOB),
     &                  NAOXI,NAOI,NAXI,NAI,NIXI,NII,BUFTMP,
     &                  BUF1(IOFF1),1)
            IOFFG1B=IOFFG1B+IBLKSIZ
...
C
          DO 170 INDXNU=1,NAOI
           DO 180 INDXMU=1,NAOXI
            CALL SCOPY(NSZBJ1,BUF1(IOFF1A),NSIZF,BUFTMP,1)
            CALL SCOPY(NSZBJ2,BUF1(IOFF1B),NSIZF,
     &               BUFTMP(IOFFBA),1)
     ...
     &                BUFTMP(IOFFBB),BUFTMP(IOFFCC),0)
            ...
            CALL PUTLST(BUFTMP(IOFFCC),IOFF1A,1,1,3,ITHRU)
            IOFF1A=IOFF1A+1
            IOFF1B=IOFF1B+1
180        CONTINUE
170       CONTINUE
...
C
          ...
          IOFFCC=IOFFBB+NAOXI*NAOI
C
          DO 270 INDXNU=1,NAOI
           DO 280 INDXMU=1,NAOXI
            CALL SCOPY(NSZBJ1,BUF1(IOFF1A),NSIZF,BUFTMP,1)
            CALL SCOPY(NSZBJ2,BUF1(IOFF1B),NSIZF,
     &               BUFTMP(IOFFBA),1)
            CALL GETLST(BUFTMP(IOFFCC),IOFF1A,1,1,3,ITHRU)
