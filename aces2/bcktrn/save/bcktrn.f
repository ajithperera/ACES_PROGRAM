...
C
      IOFF0=0
      IF(SPHHRM)CALL SPH2CRT(ICORE(I000),ICORE(I010),MAXCOR,IUHF,1)
...
C
     ...
     &             ICORE(I010))
       ...
       IF(SPHHRM)CALL SPH2CRT(ICORE(I010),ICORE(I020),MAXCOR,IUHF,2)
...
C
       ...
       ELSE
          ...
          IEND=I040+N1C*IINTFP-I0+1
C
C AP, 12/99. No need to go in to BXAAAA2.
C       
          IF (.NOT. MOEQAO) THEN
           Write(6, *) "@BCKTRN Not enough memory for incore algorithm"
           CALL INSMEM('BXAAAA2', IEND, MAXCOR)
          ENDIF
       ENDIF 
C
       CALL BXAAAA2(ICORE(I000),ICORE(I020),ICORE(I030),ICORE(I040),
     &               N1A,N1B,N1C,IUHF,ICORE(I020),MAXSIZE,INCORE)
C
       IF(NIRREP.GE.2)THEN
        I030=I020+N2A*IINTFP
        I040=I030+N2B*IINTFP
