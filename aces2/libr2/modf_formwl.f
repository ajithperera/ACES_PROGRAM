      ...
      SUBROUTINE MODF_FORMWL(ICORE,MAXCOR,IUHF)
C
...
C DO SPIN CASE ABBA
C
      ISIZE=ISYMSZ(ISYTYP(1,258),ISYTYP(2,258))
      I000=1
      I010=I000+IINTFP*ISIZE
      I020=I010+IINTFP*ISIZE
      IF (I020.GT.MAXCOR+1) CALL INSMEM("FORMWL",(I020-1),MAXCOR)
      CALL GETALL(ICORE,ISIZE,1,258)
      CALL SSCAL(ISIZE,TWO,ICORE,1)
      CALL GETALL(ICORE(I010),ISIZE,1,25)
      CALL SAXPY(ISIZE,ONEM,ICORE(I010),1,ICORE(I000),1)
      CALL PUTALL(ICORE,ISIZE,1,258)
C
...
C DO SPIN CASE BABA
C
      ISIZE=ISYMSZ(ISYTYP(1,257),ISYTYP(2,257))
      I000=1
      I010=I000+IINTFP*ISIZE
      I020=I010+IINTFP*ISIZE
      IF (I020.GT.MAXCOR+1) CALL INSMEM("FORMWL",(I020-1),MAXCOR)
      CALL GETALL(ICORE,ISIZE,1,257)
      CALL SSCAL(ISIZE,TWO,ICORE,1)
      IF(bRedundant) THEN
...
C DO SPIN CASE BAAB
C
      ISIZE=ISYMSZ(ISYTYP(1,259),ISYTYP(2,259))
      I000=1
      I010=I000+IINTFP*ISIZE
      I020=I010+IINTFP*ISIZE
      IF (I020.GT.MAXCOR+1) CALL INSMEM("FORMWL",(I020-1),MAXCOR)
      CALL GETALL(ICORE,ISIZE,1,259)
      CALL SSCAL(ISIZE,TWO,ICORE,1)
      CALL GETALL(ICORE(I010),ISIZE,1,26)
      CALL SAXPY(ISIZE,ONEM,ICORE(I010),1,ICORE(I000),1)
      CALL PUTALL(ICORE,ISIZE,1,259)
C
      ENDIF
C
...
C
       CALL PDCC_T1RING(ICORE,MAXCOR,IUHF,.TRUE.)

C SUBTRACT THE T1**2 CONTRIBUTION 
C
       IF (.NOT. HBAR_4LCCSD) CALL MODF_T12INW3(ICORE,MAXCOR,IUHF)
C
C FOR UHF FORM THE ABAB CONTRIBUTION
C
       IF(IUHF.EQ.0) CALL MODF_QUIKAB(ICORE,MAXCOR,IUHF)
C
      ENDIF
      RETURN
      END
