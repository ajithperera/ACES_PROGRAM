      SUBROUTINE MODT1T1(ICORE,MAXCOR,IUHF,FACT)
C
C THIS ROUTINE READS IN LISTS 36 AND 37, AND FORMS
C
C   Z(AI,bj) = SIGN*T(AI)*T(bj)
C
...
CEND
      ...
      DOUBLE PRECISION FACT,ONE,ONEM,ZILCH
      LOGICAL BREDUNDANT
...
C
      ...
      CALL PUTALL(ICORE(I000),1,1,LISTT)

      IF(FACT.NE.ZILCH)THEN

         CALL XGEMM ('N','N',DISSIZ,NUMDIS,1,FACT,
     ...
     &             1,'3214')
       ...
       CALL ZERO(ICORE(I000),ISIZE)
       CALL PUTALL(ICORE(I000),1,1,LISTT-1)
