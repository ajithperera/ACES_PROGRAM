      SUBROUTINE H4X2_4PDCC(ICORE,MAXCOR,ISPIN,IUHF,TAU)
C
...
C***********************************************************************
       LISTT=33+ISPIN
       LISTW=53+ISPIN
       CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,
...
C
CSSS       IF(TAU) THEN
CSSS        NUMSYQ=IRPDPD(1,ISYTYP(2,39+ISPIN))
CSSS        DISSYQ=IRPDPD(1,ISYTYP(1,39+ISPIN))
CSSS        I000=1
CSSS        I001=I000+IINTFP*NUMSYQ*DISSYQ
CSSS        CALL L1T13(ICORE(I000),DISSYQ,NUMSYQ,ICORE(I001),
CSSS     &             ICORE(IOFFT1(ISPIN)),ICORE(IOFFT1(ISPIN)),
CSSS     &             ICORE(IOFFL1(ISPIN)),THREE,ISPIN,ISPIN,39+ISPIN,'N')
CSSS       ENDIF
C
...
CSSS       Call checksum(SPCASE,ICORE(I010),NTOTSZ2)
...
C***********************************************************************
        LISTT=34
        LISTW=56
        CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,
     &               42,TAU,ICORE(IOFFT1(1)),ICORE(IOFFT1(1)),      
...
C
       LISTW=54+IUHF
       LISTT=37
       CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,1,42,
...
C
CSSS       IF(TAU) THEN
CSSS        NUMSYQ=IRPDPD(1,ISYTYP(2,42))
CSSS        DISSYQ=IRPDPD(1,ISYTYP(1,42))
CSSS        I000=1
CSSS        I001=I000+NUMSYQ*DISSYQ*IINTFP
CSSS        CALL L1T13(ICORE(I000),DISSYQ,NUMSYQ,ICORE(I001),
CSSS     &             ICORE(IOFFT1(1)),ICORE(IOFFT1(2)),
CSSS     &             ICORE(IOFFL1(2)),THREEM,1,2,42,'N')
CSSS       ENDIF
C
...
C
       LISTT=36
       LISTW=54
       CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,42,
...
CSSS        I000=1
CSSS        I001=I000+NUMSYQ*DISSYQ*IINTFP
CSSS        CALL L1T13(ICORE,DISSYQ,NUMSYQ,ICORE(I001),
CSSS     &             ICORE(IOFFT1(2)),ICORE(IOFFT1(1)),
CSSS     &             ICORE(IOFFL1(1)),THREEM,2,1,42,'T')
CSSS       ENDIF
C***********************************************************************
C
...
C***********************************************************************
       LISTW=58+IUHF
       LISTT=39
       CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'TxW',MAXSIZ,INCREM,43,
...
C
       LISTT=38
       LISTW=58
       CALL PDCC_HRNGDRV(ICORE,MXCOR,LISTW,LISTT,'WxT',MAXSIZ,1,43,
...
CSSS       Call checksum("ABAB    ", ICORE(I010), NSZAB)
      ENDIF
      RETURN
      END
