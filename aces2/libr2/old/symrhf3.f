      SUBROUTINE SYMRHF3(IRREPIJ,IRREPKL,NUML,NUMR,DISSIZE,A,
     &                  SCR,ISCRL,ISCRR)
C
...
C
C  INPUT :  IRREPKL ...   IRREP OF   G(K)*G(L) 
C           IRREPIJ ...   IRREP OF   G(I)*G(J)
...
C
      ...
      DO 10 IRREPJ=1,NIRREP-1
       ...
       IRREPK=DIRPRD(IRREPKL,IRREPL)
       IPR(IRREPL+1)=IPR(IRREPL)+NUMR(IRREPK)*NUMR(IRREPL)
