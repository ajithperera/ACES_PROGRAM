      ...
      SUBROUTINE MODF_QUIKAB(ICORE,MAXCOR,IUHF,LISTA,LISTB,LISTC)
C
...
100    FORMAT(T3,'@QUIKAB, Fatal logic error.  QUIKAB called for UHF.')
      ENDIF
      TOTSIZ=ISYMSZ(ISYTYP(1,LISTC),ISYTYP(1,LISTC))
      I000=1
      I010=I000+TOTSIZ*IINTFP
      I020=I010+TOTSIZ*IINTFP 
      IF(I020.GT.MAXCOR)CALL INSMEM('QUIKAA',I020,MAXCOR)
      CALL GETALL(ICORE(I000),TOTSIZ,1,LISTA)
      CALL GETALL(ICORE(I010),TOTSIZ,1,LISTB)
      CALL VADD(ICORE(I000),ICORE(I010),ICORE(I000),TOTSIZ,ONEM)
      CALL PUTALL(ICORE,TOTSIZ,1,LISTC)
      RETURN
      END
