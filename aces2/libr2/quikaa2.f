      ...
      SUBROUTINE QUIKAA2(ICORE,MAXCOR)
C
...
C
     ...
     &                   Gae_scale,Gmi_scale 
      ...
      CALL GETALL(ICORE(I000),TOTSIZ,1,58+IOFFLISTH)

      Write(6,"(a)") "@-QUIKAA2:"
      call checksum("58      ", ICORE(I000), TOTSIZ)
      CALL GETALL(ICORE(I010),TOTSIZ,1,56+IOFFLISTH)
      call checksum("56      ", ICORE(I010), TOTSIZ)
      If (Ispar .and. Coulomb) Then
         CALL SAXPY(TOTSIZ,ONEM,ICORE(I010),1,ICORE(I000),1)
      Else 
         CALL SAXPY(TOTSIZ,ONEM,ICORE(I010),1,ICORE(I000),1)
      Endif 
      CALL PUTALL(ICORE,TOTSIZ,1,54+IOFFLISTH)
      call checksum("54      ", ICORE, TOTSIZ)
      RETURN
      END
