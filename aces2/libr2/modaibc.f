...
C
      ...
      DO 10 IRREPDO=1,NIRREP
       ...
       IF(I030.GT.MXCOR)THEN
        CALL MODAIBC2(ICORE(I010),MXCOR,IUHF,4,IRREPDO,FACT)
       ELSE
...
C
      ...
      DO 210 IRREPDO=1,NIRREP
       ...
       I030=I020+IINTFP*NUMDSZ*DISSYZ
       IF(I030.GT.MXCOR)THEN
        CALL MODAIBC2(ICORE(I010),MXCOR,IUHF,3,IRREPDO,FACT)
       ELSE
        CALL GETLST(ICORE(I010),1,NUMDSW,1,IRREPDO,LISTW)
        CALL GETLST(ICORE(I020),1,NUMDSZ,1,IRREPDO,LISTZ)
        IOFFT=I000
...
C
      DO 300 ISPIN=1,2
       ...
       DO 310 IRREPDO=1,NIRREP
        ...
        I030=I020+IINTFP*NUMDSZ*DISSYZ
        IF(I030.GT.MXCOR)THEN
         CALL MODAIBC2(ICORE(I010),MXCOR,IUHF,ISPIN,IRREPDO,FACT)
        ELSE
         CALL GETLST(ICORE(I010),1,NUMDSW,1,IRREPDO,LISTW)
