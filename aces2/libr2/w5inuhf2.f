      SUBROUTINE W5INUHF2(ICORE,MAXCOR,IUHF,TERM1,TERM2,IOFFLIST)
C
...
C
      ...
      DO 207 IRREP=1,NIRREP
       ...
       CALL SYMTR3(IRREP,VRT(1,2),POP(1,1),DISSYT,NUMDST,ICORE(IOFFT),
...
C
         DO 213 I=1,NUMI
          DO 214 IRREPB=1,NIRREP
           ...
           IOFFT=ILOCT(IRREPEM)+IINTFP*
     &           (NSUM*(ISYMOFF(IRREPI,IRREPEM,11)-1)+
     &           NSUM*NUMA*(I-1))
