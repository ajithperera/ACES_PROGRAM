      ...
      SUBROUTINE HRNGDRV_1(ICORE,MAXCOR,LISTW,LISTT,CALMOD,MAXSIZ,
...
CSSS         IF(TAU) THEN
CSSS          CALL F2TAU(ICORE(I010),T1A,T1B,DISSYT,NUMSYT,POP1,POP2,
CSSS     &               VRT1,VRT2,IRREP,FACT,SPCASE)
CSSS         ENDIF
...
C
        ...
        If (Ispar .and. Coulomb) Then
           Write(6, "(a,F5.2)") " In HRNGDR_1 setting delta to :",
     &                            Wmbej_scale
           Write(6,*)
           CALL DSCAL(NUMSYW*DISSYW, Wmbej_scale, ICORE(I020), 1)
        Endif
