      SUBROUTINE GABCD2(NIRREP,NTYPE,TYPE,NBAS,IOFFL,
...
C
      ...
      DIMENSION BUF(1),BUCK(1),IBUCK(1)
C
...
C
              ...
              BUCK(ISTART(IBATCH)+JCOUNT)=BUF(INDEX)
