...
c         IF (DHCEX2) THEN
c            IATOM = IATOM + 1
c            JOFFEX(IATOM) = IEX01
c            JOFFEY(IATOM) = IEY00
c            JOFFEZ(IATOM) = IEZ00
c            IOFFHC(IATOM) = INTHC
c            IHCEX2 = INTHC
c            NHCEX2 = NRCCPP
c            INTHC = INTHC + KHNRCP
c         END IF
       JENDAT(ICOOR) = IATOM
c      END IF
C
...
c         IF (DHCEY2) THEN
c            IATOM = IATOM + 1
c            JOFFEX(IATOM) = IEX00
c            JOFFEY(IATOM) = IEY01
c            JOFFEZ(IATOM) = IEZ00
c            IOFFHC(IATOM) = INTHC
c            IHCEY2 = INTHC
c            NHCEY2 = NRCCPP
...
c      IF (IPRINT .GE. 10) THEN
         WRITE (LUPRI, 1000)
c         WRITE (LUPRI, 1020) DHCEX, DHCEX1, DHCEX2
c         WRITE (LUPRI, 1030) DHCEY, DHCEY1, DHCEY2
c         WRITE (LUPRI, 1040) DHCEZ, DHCEZ1, DHCEZ2
c         WRITE (LUPRI, 1045) NWORKE
...
c      END IF
      RETURN
 1000 FORMAT (//,1X,'***** SUBROUTINE G1EINT - INITIALIZATION *****',/)
