      ...
      SUBROUTINE Tdcc_sa2_r_debug(ICORE,MAXCOR,IRREPX,IUHF)
C
...
C
      ...
      DATA MATTYP/'N','T'/
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_sa2_r_debug---"
        Write(6,*)
...
C
CSSS       CALL ZERO  (ICORE(I000),LENTAR)
        CALL GETLST(ICORE(I000),1,1,1,ISPIN,394)
C
       IF(IUHF.NE.0)THEN
...
C
     ...
     &              1,ICORE(I020),DISSYW,ONE,ICORE(I000),1)
      ...
      call Checksum("mu_r2_dot_debug(f2) :",Icore(I000),Lentar,S)
C
C THIS CONTRACTION INITIALIZES THE INCREMENT LIST
C
CSSS       CALL PUTLST(ICORE(I000),1,1,1,ISPIN+2,LISTT1)
C
 10    CONTINUE
