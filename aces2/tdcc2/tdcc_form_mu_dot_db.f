      ...
      Subroutine Tdcc_form_mu_dot_db(Work,Memleft,Irrepx,Iuhf,Ioff_vo)
...
C
      Data One, Onem, Zero/1.0D0, -1.0D0, 0.0D0/
        ...
        Write(6,*)
        Write(6,"(a)") "---Entered  tdcc_form_mu_dot_db---"
        Write(6,*)
...
C Z(Ab,Ij) = Hbar(Ab,Ie) * Mu(e,j) per given e 
     ...
     +           Isytyp(2,z2_pphh_list))
      ...
      call checksum("Tdcc_form_mu_dot_db Z(Ab,Ij)(f):",Work(i000),
     +               Isize_abij_z,S)
