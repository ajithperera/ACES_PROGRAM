      ...
      SUBROUTINE tdcc_mutilde_dot_da_debug(ICORE,MAXCOR,IUHF,IRROMEGA)
C
...
C
      ...
      DATA ZILCH/0.0D0/
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_mutilde_dot_da_debug---"
        Write(6,*)

      CALL GETDT1(ICORE,MAXCOR,MXCOR,IUHF,IOFFT1,IRROMEGA,392)
      RHF=.FALSE.
...
100   CONTINUE
      i000=1
      Isize_abij_z=Idsymsz(IRROMEGA,Isytyp(1,346),
     +           Isytyp(2,336))
      call getall(Icore(i000),Isize_abij_z,IRROMEGA,346)
      call checksum("Tdcc_mu_dot_da_debug Z(Ab,Ij)(f)  :",
...
210    CONTINUE
      i000=1
      Isize_abij_z=Idsymsz(IRROMEGA,Isytyp(1,listz),
     +           Isytyp(2,listz))
      call getall(Icore(i000),Isize_abij_z,IRROMEGA,listz)
      call checksum("Tdcc_mu_dot_da_debug Z(A<B,I<J)(f):",Icore(i000),
     +               Isize_abij_z,S)
200   CONTINUE
C
      RETURN
