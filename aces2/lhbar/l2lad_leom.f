      ...
      SUBROUTINE L2LAD_LEOM(ICORE,MAXCOR,IUHF,ITYPE,LISTIN)
C
...
C
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW)THEN
          CALL LLADAA1_LEOM(ICORE(I020),ICORE(I000),ICORE(I010),
     &                 MAXSIZE,
        ...
        IF(MIN(NUMSYT,NUMSYW,DISSYT,DISSYW).NE.0)THEN
         IF(MAXSIZE.GT.DISSYW)THEN
          IF(IUHF.NE.0.OR.ITYPE.EQ.1)THEN
           CALL LLADAB1_LEOM(ICORE(I020),ICORE(I000),ICORE(I010),
     &                  MAXSIZE,
     &                  DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,LISTT,ITYPE,
     &                  IRREP,CC,CCSD)
          ELSE
           CALL LLADAB2_LEOM(ICORE(I020),ICORE(I000),ICORE(I010),
     &                  MAXSIZE,
     &                  DISSYW,NUMSYW,DISSYT,NUMSYT,LISTW,LISTT,ITYPE,
     &                  IRREP,CC,CCSD)
          ENDIF
