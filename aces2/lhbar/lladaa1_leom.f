      ...
      SUBROUTINE LLADAA1_LEOM(W,T,Z,MAXSIZE,DISSYW,NUMSYW,DISSYT,
...
C
C This term is done in w1lad_eom.F for DCC
C
CSSS       call checksum("ZMNIJ    :", Z, NUMSYT*DISSYT)
CSSS#ifndef _DCC_FLAG
       If (.NOT. ispar) Then
       IF(CC)THEN
        CALL GETLST(T,1,NUMSYT,1,IRREP,13+ISPIN)
        CALL GETLST(W,1,NUMSYW,2,IRREP,150+ISPIN)
CSSS        call checksum("13+Ispin :", T, NUMSYT*DISSYT)
CSSS        call checksum("150+Ispin:",W, NUMSYW*DISSYW)
