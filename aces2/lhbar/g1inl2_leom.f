      ...
      SUBROUTINE G1INL2_LEOM(ICORE,MAXCOR,IUHF)
C
...
C These get included in Hbar(ai,bc) and Hbar(ij.ka)
C
C AUGMENT G IF THIS IS CCSD OR QCISD
C
CSSS      IF(CCSD.OR.QCISD) THEN
CSSS       CALL GADD(ICORE,MXCOR,IUHF,ICORE(I0AA),1,'EA')
CSSS      ENDIF
...
C
CSSS       IF(CCSD.OR.QCISD) THEN
CSSS        CALL GADD(ICORE,MXCOR,IUHF,ICORE(I0BB),2,'EA')
CSSS       ENDIF
      ENDIF
C
