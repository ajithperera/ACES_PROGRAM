...
C
      SUBROUTINE PRNT_SPNSPN_TNSR(XMATX, N, IFERMI, ISDIP, IPSO, 
     &                            IDSO, IEOMPROP)
C
...
C
 ...
 5000 FORMAT (1X, 'The NMR spin-spin colsupling tensors correspond to',
...
C      
      IF(IFERMI .NE. 0) THEN
          CALL OUTPUT(XMATX, 1, N, 1, N, N, N, 1)
         NCOMPO = 1
