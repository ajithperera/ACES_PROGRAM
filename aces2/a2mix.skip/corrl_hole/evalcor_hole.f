      SUBROUTINE EVALCOR_HOLE(IANGMOM, JANGMOM, KANGMOM, LANGMOM, 
     &                        INCRF,JNCRF, KNCRF, LNCRF, IBEGIN, 
     &                        JBEGIN, KBEGIN, LBEGIN, ICFNCOUNT, 
     &                        JCFNCOUNT, KCFNCOUNT, LCFNCOUNT, 
     &                        NTOTCRF, LENGTH, SHELIEQJ, SHELKEQL, 
     &                        SHELIJKL, ANGMOMIJ, ANGMOMKL, IPRIM,
     &                        JPRIM, KPRIM, LPRIM, NTOTPRIM, COORD_IX, 
     &                        COORD_IY, COORD_IZ, COORD_JX, 
     &                        COORD_JY, COORD_JZ, COORD_KX, 
     &                        COORD_KY, COORD_KZ, COORD_LX, 
     &                        COORD_LY, COORD_LZ, SCFDENT, RELDENT, 
     &                        SCFDEND, RELDEND, ALPHA, PCOEF,
     &                        GAMMATMP, GAMMA, POTNL_R, REPLSN_FACT,
...
C
     ...
     &          ALPHA(NTOTPRIM), PCOEF(NTOTPRIM, NTOTCRF)
C
...
C
     ...
     &                                  PRDUTINT(KNDX, LNDX)
C                              
C Calculate the appropriate AO integrals. The integral routine was provided by
C Peter Gill 
                              CALL EVAL_CUSP_INT(IMOMN, JMOMN, KMOMN, 
     &                                           LMOMN, IPRIM, JPRIM,
     &                                           KPRIM, LPRIM, COORD_IX,
     &                                           COORD_IY, COORD_IZ,
     &                                           COORD_JX, COORD_JY,
     &                                           COORD_JZ, COORD_KX,
     &                                           COORD_KY, COORD_KZ, 
     &                                           COORD_LX, COORD_LY, 
     &                                           COORD_LZ, ALPHA, UVALUE, 
     &                                           CUSPINT)
C
