...
C     write(6,*) ' @TRPS14-I, sym, record ',IRPIJK,IJKVAL
      IF(T3STOR)THEN
      CALL PUTLIST_PCCD(ICORE(IM50),IJKVAL,1,1,IRPIJK,1+3*(ISPIN-1),
     +                  PCCD)
      ENDIF
  410 CONTINUE
  420 CONTINUE
