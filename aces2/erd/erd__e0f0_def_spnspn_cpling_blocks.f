...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__E0F0_DEF_SPNSPN_CPLING_BLOCKS
     +
     +               ( ZMAX,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__E0F0_DEF_SPNSPN_CPLING_BLOCKS
...
C
         ...
         INTEGER     NINT2D,NINT2D1,NINT2D2
...
C
         IF (MEMORY) THEN
             ...
             NINT2D2 = MGQIJKL * (SHELLP+1) * (SHELLQ+1)
             MRSKL   = NRS * MKL
...
C
                    ...
                    ZINT2DX2 = ZINT2DZ1 + NINT2D1
                    ZINT2DY2 = ZINT2DX2 + NINT2D2
                    ZINT2DZ2 = ZINT2DY2 + NINT2D2
