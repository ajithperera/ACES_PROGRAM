         ...
         SUBROUTINE  ERD__SOI_PCGTO_BLOCK_XY
     +
     +                    ( NBATCH,
...
CSSS        write(*,*) ' I think I need to differential A and B'
CSSS        write(*,*) 'DIFFA=',DIFFA
CSSS        write(*,*) 'DIFFB=',DIFFB
...
C
C
cC         write(*,*) 'Primtype must be ABCD'
cPV         write(*,*) 'PRIMTYP=',PRIMTYP
