...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D2_SPNSPN_CPLINGYY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +                               INT2DZ2)
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D2_SPNSPN_CPLINGYY_PQ_INTEGRALS
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
                  ...
                  INT2DY2 (N,0,0) = (PQY * INT2DY1 (N,0,0) +
     +                                     INT2DY  (N,0,0) * RHOINV)
     +                                   * QROOT 
                  ...
                  DO K = 1, SHELLQ
                     ...
                     INT2DY2 (N,0,K) = (PQY  * INT2DY1 (N,0,K)  -
     +                                  QKL  * INT2DY1 (N,0,K1) * K
     +                                       + INT2DY  (N,0,K)
     +                                       * RHOINV)
     +                                       * QROOT 
                  ...
                  DO I = 1, SHELLP
                     ...
                     INT2DY2 (N,I,0) = (PQY  * INT2DY1 (N,I,0)  +
     +                                  PIJ  * INT2DY1 (N,I1,0) * I 
     +                                       + INT2DY  (N,I,0)
     +                                       * RHOINV)
     +                                       * QROOT 
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        ...
                        INT2DY2 (N,I,K) = ( PQY  * INT2DY1 (N,I,K)  +
     +                                      PIJ  * INT2DY1 (N,I1,K) * I  
     +                                    - QKL  * INT2DY1 (N,I,K1) * K  
     +                                           + INT2DY  (N,I,K)
     +                                           * RHOINV)
     +                                           * QROOT 
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
     ...
     +                                     * QROOT 
                  ...
                  INT2DY2 (N,0,1) = (PQY   * INT2DY1 (N,0,1) -
     +                               QKL   * INT2DY1 (N,0,0) 
     +                                     + INT2DY  (N,0,1)
     +                                     * RHOINV)
     +                                     * QROOT 
                  INT2DZ2 (N,0,1) = INT2DZ (N,0,1)
                 DO K = 2, SHELLQ
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
     ...
     +                                       RHOINV) * QROOT 
                  ...
                  INT2DY2 (N,1,0) = (PQY   * INT2DY1 (N,1,0) +
     +                               PIJ   * INT2DY1 (N,0,0) -
     +                                     + INT2DY  (N,1,0) * 
     +                                       RHOINV) * QROOT 
                  INT2DZ2 (N,1,0) = INT2DZ (N,1,0)
                  DO I = 2, SHELLP
                     I1 = I - 1

                     INT2DX2 (N,I,0) = INT2DX (N,I,0)
                     INT2DY2 (N,I,0) = (PQY  *      INT2DY1 (N,I,0)  +
     +                                  PIJ  *  I * INT2DY1 (N,I1,0) 
     +                                            + INT2DY  (N,I,0)  * 
     +                                              RHOINV) * QROOT 
                     INT2DZ2 (N,I,0) = INT2DZ (N,I,0)
                  ENDDO
