...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D2_ATOM_SPNSPN_CPLINGYY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
                 ...
                 INT2DY2 (N,0,0) = INT2DY (N,0,0) * QROOT * RHOINV
                 ...
                 DO K = 1, SHELLQ
                    ...
                    INT2DY2 (N,0,K) = (- QKL * INT2DY1 (N,0,K1) * K
     +                                       + INT2DY  (N,0,K)  * 
     +                                         RHOINV) * QROOT
                 ...
                 DO I = 1, SHELLP
                    ...
                    INT2DY2 (N,I,0) = (PIJ * INT2DY1 (N,I1,0) * I 
     +                                     + INT2DY  (N,I,0)  * RHOINV)
     +                                     * QROOT
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DY2 (N,I,K) = (INT2DY1 (N,I1,K) * I  * PIJ  -
     +                                    INT2DY1 (N,I,K1) * K  * QKL
     +                                  + INT2DY  (N,I,K)  * RHOINV)
     +                                  * QROOT
