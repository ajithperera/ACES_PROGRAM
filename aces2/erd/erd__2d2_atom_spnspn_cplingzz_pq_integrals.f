...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D2_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      P,Q,RTS,
     ...
     +                               INT2DZ2)
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D2_ATOM_SPNSPN_CPLINGZZ_PQ_INTEGRALS
...
CSSS                 QROOT = RTS(N) *  RTS(N) * RHOSQR * INVRT
                 ...
                 INT2DZ2 (N,0,0) = INT2DZ (N,0,0) * QROOT * RHOINV
                 ...
                 DO K = 1, SHELLQ
                    ...
                    INT2DZ2 (N,0,K) = (- QKL * INT2DZ1 (N,0,K1) * K
     +                                       + INT2DZ  (N,0,K) *
     +                                         RHOINV) * QROOT
                 ENDDO
                 ...
                 DO I = 1, SHELLP
                    ...
                    INT2DZ2 (N,I,0) = (PIJ * INT2DZ1 (N,I1,0) * I 
     +                                     + INT2DZ (N,I,0)  * RHOINV)
     +                                     * QROOT
                 ...
                 DO I = 1, SHELLP
                    DO K = 1, SHELLQ
                       ...
                       INT2DZ2 (N,I,K) = (INT2DZ1 (N,I1,K) * I  * PIJ  -
     +                                    INT2DZ1 (N,I,K1) * K  * QKL
     +                                  + INT2DZ  (N,I,K)  * RHOINV) 
     +                                  * QROOT
