...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D_SPNSPN_CPLINGXY_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_SPNSPN_CPLINGXY_PQ_INTEGRALS
...
C
         ...
         DOUBLE PRECISION  PQX,PQY
         DOUBLE PRECISION  PQXC,PIJXC,QKLXC
         DOUBLE PRECISION  QROOT
         DOUBLE PRECISION  PQ,PQSUM,TWORHO,RHOSQR, RHO
...
C
     ...
     +                                   INT2DX (N,1,K1) * QKL * K
                       ...
                       INT2DY1 (N,1,K) = INT2DY (N,1,K)  * PQX +
     +                                   INT2DY (N,0,K)  * PIJ -
     +                                   INT2DY (N,1,K1) * QKL * K
