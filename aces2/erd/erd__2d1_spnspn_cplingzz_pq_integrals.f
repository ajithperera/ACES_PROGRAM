...
C  in the file COPYRIGHT.
         SUBROUTINE  ERD__2D1_SPNSPN_CPLINGZZ_PQ_INTEGRALS
     +
     +                    ( SHELLP,SHELLQ,
     +                      MIJ,MKL,NGQP,NGQEXQ,
     +                      PX,PY,PZ,QX,QY,QZ,
     ...
     +                               INT2DZ1 )
C------------------------------------------------------------------------
C  OPERATION   : ERD__2D_SPNSPN_CPLINGZZ_PQ_INTEGRALS
...
C
         ...
         DOUBLE PRECISION  PQ,PQSUM,TWORHO, DUMB
         ...
         DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DZ1 (N,0,0) = PQZ  * INT2DZ (N,0,0) * QROOT 

                  DO K = 1, SHELLQ
                     K1 = K - 1

                     INT2DZ1 (N,0,K) = (PQZ  * INT2DZ (N,0,K)   -
     +                                  QKL  * INT2DZ (N,0,K1)  * K) *
     +                                  QROOT 
                  ENDDO 
...
C       Write(*,*)
                  ...
                  DO I = 1,  SHELLP
                     DO K = 1,  SHELLQ
                        ...
                        INT2DZ1 (N,I,K) = (PQZ  * INT2DZ (N,I,K)  +
     +                                     PIJ  * INT2DZ (N,I1,K) * I  -
     +                                     QKL  * INT2DZ (N,I,K1) * K) *
     +                                     QROOT 
                     ENDDO
    ...
    2    DO IJ = 1,MIJ
            ...
            DO KL = 1,MKL
               ...
               DO ROOT = 1, NGQP
                  ...
                  INT2DZ1 (N,0,0) = PQZ    * INT2DZ (N,0,0) * QROOT 
                  INT2DZ1 (N,0,1) = (PQZ   * INT2DZ (N,0,1) -
     +                               QKL   * INT2DZ (N,0,0)) 
     +                                     * QROOT
