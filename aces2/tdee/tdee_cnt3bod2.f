      ...
      SUBROUTINE TDEE_CNT3BOD2(IRREPX,ICORE,MAXCOR,IUHF,LISTZ0)
C
...
C
      DO 100 IRREPZR=1,NIRREP
       ...
       CALL GETLST(ICORE(I020),1,1,1,1+IUHF,381)
       CALL GETLST(ICORE(I030),1,1,1,1+IUHF,382)
C
...
C
        CALL GETLST(ICORE(I020),1,1,1,1,381)
        CALL GETLST(ICORE(I030),1,1,1,1,382)
C
...
C
      DO 500 ISPIN=1,2
       DO 510 IRREPZR=1,NIRREP
        ...
        CALL GETLST(ICORE(I020),1,1,1,ISPIN,381)
        CALL GETLST(ICORE(I030),1,1,1,ISPIN,382)
