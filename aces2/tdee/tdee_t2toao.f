      ...
      SUBROUTINE TDEE_T2TOAO(ICORE,MAXCOR,IUHF,TAU,TAU2,LISTT2,
     &                       LSTAO,IRREPX)
C
...
C
CEND
C LISTT2=313(ISIDE=1),323(ISIDE=2)
...
C
         IF(ISPIN.LE.2) THEN
          CALL GETLST(ICORE(I020),1,1,1,ISPIN,90)
          CALL GETLST(ICORE(I040),1,1,1,ISPIN,396)
...
C
          CALL GETLST(ICORE(I020),1,1,1,1,90)
          CALL GETLST(ICORE(I040),1,1,1,1,396)
          CALL GETLST(ICORE(I030),1,1,1,1+IUHF,90)
          CALL GETLST(ICORE(I050),1,1,1,1+IUHF,396)
          CALL DTAU(IRREPAB,IRREPIJ,1,IRREPX,ICORE(I000),
