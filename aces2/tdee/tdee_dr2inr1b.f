      ...
      SUBROUTINE TDEE_DR2INR1B(ICORE,MAXCOR,IUHF,IRROMEGA,ISIDE,
     &                         LISTW0,LISTT0)
C
...
CSSS        call checksum("check1",icore(i000),Lentar,s)
C
...
C
       IF (ISIDE .EQ. 1) THEN
          CALL GETLST(ICORE(I010),1,1,1,ISPIN,394)
          CALL SAXPY (LENTAR,ONE,ICORE(I000),1,ICORE(I010),1)
          CALL PUTLST(ICORE(I010),1,1,1,ISPIN,394)
       ELSEIF (ISIDE .EQ. 2) THEN
          CALL GETLST(ICORE(I010),1,1,1,ISPIN,396)
          CALL SAXPY (LENTAR,ONE,ICORE(I000),1,ICORE(I010),1)
          CALL PUTLST(ICORE(I010),1,1,1,ISPIN,396)
       ENDIF 
C
50    CONTINUE
C
