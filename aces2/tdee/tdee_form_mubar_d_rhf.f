...
C
      SUBROUTINE TDEE_FORM_MUBAR_D_RHF(MIJBAR,MABBAR,MIABAR,ICORE,
...
C
     ...
     &             VRT(1,1),POP(1,1),ICORE(I020),IRREPX,'1324')
       If (iside .eq.1)  call Checksum("tdee_form_mubar_d_rhf_r(f)  :",
     +                                  icore(I010),isize,S)

       If (iside .eq.2)  call Checksum("tdee_form_mubar_d_rhf_l(f)  :",
     +                                  icore(I010),isize,S)
C
