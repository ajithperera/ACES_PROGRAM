      ...
      SUBROUTINE TDEE_LOAD_INIT_VEC(IRREPX,SCR,MAXCOR,LIST1,IOFF1,
...
C
      ...
      I0C1A=1
      CALL GETLST(SCR(I0C1A),1,1,1,3,LIST1+IOFF1)
      Write(6,*)
      Write(6,"(a)") "@-tdee_load_init_vec"
      ...
      IF(IUHF.NE.0)THEN
       ...
       ITOP  =I0C2AA+LENC2AA
       CALL GETLST(SCR(I0C1B),1,1,1,4,LIST1+IOFF1)
