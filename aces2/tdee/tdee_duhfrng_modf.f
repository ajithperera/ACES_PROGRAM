      ...
      SUBROUTINE TDEE_DUHFRNG_MODF(ICORE,MAXCOR,IUHF,IRREPX,DISCO,
     &                             INCREM,LISTT0,LISTZ0,LSTTMP0,
     &                             ISIDE)
C
...
C
        IF(DISCO.AND.IRREPZR.EQ.1)THEN
         ...
         IF (ISIDE .EQ. 1) THEN
           CALL GETLST(ICORE(I020),1,1,1,ISPIN,390)
         ELSEIF (ISIDE .EQ.2) THEN
           CALL GETLST(ICORE(I020),1,1,1,ISPIN,392)
         ENDIF 
...
C
       IF(DISCO.AND.IRREPZR.EQ.1)THEN
        ...
        IF (ISIDE .EQ. 1) THEN
           CALL GETLST(ICORE(I020),1,1,1,1,390)
        ELSEIF (ISIDE .EQ.2) THEN
           CALL GETLST(ICORE(I020),1,1,1,1,392)
        ENDIF 
...
C
       IF(DISCO.AND.IRREPZL.EQ.1)THEN
        ...
        IF (ISIDE .EQ. 1) THEN
           CALL GETLST(ICORE(I020),1,1,1,2,390)
        ELSEIF (ISIDE .EQ.2) THEN
           CALL GETLST(ICORE(I020),1,1,1,2,392)
        ENDIF 
