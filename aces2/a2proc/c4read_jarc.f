...
C---------------------------------------------------------------------
C
      SubroutinE C4read_jarc(FlgACESGeom,FlgACESElec,FlgACESGrad,
...
C        -------------------------------------------------------------
         Call Getrec_c4(20,'JOBARC','OCCUPYA0',NIrRep,NOcc(1)) 
         Nalph=0
         If (iUHF .EQ. 0) then
            Do i=1,NIrRep
               Nalph=Nalph+NOcc(i)
         ...
         Else if (iUHF .EQ. 1) then
            Call Getrec_c4(20,'JOBARC','OCCUPYB0',NIrRep,NOcc(9))
            Nbeta=0
            Do i=1,NIrRep
               Nalph=Nalph+NOcc(i)
...
C        Read total energy
C        -------------------------------------------------------------
         CALL Getrec_c4(20,'JOBARC','TOTENERG',IINTFP,Etot)
         If (Wrt_extrnl) Then
...
C
         Call Getrec_c4(20,'JOBARC','GRADIENT',3*Nreal*IINTFP,
     &                  VGrad(1,1))
         Do i=1,Nreal
            k=Imap(i)
            Do j=1,3
...
C
      If (flgACESHess) then
C
         Call Getrec_c4(20,'JOBARC','CART_HES',9*Natom*Natom*IINTFP,
     &                  VHess)
...
C
      If (FlgACESForc) Call Getrec_c4(20, "JOBARC", 'FORCECON', 
