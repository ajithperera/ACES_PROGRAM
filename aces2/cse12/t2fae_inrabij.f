      ...
      Subroutine T2fae_inrabij(T2aa_old,T2bb_old,T2ab_old,T2resid_aa,
...
C AAAA block 
      ...
      Do A = 1, Nvrt_a
         T = 0.0D0 
      Do E = 1, Nvrt_a 
         T = T + Fae_aa(A,E)*T2aa_old(E,B,I,J)
      Enddo 
...
C BBBB block 
      ...
      Do A = 1, Nvrt_b
         T = 0.0D0 
      Do E = 1, Nvrt_b
         T = T + Fae_bb(a,e)*T2bb_old(e,b,i,j)
      Enddo
...
C ABAB block 
      ...
      Do A = 1, Nvrt_a
         T = 0.0D0
      Do E = 1, Nvrt_a
         T = T + Fae_aa(A,E)*T2ab_old(E,b,I,j)
      Enddo
      ...
      Do A = 1, Nvrt_a
         T = 0.0D0
      Do E = 1, Nvrt_b
         T = T + Fae_bb(b,e)*T2ab_old(A,e,I,j)
      Enddo
         T2resid_ab(A,b,I,j) = T2resid_ab(A,b,I,j) + T 
      Enddo
      Enddo
