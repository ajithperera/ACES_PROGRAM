...
C***CATEGORY  D4C4
C***TYPE      DOUBLE PRECISION (BALBAK-S, CBABK2-C)
...
C
C     This subroutine forms the eigenvectors of a REAL*8 GENERAL
...
C          REAL*8 array, dimensioned SCALE(N).
C
...
C          Z is a two-dimensional REAL*8 array, dimensioned Z(NM,M).
C
C     On OUTPUT
C
