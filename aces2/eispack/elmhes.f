...
C***CATEGORY  D4C1B2
C***TYPE      DOUBLE PRECISION (ELMHES-S, COMHES-C)
...
C
C     Given a REAL*8 GENERAL matrix, this subroutine
...
C
C        A contains the input matrix.  A is a two-dimensional REAL*8
