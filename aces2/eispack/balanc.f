...
C***CATEGORY  D4C1A
C***TYPE      DOUBLE PRECISION (BALANC-S, CBAL-C)
...
C
C     This subroutine balances a REAL*8 matrix and isolates
...
C          two-dimensional REAL*8 array, dimensioned A(NM,N).
C
C     On OUTPUT
C
...
C          scaling factors used.  SCALE is a one-dimensional REAL*8 array,
