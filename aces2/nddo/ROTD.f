...
C     FORTRAN VERSION OF DGEMM CHECKS ON SPARSITY OF SECOND MATRIX.
      IF(IROTD.EQ.3) THEN
         CALL XGEMM ('N','N',LIMKL,LIMIJ,LIMKL,ONE,YM,LIMY,W,LIMKL,
     1               ZERO,V,LIMV)
         CALL XGEMM ('N','T',LIMKL,LIMIJ,LIMIJ,ONE,V,LIMV,YM,LIMY,
     1               ZERO,W,LIMKL)
      ENDIF
...
C     FORTRAN VERSION OF DGEMM CHECKS ON SPARSITY OF SECOND MATRIX.
      IF(IROTD.EQ.4) THEN
         CALL XGEMM ('N','T',LIMKL,LIMIJ,LIMIJ,ONE,W,LIMKL,YM,LIMY,
     1               ZERO,V,LIMV)
         CALL XGEMM ('N','N',LIMKL,LIMIJ,LIMKL,ONE,YM,LIMY,V,LIMV,
     1               ZERO,W,LIMKL)
      ENDIF
      RETURN
      END
