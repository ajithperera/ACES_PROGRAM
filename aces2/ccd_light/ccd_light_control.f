      ...
      Subroutine Ccd_light_control(Work,Maxcor,Iuhf)
...
C Cmo_a(mu,p) and Cmo_b(nu,q) MO ints.
     ...
     +     Work(IW__abab),Work(Icmo_a),Work(Icmo_b),
     +     Nocc_a,Nocc_b,Nvrt_a,Nvrt_b,
     +     Nbasis,Naobfns,Work(Iend),Memleft,Frac_occ)
...
C F(m,i), F(a,e), F(m,e)  intermediate 
     ...
     +                                   Maxcor)
      ...
      Call Rccd_light_driver(Work(IW0_aaaa),Work(IW0_bbbb),
     +     Work(IW0_abab),Work(IW1_aaaa),Work(IW1_bbbb),
     +     Work(IW1_abab),Work(IW2_aaaa),Work(IW2_bbbb),
     +     Work(IW2_abab),Work(IW3_aaaa),Work(IW3_bbbb),
     ...
     +     Nocc_a,Nocc_b,Nvrt_a,Nvrt_b,Work(Iend),Memleft)

    
      Else

      Call Ccd_light_driver(Work(IW0_aaaa),Work(IW0_bbbb),
     +     Work(IW0_abab),Work(IW1_aaaa),Work(IW1_bbbb),
     +     Work(IW1_abab),Work(IW2_aaaa),Work(IW2_bbbb),
     +     Work(IW2_abab),Work(IW3_aaaa),Work(IW3_bbbb),
     +     Work(IW3_abab),Work(IW3_baba),Work(IW3_abba),Work(IW3_baab),
