...
c maxbasfn.par : end
     ...
     +                             NOcc_a,Nocc_b,Nvrt_a,Nvrt_b
      ...
      cc_maxcyc  = IFLAGS(7)
      Ring_cc    = IFLAGS(87)  .EQ. 2 
      Icontl     = IFLAGS(8)
      Denom_tol  = 10.D0**(-Icontl) 
      Save_ints  = IFLAGS(26) .GT. 0
     ...
     +                                 Nbasis,Work(Iocn_b))
          ...
          If (Nfrac_a .NE. 0 .OR. Nfrac_b .NE. 0) Then
             Frac_occ = .True.
             Write(6,"(2a)") " Fractional occupation CCD calculation",
...
C canonical occupations. 
             ...
             Frac_occ = .True.
             Write(6,"(3a)") " Fractional occupation CCD calculation",
     ...
     +                        " performed."
          ...
          If (Frac_occ .and. Ring_cc) Then
             Write(6,"(2a)") " Ring-CCD with Fractional occupations is",
     +                      " not supported."
             Write(6,*)
             Call Errex
          Endif 
...
C following logic assuares that.
     ...
     +                      " use SYMMETRY=OFF instead."
          ...
          If (Ring_CC) Then
          Write(6,"(2a)") " Canonical Ring-CCD calculation with the",
     +                    " canonical occupation numbers is"
          Write(6,"(a)")  " performed."
          Else
          Write(6,"(2a)") " Canonical CCD calculation with the",
     +                    " canonical occupation numbers is performed."
      ...
      Write(6,*)
      Write(6,"(2a,ES8.2E2,1x,I2,1x,l)") "@-set_prelims, varibales:",
