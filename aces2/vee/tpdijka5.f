...
1100    CONTINUE
C
CSSS       call checksum('tpdijka5',icore(i000),irpdpd(irrepx,20+ispin),s)
1000   CONTINUE
C
C FORM G*T TERMS
C
...
C
CSSSS          call checksum('tpdijka5',icore(i010),numsyg*dissyg,s) 
...
C
CSSS         call checksum('tpdijka5',icore(i010),numsyg*dissyg,s)
         CALL PUTLST(ICORE(I010),1,NUMSYG,1,IRREP,LISTG)
C
3100    CONTINUE
C
