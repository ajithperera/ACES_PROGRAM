...
C
        ENDIF
CSSS        call checksum('tpdijab1',icore(i0z(ispin)),DISSYR2,s)
C
       LISTT1=38-ISPIN
       LISTT2=33+ISPIN
       IF(IUHF.EQ.0) THEN
...
C
700      CONTINUE
CSSS        call checksum('tpdijab1',icore(i0r2l2),irpdpd(1,20+ispin),s)
C
        ENDIF
C
        LISTL=446
...
1610      CONTINUE
C
CSSSS          call checksum('ltxxxxxx',icore(i010),numsyl*nov,s)
C GET T AMPLITUDES
C
        CALL GETTRN(ICORE(I000),ICORE(ITMP),DISSYT,NUMSYT,1,
     &               IRREPR,LISTT)
...
1600     CONTINUE
C
CSSSS        call checksum('tpdijabn',icore(i0z(ispin)),DISSYR2,s)
C
C SIXTH CONTRIBUTION
C
        CALL ZERO(ICORE(I0R2L2),IINTFP*IRPDPD(1,20+ISPIN))
...
C
1200      CONTINUE
CSSSS        call checksum('tpdijab1',icore(i0r2l2),irpdpd(1,20+ispin),s)
C
        ENDIF
C
        LISTL=446
...
C
     ...
     &             IRREP,ISPIN)
         ENDIF
C
CSSS         call checksum('tpdijab1',icore(i000),numsyg*dissyg,s)
C
