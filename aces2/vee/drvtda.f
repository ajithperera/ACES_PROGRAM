...
C
      ...
      Write(6,"(a)") "  Requested number of roots:"
      Write(6,"(1x,8(1x,I2))") (Nroot(I),I=1,NIRREP)
...
14      CONTINUE
     ...
     &              IMAP(1,IRREP),IRREP, TRIPLET)
        ...
        ELSEIF (BLOCK_DAVID) THEN
        
        I020    = I010 + MAXIT*MAXIT
        I030    = I020 + NUMSOL
        IEND    = I030 + NUMSOL*NUMDIS
        MEMLEFT = MAXCOR - IEND 
        NSIZE   = MATDIM
        Write(6,"(a)") "  Roots are searched using the block Davidson",
     &                 " algorithm"
        CALL BLOCKDAVID_TDA(W(I000),W(IEND),NSIZE,MEMLEFT,IUHF,IROOT,
     &                      MAXIT,NUMSOL,TOL,W(I020),W(I030))
