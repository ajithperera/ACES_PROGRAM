...
C
100     CONTINUE
CSSS        call checksum('tpd3z1',icore(i0z1(ispin)),IRPDPD(1,20+ISPIN),
CSSS     &                 s)
C
...
C
200     CONTINUE
CSSS        call checksum('1tpd3y1 ',icore(i0Y1(ispin)),
CSSS     &           IRPDPD(IRREPX,20+ISPIN),s)
C
...
C
300     CONTINUE
CSSS        call checksum('2tpd3z2',icore(i0z2(ispin)),IRPDPD(1,18+ISPIN),
CSSS     &                 s)
C
C SG 2/96 
...
C
400     CONTINUE
CSSS        call checksum('3tpd3y2 ',icore(i0y2(ispin)),
CSSS     &                IRPDPD(IRREPX,18+ISPIN),s)
C
...
600     CONTINUE
C
CSSS        call checksum('4tpd3z1 ',icore(i0z1(ispin)),IRPDPD(1,20+ISPIN),
CSSS     &                 s)
C
        IF(IUHF.EQ.1) THEN
C
...
C
700      CONTINUE
CSSS        call checksum('5tpd3y1 ',icore(i0y1(ispin)),
CSSS     &                  irpdpd(1,20+ispin),s)
C
        ENDIF
C
        LISTL=446
...
C
800     CONTINUE
CSSS        call checksum('6tpd3y1 ',icore(i0y1(ispin)),
CSSS     &                  irpdpd(irrepx,20+ispin),s)
C
...
1000    CONTINUE
C
CSSS        call checksum('7tpd3z2 ',icore(i0z2(ispin)),
CSSS     &                IRPDPD(1,18+ISPIN),s)
C
        IF(IUHF.EQ.1) THEN
C
         LISTL=443+ISPIN
...
C
1100     CONTINUE
CSSS        call checksum('8tpd3y2 ',icore(i0y2(ispin)),
CSSS     &                  irpdpd(irrepx,18+ispin),s)
C
        ENDIF
C
...
C
1200     CONTINUE
CSSS        call checksum('10tpd3y2 ',icore(i0y2(ispin)),
CSSS     &                  irpdpd(irrepx,18+ispin),s)
C
10000  CONTINUE
C
