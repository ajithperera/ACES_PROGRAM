      ...
      SUBROUTINE SCRNC_LOAD_VEC(IRREPX,SCR,MAXCOR,LIST1,IOFF1,
...
C
      ...
      call checksum("AA  :",SCR(I0C1A),LENC1A)
      IF(IUHF.NE.0)THEN
     ...
     +                    LIST2+2+IOFF2
      call checksum("BB  :",SCR(I0C1B),LENC1B)
      call checksum("AAAA:",SCR(I0C2AA),LENC2AA)
      call checksum("BBBB:",SCR(I0C2BB),LENC2BB)
      ELSE
       I0C2AB=I0C1A+LENC1A
       ITOP  =I0C2AB+LENC2AB
      ENDIF
      ...
      call checksum("ABAB:",SCR(I0C2AB),LENC2AB)
C
      IF (SPINAD) THEN
       IOFF=I0C2AB
       ITMP1=ITOP
