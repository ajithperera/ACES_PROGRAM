...
C  in the file COPYRIGHT.
         SUBROUTINE  OED__DELTA_E0_PCGTO_BA_BLOCK
     +
     +                    ( NBATCH,
     +                      ATOMIC,
...
C
         ...
         DOUBLE PRECISION DEXP, PREFACT, FACT, NORMBB
C
         PARAMETER  (ZERO  = 0.D0)
...
C     
      ...
      Write(6,*)
        ...
        IF (MIN(SHELLA,SHELLB) .GT. 7) THEN
...
C General Cases
     ...
     &                         NIJ, NXYZET
CSSS      Do i=1, NAB
CSSS         Write(6,"(1x,a,i4)") "The prim. pair: ", i
CSSS         write(6,"(6(1x,F20.10))") (BATCH(i,j), j=1, NXYZ)
CSSS      Enddo
      call output(Batch, 1,NPGTOA*NXYZA, 1,NPGTOB*NXYZB, NPGTOA*NXYZA, 
     &           NPGTOB*NXYZB, 1)
         RETURN
         END
