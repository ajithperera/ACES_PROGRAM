...
C  in the file COPYRIGHT.
         SUBROUTINE  OED__NAI_DERV_3CEN_PCGTO_BLOCK_TEST
     +
     +                    ( NBATCH,
...
C
C
CSSSS             PROCEED = (.NOT.ATOMIC) .AND. DIFFB .AND. (DERBX.GT.0)
...
C
C
CSSS             PROCEED = (.NOT.ATOMIC) .AND. DIFFB .AND. (DERBY.GT.0)
...
C
C
CSSS             PROCEED = (.NOT.ATOMIC) .AND. DIFFB .AND. (DERBZ.GT.0)
