...
C  in the file COPYRIGHT.
         SUBROUTINE  OED__PVP_DEF_BLOCKS
     +
     +               ( ZMAX,
     +                 NPGTOA,NPGTOB,
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : OED__PVP_DERV_DEF_BLOCKS
...
C
C
         SIZEPX  = (SHELLP + XCOMP + XCOMP + 1)
         SIZEPY  = (SHELLP + YCOMP + YCOMP + 1)
         SIZEPZ  = (SHELLP + ZCOMP + ZCOMP + 1)
         SHELLX  = 0
         SHELLY  = 0
         SHELLZ  = 0
         ISHELLX = 0
         ...
         SIZEAX  = (SHELLA + XCOMP + 1)
         SIZEAY  = (SHELLA + YCOMP + 1)
         SIZEAZ  = (SHELLA + ZCOMP + 1)
         SIZEBX  = (SHELLB + XCOMP + 1)
         SIZEBY  = (SHELLB + YCOMP + 1)
         SIZEBZ  = (SHELLB + ZCOMP + 1)
