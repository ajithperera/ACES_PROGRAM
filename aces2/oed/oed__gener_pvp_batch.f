...
C  in the file COPYRIGHT.
         SUBROUTINE  OED__GENER_PVP_BATCH
     +
     +                    ( IMAX,ZMAX,
     +                      NALPHA,NCOEFF,NCSUM,
     +                      NCGTO1,NCGTO2,
     ...
     +                      NUCLEI,
     +                      XN,YN,ZN,NCHARGE,
     +                      XCOMP,YCOMP,ZCOMP,             ! Watson Added
     ...
     +
C------------------------------------------------------------------------
C  OPERATION   : OED__GENER_PVP_BATCH
C  MODULE      : ONE ELECTRON INTEGRALS DIRECT
C  MODULE-ID   : OED
C  SUBROUTINES : OED__PVP_CSGTO
...
C
         ...
         INTEGER     XCOMP,YCOMP,ZCOMP                     ! Watson Added
