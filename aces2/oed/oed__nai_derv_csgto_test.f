...
C  in the file COPYRIGHT.
         SUBROUTINE  OED__NAI_DERV_CSGTO_TEST
     +
     +                    ( IMAX,ZMAX,
     +                      NALPHA,NCOEFF,NCSUM,
     +                      NCGTO1,NCGTO2,
...
C
         ...
         CALL  OED__NAI_SET_DERV_AB_TEST
     +
     +              ( NCGTO1,NCGTO2,
     +                NPGTO1,NPGTO2,
     +                SHELL1,SHELL2,
     ...
     +
     +
         WRITE (*,*) ' Finished set derivative ab '
         WRITE (*,*) ' Index A,B = ',INDEXA,INDEXB
         WRITE (*,*) ' Empty = ', Empty
...
C
         IF (CASEIII) THEN
             ...
             DO 3000 NIJBEG = 1,NIJ,NIJBLK
                ...
                CALL  OED__NAI_DERV_3CEN_PCGTO_BLOCK_TEST
     +
     +                     ( NBATCH,
     +                       NINT1DX,NINT1DY,NINT1DZ,
     +                       ATOMIC,
