      ...
      SUBROUTINE INTRN4(EVEC,AOINT,BUF1,RHF,NBASIS,NBAS,
     &                  NMO,NOCC1,NOCC2,NSTART,NEND,
     &                  ISIZE,IOFFN,NSIZE,ISPIN,IREORD)
C
...
C
         ILNBUF=600
         IOFF=1+ILNBUF
         CALL DHF24(AOINT(IOFF3I),BUF1,BUF1(IOFF),ILNBUF,IRREP1,
     &              IRREP2,NSTART1,NEND1,NMO2,NOCC1,NMO,
...
C
          ...
          IOFF=1+ILNBUF
          CALL DHF24(AOINT(IOFF3I),BUF1,BUF1(IOFF),ILNBUF,IRREP1,
     &               IRREP2,NSTART1,NEND1,NMO2,NOCC2,NMO,
