      SUBROUTINE DHF23F(AOINT,BUF,IBUF,ILNBUF,IRREP1,IRREP2,
     &                  NMO1,NMO2,NSTART1,NEND1,IOFF1,IOFF2,
     &                  IREORD,RHF,ISPIN)
C
CEND
C
...
C
         DO 300 L=1,NMO2
C
          LXX=IREORD(L+IOFF1(IRREP2))
C
          DO 400 K=1,NMO1
C
           KXX=IREORD(K+IOFF1(IRREP1))
C
           IF(KXX.GT.LXX) THEN
            KX=KXX
            LX=LXX
...
C
         DO 1300 L=1,NMO2
C
          LXX=IREORD(L+IOFF2(IRREP2))
C
          DO 1400 K=1,NMO1
C
           KXX=IREORD(K+IOFF2(IRREP1))
C
           IF(KXX.GT.LXX) THEN
            KX=KXX
            LX=LXX
