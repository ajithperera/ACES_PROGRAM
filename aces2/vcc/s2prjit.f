      SUBROUTINE S2PRJIT(ICORE,MAXCOR,IUHF,SINGLE,IORDER)
C
...
10    CONTINUE
      ...
      IF(SINGLE)THEN
        IF(IORDER.EQ.3) THEN
          ...
          CALL GETLST(ICORE(I060),1,1,1,3,90)
          CALL GETLST(ICORE(I070),1,1,1,4,90)
          CALL SAXPY(NT(1),ONE,ICORE(I060),1,ICORE(I040),1)
          CALL SAXPY(NT(2),ONE,ICORE(I070),1,ICORE(I050),1)
        ELSEIF(IORDER.GE.4) THEN
          I050=I040+IINTFP*NT(1)
          I060=I050+IINTFP*NT(2)
          I070=I060+IINTFP*NT(1)
          I080=I070+IINTFP*NT(2)
          CALL GETLST(ICORE(I040),1,1,1,1,90)
          CALL GETLST(ICORE(I050),1,1,1,2,90)
          CALL GETLST(ICORE(I060),1,1,1,9,90)
          CALL GETLST(ICORE(I070),1,1,1,10,90)
          CALL SAXPY(NT(1),ONE,ICORE(I060),1,ICORE(I040),1)
          CALL SAXPY(NT(2),ONE,ICORE(I070),1,ICORE(I050),1)
          CALL GETLST(ICORE(I060),1,1,1,3,90)
          CALL GETLST(ICORE(I070),1,1,1,4,90)
      ...
      ENDIF
C
C DO T2 CONTRIBUTION TO S**2
C
      IF(IORDER.EQ.3) THEN
        NSIZE=ISYMSZ(ISYTYP(1,46),ISYTYP(2,46))
        imode=0
        CALL INIPCK(1,ISYTYP(1,46),ISYTYP(2,46),98,imode,0,1)
        I070=I060+NSIZE*IINTFP
        I080=I070+NSIZE*IINTFP
        CALL GETALL(ICORE(I060),NSIZE,1,46)
        CALL GETALL(ICORE(I070),NSIZE,1,63)
        CALL SAXPY(NSIZE,ONE,ICORE(I070),1,ICORE(I060),1)
        CALL PUTALL(ICORE(I060),NSIZE,1,98)
        LISTT=98
      ELSEIF(IORDER.GE.4) THEN
        NSIZE=ISYMSZ(ISYTYP(1,46),ISYTYP(2,46))
        I070=I060+NSIZE*IINTFP
        I080=I070+NSIZE*IINTFP
        CALL GETALL(ICORE(I060),NSIZE,1,46)
        CALL GETALL(ICORE(I070),NSIZE,1,96)
        CALL SAXPY(NSIZE,ONE,ICORE(I070),1,ICORE(I060),1)
        CALL GETALL(ICORE(I070),NSIZE,1,63)
        CALL SAXPY(NSIZE,ONE,ICORE(I070),1,ICORE(I060),1)
        CALL PUTALL(ICORE(I060),NSIZE,1,98)
