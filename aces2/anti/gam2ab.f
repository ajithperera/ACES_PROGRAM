      SUBROUTINE GAM2AB(GAMMA,BUF,BUF1,BUF2,SCR1,SCR2,
...
C
      ...
      IF(TDA)THEN
       CALL G2AB4(GAMMA,BUF,GOFF,LENGAM,FAIBJ)
      ELSE
       CALL G2AB3(GAMMA,BUF,GOFF,LENGAM,FABIJ)
       IF(MBPT2)GOTO 2000
       CALL G2AB1(GAMMA,BUF,GOFF,LENGAM,FIJKL)
       CALL G2AB6(GAMMA,BUF,BUF1,BUF2,SCR1,SCR2,GOFF,LENGAM,FABCD,
     &            IUHF)
       CALL G2AB4(GAMMA,BUF,GOFF,LENGAM,FAIBJ)
       IF(CCD.OR.(MBPT3.AND.(.NOT.ROHF)))GOTO 2000
       CALL G2AB2(GAMMA,BUF,GOFF,LENGAM,FIJKA)
       CALL G2AB5(GAMMA,BUF,GOFF,LENGAM,FABCI)
2000   CONTINUE
      ENDIF
      LIST1=2
      LIST2=1
...
C EVENTUALLY OVERWRITE LIST (2,1), WHICH HAS THE PHYSICAL DIMENSIONS
