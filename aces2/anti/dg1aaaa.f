...
C DRIVER FOR SORTING MO GAMMA ELEMENTS (SPIN CASE AAAA)

      SUBROUTINE DG1AAAA(ICORE,BUF1,BUF2,MEMSZ,NUMAO,
     &                   LIST1,LIST2,ISPIN,IRREPDO)
...
C  READ INTO CORE.
C
C SRG/JDW. 12/14/95. Change dimension of BUF (ILNBUF) to avoid possible 
C overwrite in SG1AAAA.
C
      MXLNT1=0
      DO  5 IRREP=1,NIRREP
...
4000   FORMAT(T3,'@DG1AAAA-F, Not enough core to hold one integral ',
     &        'distribution.',/,
...
C
      ...
      I030=ILNBUF*IINTFP+I020
      I040=NBKINT*NBUCK+I030
      I050=NBUCK+I040
      I060=NBUCK+I050
      WRITE(6,*)' I060 Is ',I060,'  MEMSIZ IS ',MEMSIZ
      IF(I050.GT.MEMSIZ)THEN
       WRITE(6,5000)
5000   FORMAT(T3,'@DG1AAAA-F, Core screwup.')
       CALL ERREX
      ENDIF
      WRITE(6,1000)MEMSZ,MEMSIZ,DISSIZ*LENINT,NUMDIS,NINCOR,NBUCK,
     &        NDBCK,NBKINT,IRECL,I050
1000   FORMAT(T3,'@DG1AAAA-I, Information for gamma sort',/,
     ...
     &   '        Total utilized memory (words)          ',I10,'.')
      CALL SG1AAAA(ICORE(I000),ICORE(I010),ICORE(I020),ICORE(I030),
     &             ICORE(I040),ICORE(I050),NBUCK,NDBCK,
     &             NBKINT,NREC,IRECL,ILNBUF,BUF1,BUF2,ISPIN,IRREPDO)
C
...
200   FORMAT(T3,'@DG1AAAA-I, Sort chain processing uses ',I10,
     &          ' out of ',I10,' words.')
      IF(I040.GT.MEMSIZ)THEN
       WRITE(6,300)I040,MEMSIZ
       CALL ERREX
300    FORMAT(T3,'@DG1AAAA-F, Core screwup. ',I10,' words needed.',
     &           I10,' words available.')
      ENDIF
      CALL CG1AAAA(ICORE(I010),ICORE(I020),ICORE(I030),ICORE(I000),
