...
C
C
         CASE2D = 3 * MIN0 (2,SHELLQ+1) + MIN0 (2,SHELLP) + 1
C
C
...
C
     ...
     +
C
         Write(*,*) "END ERD__RYS_ROOTS_WEIGHTS"
C
...
CSSS         ATOMIC = .FALSE.
         IF (.NOT.ATOMIC) THEN
             write(*,*) "Enter  ERD__2D_DSHIELD_PQ_INTEGRALS"
             write(*,*) "CASE2D", CASE2D
     ...
     +
             Write(*,*) "EP0-1 batches"
             Write(*,"(3(1x,F15.10))") (BATCH (I), I=1, NBATCH)
     ...
     +
         ...
         ELSE
             write(*,*) "Enter  ERD__2D_ATOM_DSHIELD_PQ_INTEGRALS"
     ...
     +
     +
C          write(*,*) " End ERD__2D_ATOM_DSHIELD_PQ_INTEGRALS"
C          WRITE(*,*) SHELLP, SHELLQ
             IF (SHELLQ.EQ.0) THEN

                 write(*,*) "Enter  ERD__ATOM_INT2D_TO_E000"
