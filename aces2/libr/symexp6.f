      ...
      SUBROUTINE SYMEXP6(IRREP,NUM1,NUM2,DSZ1,DSZ,DIS,A1,A,B)
C
C     THIS ROUTINE EXPANDS THE A COMPRESSED ARRAY A(A<=B,I<=J) WITH
C     A LE B  TO AN ARRAY A(AB,I<=J). NOTE THAT THIS ROUTINE
C     EXPECTS THAT THE ARRAY A IS SYMMETRY PACKED
C
C  USAGE :
C          IRREP ....... IRREDUCIBLE REPRESENTATION OF THE BLOCKS
C          NUM1 ......... POPULATION IN EACH IRREP FOR THE ORBITALS 
C                         FOR THE KET SIDE
C          NUM2 ......... POPULATION IN EACH IRREP FOR THE ORBITALS
C                         FoR THE BRA SIDE
...
C          B ........... SCRATCH ARRAY
C
C WARNING: THIS ROUTINE ASSUMES THAT A IS SYMMETRIC 
...
C 
      DATA ZERO /0.0D0/
C
      CALL DZERO(A1,DSZ1*DIS)
      CALL DCOPY(DSZ*DIS,A,1,B,1)
