      SUBROUTINE PDCC_T1RB01(ICORE,MAXCOR,IUHF,LAMBDA)
C
...
CSSS          CALL TRACEOO('VOVO',IRREPDO,POP(1,2),VRT(1,1),
CSSS     &                  DISTAR,ABFULL,ICORE(I000),ICORE(I010))
CSSS         ELSE
CSSS          CALL TRACEOO('OVVO',IRREPDO,POP(1,1),VRT(1,2),
CSSS     &                  DISTAR,ABFULL,ICORE(I000),ICORE(I010))
CSSS         ENDIF
CSSS         CALL SUMSYM3(ICORE(I010),ICORE(I020),ABFULL,1,ISPIN,LSTFEA)
CSSS        ENDIF
C
