...
C
        ...
        DO 9007 I=NSTARTX,NENDX
         W2(I)=CMO(IOFFC+IX+(I-1)*NBASXJ)*X2
9007    CONTINUE
C
C INCREMENT L(JX,LX,KX;I)
C
        DO 9008 I=NSTARTX,NENDX
         IADR=IOFFW1+JX+NBASXI*(IND1-1)+ISIZEX*(I-NSTARTX)
         W(IADR)=W(IADR)+W2(I)
9008    CONTINUE
10    CONTINUE
      NAOINT=NAOINT+NUT
...
C
      RETURN
900   WRITE(6,1000)
1000  FORMAT(T3,'@LOADA5-F, Unexpected end-of-file on integral file.')
      CALL ERREX
      RETURN
901   WRITE(6,1000)
1001  FORMAT(T3,'@LOADA5-F, I/O error on unit ',I5,'.')
      CALL ERREX
      RETURN
      END
