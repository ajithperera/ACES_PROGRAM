...
C
      WRITE(6,3000)
3000  FORMAT(' @-LINEQ2-I, CPHF did not converge after ',I4,
     &       ' cycles,',' abort !')
      WRITE(6,3001)TEST
3001  FORMAT(' @-LINEQ2-I The convergence is : ',E20.10) 
      CALL ERREX
C
...
C
      WRITE(6,3002) K 
3002  FORMAT(' @-LINEQ2-I, CPHF converged after ',I3,' iterations.')
C
...
C
      DO 340 I=1,K1
       CALL SAXPY(NA,ASQUARE(I,IPERT),UPDATA(1,IPERT,I),1,
     &            BIAA(1,IPERT),1)
       CALL SAXPY(NB,ASQUARE(I,IPERT),UPDATB(1,IPERT,I),1,
     &            BIAB(1,IPERT),1)
340   CONTINUE
40    CONTINUE
C
