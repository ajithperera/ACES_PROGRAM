      SUBROUTINE MKARHF2(IRREP,AMAT,SCRATCH)
C
...
CEND
C
C   CODED JULY/90   JG, MODIFIED SEPTEMBER/91 JG 
C
...
C
      DATA ONE,ONEM,TWO,FOUR/1.0D+0,-1.0D+0,2.0D+0,4.D0/
C
...
C
      CALL GETLST(SCRATCH,1,NUMSYW,2,IRREP,LISTW)
C
      CALL SAXPY(NUMSYW*DISSYW,FOUR,SCRATCH,1,AMAT,1)    
C
C  ALL DONE
C
      RETURN
