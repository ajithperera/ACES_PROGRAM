      SUBROUTINE GT1RA02(ICORE,MAXCOR,IUHF,LAMBDA,LISTZOFF,
     &                   TERM1,TERM2,DOFEA)
C
...
CEND
      ...
      LOGICAL LAMBDA,TERM1,TERM2,DOFEA
...
C          B,M-J,E
C
        DISW  =IRPDPD(IRREPDO,ISYTYP(2,6+ISPIN))
        DSZW  =IRPDPD(IRREPDO,ISYTYP(1,6+ISPIN))
