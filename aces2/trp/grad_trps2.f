      ...
      SUBROUTINE GRAD_TRPS2(T1A,T1B,FOVA,FOVB,D1T1A,D1T1B,S1A,S1B,
...
C
     ...
     1 T2AAAJ,T2AAAI)
       ...
       DIJK = EVAL(ABSOCC(I,IRPI,1),1) + EVAL(ABSOCC(J,IRPJ,1),1)
     1      + EVAL(ABSOCC(K,IRPK,2),2)
CSSS       CALL RMD314(ICORE(I000),ICORE(I060),LENABC,DIJK)
...
CSSS     &             "grad_trps2.F")
       CALL DCOPY(LENABC, ICORE(ISTART), 1, ICORE(I000), 1)
      ENDIF 
...
CSSS Is this a duplicate
     ...
     &                   LENABC,DIJK,E4TAAA, "grad_trps2.F")
