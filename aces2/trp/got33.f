      SUBROUTINE GOT33(GOOOV,LNOOOV,OOOVAD,T3,W,CORE,
     1                 IADT3,IADW,
...
C
     ...
     1            JL,1,1,IRPJL,43+ISPIN1+LISTOFF)
  140 CONTINUE
      ENDIF
C
     ...
     1            JL,POP(IRPL,ISPIN1),1,IRPJL,43+ISPIN1+LISTOFF)
...
C
     ...
     1            IL,1,1,IRPIL,43+ISPIN1+LISTOFF)
  240 CONTINUE
      ENDIF
C
      ...
      CALL GETLST(CORE(IADT2(IRPL)),
     1            IL,POP(IRPL,ISPIN1),1,IRPIL,43+ISPIN1+LISTOFF)
      CALL VMINUS(CORE(IADT2(IRPL)),LENT2(IRPL))
      ENDIF
C
...
C
      ...
      CALL GETLST(CORE(IADT2(IRPL)),
     1            JL,POP(IRPL,ISPIN2),1,IRPJL,46+LISTOFF)
C
C     WE NOW HAVE T2 IN THE FORM T2(BC,L) AND T3 IN THE FORM
...
C
      ...
      CALL GETLST(CORE(IADT2(IRPL)),
     1            IL,POP(IRPL,ISPIN2),1,IRPIL,46+LISTOFF)
C
C     WE NOW HAVE T2 IN THE FORM T2(BC,L) AND T3 IN THE FORM
C     W(BC,A). CONTRACT TOGETHER TO FORM G(L,A), WHICH CAN
