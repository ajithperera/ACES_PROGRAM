...
c      write(6,*)'nfil,irec,na:',nfil,irec,na
      ...
      do 1 i=1,nirrep
         do 2 j=1,vrt(i,1)
            kk=kk+1
c            isym(kk,1)=i      !isym(kk,1) wskazuje irrep dla orbitalu kk
c            isym(kk,2)=j      !isym(kk,2) wskazuje nr orb. wramach irr dla kk
 2       continue
 1    continue
      ir1=0
      ir2=0
...
c         stop
 ...
 1    continue
      ...
      do 3 b=1,nu
         ...
         disnum=idn(ira,irb)+(ika-1)*vrt(irb,1)+ikb  !dstb. nr in irrep
         isymcd=0
         do 4 c=1,nu
            irc=isym(c,1)
            ikc=isym(c,2)
 ...
 235     format(2f15.10)
      ...
      dimension a(1)
      ioff=1
c      write(6,*)'zapis-irec,na,nrec:',irec,na,nrec
      do 10 i=1,nrec
         iirec=irec+i-1
