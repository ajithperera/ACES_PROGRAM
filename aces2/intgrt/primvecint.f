...
c Global data
      zxocc=setptr(1,1,2*nbastot)
      do i=1,2
        zpcoeff(i)=setptr(1,1,nbastot*totprim)
      end do
...
c Local data
      ...
      zcoeff =setptr(1,1,    nbastot*naobasfn)
      zscr   =setptr(1,1,    nbastot*naobasfn)
      zscr2  =setptr(1,1,    nbastot*naobasfn)
      zscr3  =setptr(1,1,    nbastot)
      zscr4  =setptr(1,1,    nbastot)
      zcmp2c1=setptr(1,1,    nbastot*naobasfn)
      pordr  =setptr(1,0, naobasfn)
...
c This is setting of ehar to echar is not relavent since 
c ehar get set to the correct value in numintint. 
          ehar=echar
...
c Always Skip this integration for correlated calculations. This
c not setup correctly. Ajith Perera, 05/2017. This is fixed 
c to revisit CC based HF-DFT like calculations. 
c 06/2018, Ajith Perera

CSSS      if (idns.eq.1.and.iflags(18).gt.0) goto 999

      do i=1,iuhf+1
        Call gtao(i,dcore(zscr),dcore(zscr2),
