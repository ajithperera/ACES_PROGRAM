      ...
      SUBROUTINE TRPS_VCC5T(ICORE,MAXCOR,IUHF,E4T,S1A,S1B)
...
C
      ...
      CALL AT2IAB_VCC5T(ICORE(1),0,.FALSE.)
...
c     CALL TSPABCI(ICORE(1),MAXCOR,2)
      CALL AT2IAB_VCC5T(ICORE(1),1,.FALSE.)
