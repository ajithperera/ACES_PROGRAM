...
C
      ...
      CALL SYMCONTW_VCC5T(CORE(I000),CORE(I010),EVAL,IADBLK,ISPIN,NO,NV,
     1              IRPIJK)
       IF(ISPIN.EQ.1)THEN
...
C
     ...
     1             I,J,K,IRPI,IRPJ,IRPK,IRPIJ,IRPIK,IRPJK,IRPIJK,3)
      CALL SYMCONTW_VCC5T(CORE(I130),CORE(I140),EVAL,IADBLK,ISPIN,NO,NV,
     1              IRPIJK)
       IF(ISPIN.EQ.1)THEN
...
C
     ...
     1             I,J,K,IRPI,IRPJ,IRPK,IRPIJ,IRPIK,IRPJK,IRPIJK,1)
      CALL SYMCONTW_VCC5T(CORE(I120),CORE(I010),EVAL,IADBLK,ISPIN,NO,NV,
     1              IRPIJK)
