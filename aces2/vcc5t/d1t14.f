...
C
      IF(IRPJK.EQ.1)THEN
C     JK = IOFFOO(IRPK,IRPJK,ISPIN) + INDEX(K-1) + J
      JK =                            INDEX(K-1) + J
      ELSE
C     JK = IOFFOO(IRPK,IRPJK,ISPIN) + (K-1)*POP(IRPJ,ISPIN) + J
      JK =                            (K-1)*POP(IRPJ,ISPIN) + J
      ENDIF
C
