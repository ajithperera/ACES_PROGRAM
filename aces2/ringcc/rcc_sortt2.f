      ...
      SUBROUTINE RCC_SORTT2(ICORE,MAXCOR,ISPIN,ILIST,NTOP,TYPE)
C
...
CEND
      ...
      IF(ISPIN.EQ.1)THEN
       NT2SIZ=ISYMSZ(19,21)
       NSMSZ1=NNP1O2(NVRTO(ISPIN))
       NSMSZ2=NNP1O2(NOCCO(ISPIN))
       LABEL1='SVAVA1  '
       LABEL2='SOAOA1  '
...
C
      ...
      CALL RCC_TOPT2S(ISPIN,ILIST,NTOP,NT2SIZ,NOCCA,NOCCB,NVRTA,
