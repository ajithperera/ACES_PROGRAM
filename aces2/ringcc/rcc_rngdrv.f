      ...
      SUBROUTINE RCC_RNGDRV(ICORE,MAXCOR,LISTW,LISTT,CALMOD,MAXSIZ,
     &                      INCREM,LSTSCR)
...
C
C Set the spinad to false for both rCCD and drCCD.
...
C
         CALL RCC_RNGPRD(ICORE(I020),ICORE(I010),ICORE(I000),
