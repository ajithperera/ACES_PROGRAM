      SUBROUTINE GETGO4R(G,GTMP,I1,NBL0,I2,IRREP,LISTG,ISPIN,listw,leng)
...
C
 ...
 111  format (3x,'start of getgo4r with listg=',i5,5x,'listw=',i5)
...
C-----------------------
 ...
 950   format (4x,'Some error (getgo4r) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
