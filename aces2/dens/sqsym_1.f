      SUBROUTINE SQSYM_1(IRREP,NUM,DSZA,DSZB,NUMSIZ,A,B)
C
...
C
CSSS       Write(6,*) ,DSZA,DSZB,NUMSIZ
CSSS       call output(B,1,25,1,4,25,1,4,1)
...
2       CONTINUE
1      CONTINUE
CSSS       call output(A,1,15,1,4,15,4,1)
CSSS       call output(A,1,10,1,4,10,4,1)
      ELSE
C
C     IRREP NE 1
C
