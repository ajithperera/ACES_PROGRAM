      SUBROUTINE SQSYM_2(IRREP,NUM,DSZA,DSZB,NUMSIZ,A,B)
C
...
C
CSSS       call output(B,1,4,1,15,4,15,1)
CSSS       call output(B,1,4,1,10,4,10,1)
...
C
        ...
        DO 2 I=1,J-1
         ...
         DO 3 L=1,NUMSIZ
          A(IND,L)=B(IND1,L)
          write(6,"(3i3,2F10.5)") ind, ind1, l, A(IND,L), B(IND1,L)
3        CONTINUE
2       CONTINUE
1      CONTINUE
CSSS       call output(A,1,3,1,15,3,15,1)
CSSS       call output(A,1,1,1,10,1,10,1)
      ELSE
C
C     IRREP NE 1
C
