      SUBROUTINE GETGO3 (G,GTMP,I1,NBL0,I2,IRREP,LISTG,ISPIN,listw,Leng)
...
C
 ...
 111  format (3x,'start of getgo3 with listg=',i5,5x,'listw=',i5)
...
C-----------------------
 ...
 950   format (4x,'Some error (getgo3) ; ininew=',i3,5x,'iniold=',i3)
       call errex 
      END
