       SUBROUTINE INTO6(AIOO,ICORE,MAXCOR,IUHF)     
C
C
C THIS ROUTINE CALCULATES THE SIXTH TERM OF THE OCCUPIED-OCCUPIED BLOCK
C OF THE INTERMEDIATE I
C
C THE GENERAL FORMULA IS
C
C 1. TERM :  - 1/2 SUM M,N SUM E <MN//IE> G(MN,JE)
C
...
C
     ...
     &DIRPRD(8,8)
      ...
      COMMON/SYMPOP/IRP_DM(8,22),ISYTYP(2,500),INTO(18) 
      COMMON /SHIFT/ ISHIFT
C
...
C         IN CORE VERSION
C
          CALL IO6AB(ICORE(I001),ICORE(I002),AIOO(IOFF),
