...
C Just for safety, I am zeroing out future  spaces for DOO,DVV and DVO.
C I became aware of the possibility that something can go wrong on 2022 ???
C Ajith Perera.

      CALL DZERO(FOO,NTOCC)
      CALL DZERO(FVV,NTVRT)
      CALL DZERO(FVO,NTOCCVRT)
C
