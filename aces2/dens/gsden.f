...
CEND
      ...
      logical bRedundant
      character*4 spincase1, spincase2
...
C
      DO 11 ISPIN=1,1+IUHF
       ...
       IF(IUHF.EQ.0)THEN
        ...
        ELSE
           CALL GETLST(ICORE(I000),1,NUMDST,1,1,237)
           CALL GETLST(ICORE(I010),1,NUMDST,1,1,239)
c           CALL GETLST_NR(ICORE(I000),ICORE(I020),MAXCOR-I020+1,37,1)
c           CALL GETLST_NR(ICORE(I010),ICORE(I020),MAXCOR-I020+1,39,1)
        ENDIF
     ...
     &              DISSYT)
       ELSE
        ...
        ELSE
           CALL GETLST(ICORE(I000),1,NUMDST,1,1,LISTAA+200)
c           CALL GETLST_NR(ICORE(I000),ICORE(I010),MAXCOR-I010+1,LISTAA,1)
        ENDIF
     ...
     &             DISSYT)
        ...
        ELSE
           CALL GETLST(ICORE(I000),1,NUMDST,1,1,LISTAB+200)
c          CALL GETLST_NR(ICORE(I000),ICORE(I010),MAXCOR-I010+1,LISTAB,1)
        ENDIF
