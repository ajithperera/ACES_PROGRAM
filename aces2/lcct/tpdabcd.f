      SUBROUTINE TPDABCD(ICORE,MAXCOR,IUHF,LISTL2,LISTR1,LISTR1OFF,
     &   LISTR2)
...
c        call checksum('listl   ',icore(i010),dissyl*numdsl)
C
...
c        call checksum('tpdabcd ',icore(i020),dissyg*numdsg)
