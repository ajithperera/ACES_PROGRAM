     ...
     &                    POP1,POP2,VRT1,
     &                    VRT2,FACT,SPCASE,IUHF,LISTR2RS)
C
...
C
       DO 100 IRREPR=1,NIRREP
        ...
        LISTR2=LISTR
        IF(IUHF.EQ.0.AND.LISTR.EQ.LISTR2RS) LISTR2=LISTR2RS+5
...
C
         IF(IUHF.EQ.0.AND.LISTR.EQ.LISTR2RS) THEN
          CALL GETLST(ICORE(I010),1,NUMSYT,1,IRREPL,LISTR2RS+5)
          CALL GETLST(ICORE(I020),1,NUMSYT,1,IRREPL,LISTR2RS+3)
