      SUBROUTINE R2L2RNGD(ICORE,MAXCOR,IUHF,R0,SORT,LISTL2RS,LISTR2RS)
C
...
C
      CALL R2L2RNG(ICORE,MAXCOR,'ABBA',IUHF,IRREPX,R0,LISTL2RS,LISTR2RS)
      CALL R2L2RNG(ICORE,MAXCOR,'ABAB',IUHF,IRREPX,R0,LISTL2RS,LISTR2RS)
      IF(IUHF.EQ.1) THEN
       CALL R2L2RNG(ICORE,MAXCOR,'AAAA',IUHF,IRREPX,R0,LISTL2RS,
     &      LISTR2RS)
      ELSE
       CALL QUIKAA3(ICORE,MAXCOR ,1,54)
      ENDIF
      IF(IUHF.NE.0) THEN
       CALL R2L2RNG(ICORE,MAXCOR,'BBBB',IUHF,IRREPX,R0,LISTL2RS,
     &      LISTR2RS)
       CALL R2L2RNG(ICORE,MAXCOR,'BABA',IUHF,IRREPX,R0,LISTL2RS,
     &    LISTR2RS)
C
