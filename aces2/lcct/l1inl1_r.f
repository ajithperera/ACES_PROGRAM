...
C
      SUBROUTINE L1INL1_R(ICORE,MAXCOR,IUHF,ISPIN,IOFFLIST,LISTL1,
     &                    LISTL1OFF)
     ...
     &                DIRPRD(8,8)
      ...
      MAXSIZ=0
      LISTT=LISTL1
      LISTW1=53+ISPIN+IOFFLIST
      LISTW2=55+ISPIN+IOFFLIST
C
...
C
      ...
      CALL GETLST(ICORE(I010),1,1,1,ISPIN+LISTL1OFF,LISTT)

      IF(IUHF.NE.0)
     &           CALL GETLST(ICORE(I020),1,1,1,3-ISPIN+LISTL1OFF,LISTT)
