      SUBROUTINE R2L2RNG(ICORE,MAXCOR,SPCASE,IUHF,IRREPX,R0,LISTL2RS,
     &   LISTR2RS)
C
...
C
      IF(SPCASE.EQ.'AAAA'.OR.SPCASE.EQ.'BBBB')THEN
       ...
       LISTG =53+ISPIN
c       LIST1A=433+ISPIN
       LIST1A=LISTL2RS-1+ISPIN
C       LIST2A=453+ISPIN
       LIST2A=LISTR2RS-1+ISPIN
c       LIST1B=438-ISPIN
       LIST1B=LISTL2RS+4-ISPIN
c       LIST2B=458-ISPIN
       LIST2B=LISTR2RS+4-ISPIN
       LIST2AA=33+ISPIN
       LIST2BB=38-ISPIN
       FACT=ONEM
