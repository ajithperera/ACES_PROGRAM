      SUBROUTINE T2L2RNGD2(ICORE,MAXCOR,IUHF,R0,LISTL2RS)
C
...
C
      CALL T2L2RNG(ICORE,MAXCOR,'ABBA',IUHF,IRREPX,R0,LISTL2RS)
      CALL T2L2RNG(ICORE,MAXCOR,'ABAB',IUHF,IRREPX,R0,LISTL2RS)
      IF(IUHF.EQ.1) THEN
       CALL T2L2RNG(ICORE,MAXCOR,'AAAA',IUHF,IRREPX,R0,LISTL2RS)
      ELSE
       CALL QUIKAA3(ICORE,MAXCOR,IRREPX,414)
      ENDIF
      IF(IUHF.NE.0) THEN
       CALL T2L2RNG(ICORE,MAXCOR,'BBBB',IUHF,IRREPX,R0,LISTL2RS)
       CALL T2L2RNG(ICORE,MAXCOR,'BABA',IUHF,IRREPX,R0,LISTL2RS)
C
