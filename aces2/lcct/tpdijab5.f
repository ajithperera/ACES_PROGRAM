      SUBROUTINE TPDIJAB5(ICORE,MAXCOR,IUHF,LISTR1,LISTR1OFF,LISTR2RS)
...
C
      DO 200 ISPIN=3-2*IUHF,3
       CALL H4R2ALL(ICORE,MAXCOR,ISTART,I0T,I0R,ISPIN,IUHF,LISTR2RS)
200   CONTINUE
C
