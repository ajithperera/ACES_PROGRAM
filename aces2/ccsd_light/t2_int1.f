      ...
      Subroutine T2_int1(T2aa,T2bb,T2ab,W4_aa,W4_bb,W4_ab,W4_ba,
...
C T1resid(A,I)= +1/2T2(E,F,I,M)*W(E,F,A,M)
      ...
      Do e = 1, Nvrt_a
      Do f = 1, Nvrt_a
CSSS         C = (1.0D0-Ocn_va(F))*Ocn_oa(m)*(1.0D0-Ocn_va(E))
         C = (1.0D0-Ocn_va(A))
...
C T1resid(A,I)= +1/2T2(E,f,I,m)*W(E,f,A,m)
      ...
      Do e = 1, Nvrt_a
      Do f = 1, Nvrt_b
CSSS         C = (1.0D0-Ocn_vb(f))*Ocn_ob(m)*(1.0D0-Ocn_va(E))
         C = (1.0D0-Ocn_va(A))
...
C T1resid(A,I)=+1/2T2(A,E,M,N)*W(N,M,I,E)
      ...
      Do n = 1, Nocc_a
      Do e = 1, Nvrt_a 
CSSS         C = (1.0D0-Ocn_va(E))*Ocn_oa(N)*Ocn_oa(M)
         C = Ocn_oa(I)
...
C T1resid(A,I)=-1/2T2(A,e,N,m)*W(N,m,I,e)
      ...
      Do n = 1, Nocc_a
      Do e = 1, Nvrt_b
CSSS         C = (1.0D0-Ocn_vb(e))*Ocn_oa(N)*Ocn_ob(m)
         C = Ocn_oa(I)
...
C T1resid(a,i)= +1/2T2(e,f,i,m)*W(e,f,a,m)
      ...
      Do e = 1, Nvrt_b
      Do f = 1, Nvrt_b
CSSS         C = (1.0D0-Ocn_vb(f))*Ocn_ob(m)*(1.0D0-Ocn_vb(e))
         C = (1.0D0-Ocn_vb(a))
...
C T1resid(a,i)= +1/2T2(e,F,i,M)*W(e,F,a,M)
      ...
      Do e = 1, Nvrt_b
      Do f = 1, Nvrt_a
CSSS         C = (1.0D0-Ocn_va(F))*Ocn_oa(M)*(1.0D0-Ocn_vb(e))
         C = (1.0D0-Ocn_vb(a))
...
C T1resid(a,i)=+1/2T2(a,e,m,n)*W(n,m,i,e)
      ...
      Do n = 1, Nocc_b
      Do e = 1, Nvrt_b
CSSS         C = (1.0D0-Ocn_vb(e))*Ocn_ob(n)*Ocn_ob(m)
         C = Ocn_ob(i)
...
C T1resid(a,i)=-1/2T2(E,a,M,n)*W(M,n,E,i)
      ...
      Do n = 1, Nocc_b
      Do e = 1, Nvrt_a
CSSS         C = (1.0D0-Ocn_va(E))*Ocn_ob(n)*Ocn_oa(M)
         C = Ocn_ob(i)
