      ...
      Subroutine Ccsd_light_control(Work,Maxcor,Iuhf)
...
c maxbasfn.par : end
     ...
     +                          Nvrt_b,Length) 
      ...
      Ndim_vo_aa = Nvrt_a * Nocc_a
      Ndim_vo_bb = Nvrt_b * Nocc_b
      Ndim_vo_ab = Nvrt_a * Nocc_b
      Ndim_vo_ba = Nvrt_b * Nocc_a
...
C W(mb,ej) intermediate 
      ...
      Iabci_aaaa = Imbej_baab + Ndim_oo_bb*Ndim_vv_aa

C W(ab,ci) intermediate (the following intermediate are needed
C for NR algorithm

      Iabci_bbbb = Iabci_aaaa + Ndim_vv_aa*Ndim_vo_aa
      Iabci_abab = Iabci_bbbb + Ndim_vv_bb*Ndim_vo_bb
      Iabci_baba = Iabci_abab + Ndim_vv_ab*Ndim_vo_ab
      Iaibc_aaaa = Iabci_baba + Ndim_vv_ab*Ndim_vo_ba

C W(ai,bc) intermediate 

      Iaibc_bbbb = Iaibc_aaaa + Ndim_vo_aa*Ndim_vv_aa
      Iaibc_abab = Iaibc_bbbb + Ndim_vo_bb*Ndim_vv_bb
      Iaibc_baba = Iaibc_abab + Ndim_vo_ab*Ndim_vv_ab
      Iijka_aaaa = Iaibc_baba + Ndim_vo_ba*Ndim_vv_ab

C W(ij,ka) intermediate 

      Iijka_bbbb = Iijka_aaaa + Ndim_oo_aa*Ndim_ov_aa
      Iijka_abab = Iijka_bbbb + Ndim_oo_bb*Ndim_ov_bb
      Iijka_baba = Iijka_abab + Ndim_oo_ab*Ndim_ov_ab
      Iiajk_aaaa = Iijka_baba + Ndim_oo_ab*Ndim_ov_ba

C W(ia,jk) intermediate 

      Iiajk_bbbb = Iiajk_aaaa + Ndim_ov_aa*Ndim_oo_aa
      Iiajk_abab = Iiajk_bbbb + Ndim_ov_bb*Ndim_oo_bb
      Iiajk_baba = Iiajk_abab + Ndim_ov_ab*Ndim_oo_ab
      Iijab_aaaa = Iiajk_baba + Ndim_ov_ba*Ndim_oo_ab

C W(ij,ab) intermediate 

      Iijab_bbbb = Iijab_aaaa + Ndim_oo_aa*Ndim_vv_aa
      Iijab_abab = Iijab_bbbb + Ndim_oo_bb*Ndim_vv_bb
      Iend       = Iijab_abab + Ndim_oo_ab*Ndim_vv_ab
...
C F(m,i), F(a,e), F(m,e)  intermediate 
     ...
     +                                   Maxcor)
      ...
      Call Ccsd_light_driver(Work(IW0_aaaa),Work(IW0_bbbb),
     +     Work(IW0_abab),Work(IW1_aaaa),Work(IW1_bbbb),
     +     Work(IW1_abab),Work(IW2_aaaa),Work(IW2_bbbb),
     +     Work(IW2_abab),Work(IW3_aaaa),Work(IW3_bbbb),
     ...
     +     Work(Iabci_aaaa),Work(Iabci_bbbb),Work(Iabci_abab),
     +     Work(Iabci_baba),Work(Iaibc_aaaa),Work(Iaibc_bbbb),
     +     Work(Iaibc_abab),Work(Iaibc_baba),Work(Iijka_aaaa),
     +     Work(Iijka_bbbb),Work(Iijka_abab),Work(Iijka_baba),
     +     Work(Iiajk_aaaa),Work(Iiajk_bbbb),Work(Iiajk_abab),
     +     Work(Iiajk_baba),Work(Iijab_aaaa),Work(Iijab_bbbb),
     +     Work(Iijab_abab),
