     ...
     +                       W_aa,W_bb,W_ab,W4_aa,W4_bb,W4_ab,
     +                       W4_ba,W5_aa,W5_bb,W5_ab,W5_ba,
     +                       Cmo_a,Cmo_b,Nocc_a,Nocc_b,Nvrt_a,
     +                       Nvrt_b,Nbasis,Naobfns,Temp,Maxcor,
     +                       Frac_occ,Repuls) 
...
CSSS      Dimension W_pxxx(Nbasis,Naobfns,Naobfns,Naobfns)
CSSS      Dimension W_pqxx(Nbasis,Nbasis,Naobfns,Naobfns)
CSSS      Dimension W_pqrx(Nbasis,Nbasis,Nbasis,Naobfns)
CSSS      Dimension W_pqrs_aaaa(Nbasis,Nbasis,Nbasis,Nbasis)
CSSS      Dimension W_pqrs_bbbb(Nbasis,Nbasis,Nbasis,Nbasis)
CSSS      Dimension W_pqrs_aabb(Nbasis,Nbasis,Nbasis,Nbasis)
CSSS      Dimension W_pqrs_bbaa(Nbasis,Nbasis,Nbasis,Nbasis)
...
C Get I(mu,nu,lambda,sigma)
     ...
     +                          Dble(Ipqrs_aabb),Dble(Ipqrs_bbaa)
      ...
      Call Get2ints(Temp(Iw_xxxx),Buf,Ibuf,Naobfns,Repuls) 
...
C Wmnij->Wmnef
     ...
     +                      Nbasis,Nocc_a,Nocc_b,Nvrt_a,Nvrt_b)
         Call form_wabci_fo(Temp(Ipqrs_aaaa),Temp(Ipqrs_bbbb),
     +                      Temp(Ipqrs_aabb),W4_aa,W4_bb,
     +                      W4_ab,W4_ba,Nbasis,Nocc_a,Nocc_b,
     +                      Nvrt_a,Nvrt_b)

         Call form_wijka_fo(Temp(Ipqrs_aaaa),Temp(Ipqrs_bbbb),
     +                      Temp(Ipqrs_aabb),W5_aa,W5_bb,
     +                      W5_ab,W5_ba,Nbasis,Nocc_a,Nocc_b,
     +                      Nvrt_a,Nvrt_b)
         Return 
      Endif 
     ...
     +                Nbasis,Nocc_a,Nocc_b,Nvrt_a,Nvrt_b)
      ...
      Call form_wabci(Temp(Ipqrs_aaaa),Temp(Ipqrs_bbbb),
     +                Temp(Ipqrs_aabb),W4_aa,W4_bb,
     +                W4_ab,W4_ba,Nbasis,Nocc_a,Nocc_b,
     +                Nvrt_a,Nvrt_b)

      Call form_wijka(Temp(Ipqrs_aaaa),Temp(Ipqrs_bbbb),
     +                Temp(Ipqrs_aabb),W5_aa,W5_bb,
     +                W5_ab,W5_ba,Nbasis,Nocc_a,Nocc_b,
     +                Nvrt_a,Nvrt_b)
