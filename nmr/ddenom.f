      ...
      SUBROUTINE DDENOM(ACORE,MAXCOR,IUHF)
C
C THIS ROUTINE CREATES THE DENOMINATOR LISTS REQUIRED
C FOR CORRELATED SECOND DERIVATIVE CALCULATION
C
CEND
C
...
C
          DO 200 IA=1,NVRTL
          IND=IND+1
          ACORE(IEND+IND)=ONE/(EVALIJB-ACORE(IEVALA+IOFFA+IA))
