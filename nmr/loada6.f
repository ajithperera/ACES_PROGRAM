      SUBROUTINE LOADA6(CMO,W,W2,BUF,IBUF,ISYMAO,NBAS,
...
C
        DO 9008 I=NSTARTI,NENDI
         IADR=IOFFW1+JX+NBASXJ*(IND1-1)+ISIZEX*(I-NSTARTI)
         W(IADR)=W(IADR)+W2(I)
9008    CONTINUE
10    CONTINUE
      NAOINT=NAOINT+NUT
...
C
      RETURN
900   WRITE(6,1000)
1000  FORMAT(T3,'@LOADA6-F, Unexpected end-of-file on integral file.')
      CALL ERREX
      RETURN
901   WRITE(6,1000)
1001  FORMAT(T3,'@LOADA6-F, I/O error on unit ',I5,'.')
      CALL ERREX
      RETURN
      END
