      SUBROUTINE DHF24F(AOINT,BUF,IBUF,ILNBUF,IRREP1,IRREP2,
     &                  NSTART1,NEND1,NMO2,NMO,IOFF1,
...
C
      ...
      DIMENSION IOFF1(8),IOFF2(8),IREORD(1)
C
      COMMON/INTTOL/TOL
...
C
        IXX=IREORD(I+IOFF1(IRREP1))
C
        DO 200 J=1,NMO2
C
         JXX=IREORD(J+IOFF1(IRREP2))
C
         IF(IXX.GT.JXX) THEN
          IX=IXX
          JX=JXX
         ...
         ENDIF
C 
         DO 301 IRREP3=2,NIRREP
          IF(IRREP3.GE.IRREP1.OR.IRREP3.EQ.IRREP2) GO TO 301     
...
C 
          DO 300 K=1,NMO3
C 
           KXX=IREORD(K+IOFF1(IRREP3))
C
           DO 400 L=1,NMO4
C
            LXX=IREORD(L+IOFF1(IRREP4))
C
            IF(KXX.GT.LXX) THEN
             KX=KXX
             LX=LXX
...
C
         ...
         ENDIF
C 
         DO 1301 IRREP3=2,NIRREP
          IF(IRREP3.GE.IRREP1.OR.IRREP3.EQ.IRREP2) GO TO 1301     
          IRREP4=DIRPRD(IRREP3,IRREP12)
...
C 
          DO 1300 K=1,NMO3
C 
           KXX=IREORD(K+IOFF2(IRREP3))
C
           DO 1400 L=1,NMO4
C
            LXX=IREORD(L+IOFF2(IRREP4))
C
            IF(KXX.GT.LXX) THEN
             KX=KXX
             LX=LXX
...
C
         ...
         ENDIF
C 
         DO 2301 IRREP3=2,NIRREP
          IF(IRREP3.GE.IRREP1.OR.IRREP3.EQ.IRREP2) GO TO 2301     
          IRREP4=DIRPRD(IRREP3,IRREP12)
