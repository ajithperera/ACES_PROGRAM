      ...
      SUBROUTINE tdcc_mu_dot_da_debug(ICORE,MAXCOR,IUHF,IRROMEGA)
C
...
C
      ...
      DATA ZILCH/0.0D0/
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_mu_dot_da_debug---"
        Write(6,*)
      CALL GETDT1(ICORE,MAXCOR,MXCOR,IUHF,IOFFT1,IRROMEGA,390)
      RHF=.FALSE.
...
100   CONTINUE
      ...
      i000=1
      Isize_abij_z=Idsymsz(IRROMEGA,Isytyp(1,336),
     +           Isytyp(2,336))
      call getall(Icore(i000),Isize_abij_z,IRROMEGA,336)
      call checksum("Tdcc_mu_dot_da_debug Z(Ab,Ij)(f):",Icore(i000),
     +               Isize_abij_z,S)
C
      IF(RHF)RETURN
C
