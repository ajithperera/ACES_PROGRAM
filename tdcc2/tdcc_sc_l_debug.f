      ...
      SUBROUTINE Tdcc_sc_l_debug(ICORE,MAXCOR,IRREPX,IUHF)
C
...
C
      ...
      DATA ONEM/-1.0D0/
        ...
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_sc_l_debug---"
        Write(6,*)
      LISTT1 = 396
      RHF=.FALSE.
...
C                  FeM
         IZ=I000
C         call checksum("check0",icore(i000),lentar,s)
...
100    CONTINUE
C
      call Checksum("mut_lc_dot_debug(f):", Icore(I000),LENTAR,S)
CSSS       CALL GETLST(ICORE(I010),1,1,1,ISPIN,LISTT1)
CSSS       CALL SAXPY (LENTAR,ONE,ICORE(I000),1,ICORE(I010),1)
CSSS       CALL PUTLST(ICORE(I010),1,1,1,ISPIN,LISTT1)
C
50    CONTINUE
C
      RETURN
