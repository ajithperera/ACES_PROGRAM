      ...
      SUBROUTINE Tdcc_sa2_l_debug(ICORE,MAXCOR,IRREPX,IUHF)
C
...
C
      ...
      DATA MATTYP/'N','T'/
        ...
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_sa2_l_debug---"
        Write(6,*)
      ISIDE  = 2
      LISTT1 = 392 
...
C
C       CALL ZERO  (ICORE(I000),LENTAR)
        CALL GETLST(ICORE(I000),1,1,1,ISPIN,396)
C
       IF(IUHF.NE.0)THEN
...
C
     ...
     &              1,ICORE(I020),DISSYW,ONE,ICORE(I000),1)
      ...
      call Checksum("mut_la2_dot_debug(f):",Icore(I000),Lentar,S)
C
