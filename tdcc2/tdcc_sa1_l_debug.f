      ...
      SUBROUTINE tdcc_sa1_l_debug(ICORE,MAXCOR,IRREPX,IUHF)
C
...
C
      ...
      DATA ZILCH/0.0/
        ...
        Write(6,*)
        Write(6,"(a)") "---Entered tdcc_sa1_l_debug---"
        Write(6,*)
      ISIDE = 2
...
C
       CALL DZERO(ICORE(I000),LENT1)
       CALL GETLST(ICORE(I010),1,1,1,ISPIN,392)
...
15     CONTINUE
      call Checksum("mut_la1_dot_debug(f):", Icore(I000),LENT1,S)
C
CSSS       CALL GETLST(ICORE(I010),1,1,1,ISPIN+2,LISTT1)
CSSS       CALL SAXPY (LENT1,ONE,ICORE(I000),1,ICORE(I010),1)
CSSS       CALL PUTLST(ICORE(I010),1,1,1,ISPIN,396)
C
10    CONTINUE
C
      RETURN
