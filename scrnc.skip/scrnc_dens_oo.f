       ...
       SUBROUTINE Scrnc_dens_oo(DOO,ICORE,MAXCOR,IUHF)     
C
C
...
C
     ...
     &             ldens,ISPIN)
       ELSE
        write(*,*)' Triple excitations require pert. canonical ',
     &            'orbials !'
        CALL ERREX
       ENDIF
      ENDIF
...
C IFLAGS(87) 
C
C      IF(.NOT.MBPT2.AND.IFLAGS(87).NE.3.AND.IFLAGS2(101).NE.5) THEN
