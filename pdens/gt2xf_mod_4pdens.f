      ...
      SUBROUTINE GT2XF_MOD_4PDENS(Z,IRREPA,IRREPB,LISTA0,LISTB,IOF0,
     &                            SCR,MAXCOR,IUHF,IMODE)
C
...
CSSS       Print*, "The list:", LISTA1
CSSS       call output(SCR(I000), 1, DISSYA*NUMDSA, 1, 1, DISSYA*NUMDSA,
CSSS     &             1, 1)
       IF(IUHF.EQ.0)THEN
        I020=I010+NUMDSA*DISSYA
        CALL GETLST(SCR(I010),1,NUMDSA,1,IRREPAR,LISTA0+5)
CSSS        Print*, "The list:", LISTA0+5
CSSS        call output(SCR(I010), 1, DISSYA*NUMDSA, 1, 1, DISSYA*NUMDSA,
CSSS     &             1, 1)
...
CSSS        Print*, "The list:", LISTA2
CSSS        call output(SCR(I000), 1, DISSYA*NUMDSA, 1, 1, DISSYA*NUMDSA,
CSSS     &             1, 1)
CSSS        CALL XGEMM('N','N',DISSYA,1,NUMDSA,ONEM,SCR(I000),DISSYA,
CSSS     &             SCR(I0B1(ISPIN)),NUMDSA,ONE,Z(I0Z1(ISPIN)),
CSSS     &             DISSYA)
C
        If ((Iflags(18) .EQ. 9) .or.
     &      (Iflags(18) .EQ. 10)) THEN
             FAC = ONE
        ELSE
             FAC = ONEM
        ENDIF

CSSS        Print*, "The factor", FAC
        CALL XGEMM('N','N',DISSYA,1,NUMDSA,FAC,SCR(I000),DISSYA,
