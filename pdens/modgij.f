...
C
CSSS       Print*, "The L1*R1 term in modgij"
CSSS       call output(gp(IOFFG), 1, numm*numj, 1, 1, numm*numj, 1,0)
CSSS       Print*, "The L2*R2 term in modgij"
CSSS       call output(g(IOFFG), 1, numm*numj, 1, 1, numm*numj, 1,0)
C
