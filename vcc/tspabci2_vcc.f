...
C     versions). Same rationale as tspabci_vcc.f in this directory --
C     vcc is not linked against vcc5t, so without this local copy the
C     linker would resolve TSPABCI2 from trp's 4-arg version instead,
C     which t3_iter.f's 3-argument calls would feed garbage into.
