      SUBROUTINE SYMRHF3_VCC(IRREPL,IRREPR,NUML,NUMR,DISSIZE,A,
     &                  SCR,ISCRL,ISCRR)
C
...
C
      ...
      DO 10 IRREPJ=1,NIRREP-1
       ...
       IRREPK=DIRPRD(IRREPL,IRREPJ)
       IPR(IRREPJ+1)=IPR(IRREPJ)+NUMR(IRREPI)*NUMR(IRREPJ)
       IPL(IRREPJ+1)=IPL(IRREPJ)+NUML(IRREPK)*NUML(IRREPJ)
10    CONTINUE
