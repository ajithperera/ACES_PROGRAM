       sUBROUTINE QUAD3(ICORE,MAXCOR,IUHF,INCREM0,FACT)
C
...
c
       if(increm .eq.5) then
c          write(6,*) ' @quad3:, increm =5, tau = false '
          tau=.false.
          increm = 0
       endif
c
