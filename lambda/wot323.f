      SUBROUTINE WOT323_LAMBDA(T3,W,CORE,IADT3,IADW,
     1                  IRPI,IRPJ,IRPK,IRPIJ,IRPIK,IRPJK,
     1                  I,J,K,ISPIN1,ISPIN2,IUHF,LZOFF,LWOFF,SIGN)
C    1                  I,J,K,ISPIN1,ISPIN2,IUHF,IMODE)
...
c 1010 FORMAT(' @WOT323-F, Invalid value of IMODE. Given ',I10)
c      STOP
c      ENDIF
      LISTG(1) = LZOFF + 1
      LISTG(2) = LZOFF + 2
