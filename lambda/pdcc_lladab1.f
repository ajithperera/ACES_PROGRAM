      ...
      SUBROUTINE PDCC_LLADAB1(W,T,Z,MAXSIZE,DISSYW,NUMSYW,DISSYT,
...
C
        call checksum("ZBMNIJ    :",Z,NUMSYT*DISSYT)
        IF(CC)THEN
        CALL GETLST(T,1,NUMSYT,1,IRREP,16)
        CALL GETLST(W,1,NUMSYW,2,IRREP,153)
        call checksum("VMNIJ     :",W,NUMSYW*DISSYW)
        call checksum("WMNIJ     :",T,NUMSYT*DISSYT)
        CALL XGEMM('N','N',DISSYT,NUMSYW,DISSYW,ONE,
     &             T,DISSYT,W,DISSYW,ONE,Z,DISSYT)
        call checksum("ZFMNIJ    :",Z,NUMSYT*DISSYT)
       ENDIF
      ENDIF
C
      ELSE
...
C
      call checksum("WMNIJ     :", Z, NUMSYT*DISSYT)
