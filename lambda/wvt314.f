...
C
      ...
      ENDIF
      CALL GETLST(ICORE(1),JK,1,1,IRPJK,LIST)
C
...
C
      ...
      IRPBC = DIRPRD(IRPA,IRPI)
      IF(VRT(IRPA,ISPIN).EQ.0.OR.VRT(IRPD,ISPIN).EQ.0) GOTO 30
...
C
      ...
      ENDIF
      CALL GETLST(ICORE(1),IK,1,1,IRPIK,LIST)
C
...
C
      ...
      IRPBC = DIRPRD(IRPA,IRPJ)
      IF(VRT(IRPA,ISPIN).EQ.0.OR.VRT(IRPD,ISPIN).EQ.0) GOTO 130
...
C
      ...
      ENDIF
      CALL GETLST(ICORE(1),IJ,1,1,IRPIJ,LIST)
C
...
C
      ...
      IRPBC = DIRPRD(IRPA,IRPK)
      IF(VRT(IRPA,ISPIN).EQ.0.OR.VRT(IRPD,ISPIN).EQ.0) GOTO 230
