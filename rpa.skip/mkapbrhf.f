      ...
      SUBROUTINE MKAPBRHF(AMAT,SCRATCH,IRREP)
C
...
CSSS       CALL DSCAL(DISSYW, ONEM, AMAT(IOFF), 1)
...
C
      ...
      DO 1002 IDIS=1,NUMSYW
       CALL GETLST(AMAT(IOFF),IDIS,1,1,IRREP,LISTW)
CSSS       CALL SSCAL (DISSYW,TWO,AMAT(IOFF),1)
       CALL DAXPY(DISSYW, TWO, AMAT(IOFF), 1, AMAT(IOFF3),1)
