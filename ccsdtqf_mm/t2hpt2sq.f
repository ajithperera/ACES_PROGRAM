...
c      call zeroma(t2n,1,no2u2)
      ...
      CALL MATMULsp(v,vo,fpp,1,NU2,NO2,1,1)
...
c      call zclock('dgr   1  ',1)
c 6501 format('Diagram no. 1 required',f15.2,'  seconds')
      call tranmd(voe,no,no,nu,nu,12)
...
c      call zclock('dgr   2  ',1)
c 6502 format('Diagram no. 2 required',f15.2,'  seconds')
c      call zclock(1)
...
c      call zclock('dgr   3  ',1)
c      call zclock(1)
c 6503 format('Diagram no. 3 required',f15.2,'  seconds')
...
c      call zclock('dgr   4  ',1)
c      call zclock(1)
c 6504 format('Diagram no. 4 required',f15.2,'  seconds')
      ...
      call matmul(o2,fpp,t2n,no2u,nu,nu,0,0)
      call transq(t2n,nou)
c      call chksum('t2hp 5  ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6505)tcpu
c      call timer(1)
c      write(6,6505)timenew
c      call zclock('dgr   5  ',1)
c      call zclock(1)
c 6505 format('Diagram no. 5 required',f15.2,'  seconds')
      ...
      call transq(t2n,nou)
      call insitu(nu,no,no,nu,ti,t2n,13)
c      call chksum('t2hp 6  ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6506)tcpu
c      call timer(1)
c      write(6,6506)timenew
c      call zclock('dgr   6  ',1)
c      call zclock(1)
c 6506 format('Diagram no. 6 required',f15.2,'  seconds')
      call rintvo(1,no,nu,ti,t2)
 ...
 300  continue
      ...
      call transq(t2n,nou)
      call tranmd(t2n,no,nu,nu,no,23)
c      call chksum('t2hp 7  ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6507)tcpu
c      call timer(1)
c      write(6,6507)timenew
c      call zclock('dgr   7  ',1)
c      call zclock(1)
c 6507 format('Diagram no. 7 required',f15.2,'  seconds')
      call rintvo(1,no,nu,ti,t2)
      call transq(t2,nou)
      call insitu(no,no,nu,nu,ti,o2,13)
      call  transq(o2,nou)
      ...
      call vecadd(vo,voe,no2u2)
      call vecmul(voe,no2u2,half)
c      call chksum('t2hp 8  ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6508)tcpu
c      call timer(1)
c      write(6,6508)timenew
c      call zclock('dgr   8  ',1)
c      call zclock(1)
c 6508 format('Diagram no. 8 required',f15.2,'  seconds')
      ...
      call matmul(o2,vo2,t2n,nou,nou,nou,0,0)
      call tranmd(t2n,no,nu,nu,no,23)
c      call chksum('t2hp 9  ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6509)tcpu
c      call timer(1)
c      write(6,6509)timenew
c      call zclock('dgr   9  ',1)
c      call zclock(1)
c 6509 format('Diagram no. 9 required',f15.2,'  seconds')
      call rintvo(1,no,nu,ti,t2)
      call  tranmd(t2,no,nu,nu,no,14)
      call insitu(nu,no,nu,no,ti,vo,12)
      call transq(vo,nou)
      ...
      call tranmd(t2n,no,nu,nu,no,23)
      call matmul(vo2,o2,t2n,nou,nou,nou,0,1)      
c      call chksum('t2hp 11 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6511)tcpu
c      call timer(1)
c      write(6,6511)timenew
c      call zclock('dgr  11  ',1)
c      call zclock(1)
c 6511 format('Diagram no.11 required',f15.2,'  seconds')
      call rintvo(1,no,nu,ti,t2)
      call insitu(no,nu,nu,no,ti,t2,13)
      ...
      call transq(t2n,nou)
      call tranmd(t2n,no,nu,nu,no,23)
c      call chksum('t2hp 14 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6514)tcpu
c      call timer(1)
c      write(6,6514)timenew
c      call zclock('dgr  14  ',1)
c      call zclock(1)
c 6514 format('Diagram no.14 required',f15.2,'  seconds')
      call rintvo(1,no,nu,ti,t2)
      call rintvo(2,no,nu,ti,vo2)
      call vecmul(vo2,no2u2,half)
      call vecsub(t2,vo2,no2u2)
...
c      call chksum('t2hp 15 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6515)tcpu
c      call timer(1)
c      write(6,6515)timenew
c      call zclock('dgr  15  ',1)
c      call zclock(1)
c 6515 format('Diagram no.15 required',f15.2,'  seconds')
      call rintpp(1,nu,v)
      call transq(v,nu)
      call insitu(nu,nu,no,no,ti,vo,13)
      call transq(vo,nou)
...
c      call chksum('t2hp 16 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6516)tcpu
c      call timer(1)
c      write(6,6516)timenew
c      call zclock('dgr  16  ',1)
c      call zclock(1)
c 6516 format('Diagram no.16 required',f15.2,'  seconds')
      ...
      call matmul(t2,o2,t2n,nou,nou,nou,0,1)
      call tranmd(t2n,no,nu,nu,no,23)
c      call chksum('t2hp 12 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6512)tcpu
c      call timer(1)
c      write(6,6512)timenew
c      call zclock('dgr  12  ',1)
c      call zclock(1)
c 6512 format('Diagram no.12 required',f15.2,'  seconds')
      call rintvo(6,no,nu,ti,t2)
      call rintvo(-7,no,nu,ti,t2)
      call insitu(no,nu,nu,no,ti,t2,13)
      call transq(o2,nou)
      ...
      call insitu(no,no,nu,nu,ti,t2n,13)
      call transq(t2n,nou)
c      call chksum('t2hp 13 ',t2n,no2u2)
c      call timer(tcpu,tsys,0)
c      write(6,6513)tcpu
c      call timer(1)
c      write(6,6513)timenew
c      call zclock('dgr  13  ',1)
c      call zclock(1)
c 6513 format('Diagram no.13 required',f15.2,'  seconds')
...
c      write(6,6510)tcpu
c      call timer(1)
c      write(6,6510)timenew
c      call zclock('dgr  10  ',1)
c      call zclock(1)
c 6510 format('Diagram no.10 required',f15.2,'  seconds')
c      call iexit(106)
      RETURN
      END
