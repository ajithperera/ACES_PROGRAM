      ...
      SUBROUTINE PROPS(ICORE,MAXCOR,IUHF)
...
C The orbital kintic energies at CC for Y. Park (01/2022). This employ
C CC natural orbitals. 

      IF (Itop .EQ. 2) Call Built_orb_kint_enegs(Icore(I000),
     &                                           Maxcor,Ncomp,
     &                                           Norbs,Nirrep,
     &                                           Popful,Vrtful,
     &                                           Nocco,Nvrto,Iuhf)
